...
import {useTabBar} from "../../hooks/useTabBar"; import {
  Tooltip
} from 'akeneo-design-system/lib/components/Tooltip/Tooltip';

<Meta
  title="Components/Tiles"
  component={Tiles}
  argTypes={{
    size: {control: {type: 'select'}, options: ['small', 'big', 'inline']},
  }}
  args={{size: 'small'}}
/>
  ...
  <Story name="Standard">
    {args => {
      ...
      return <Tiles {...args} >
        ...
        <Tile icon={<AttributeNumberIcon/>} selected={isCurrent('Number')} onClick={() => {switchTo('Number')}}>
          Number
        </Tile>
      </Tiles>;
    }}
