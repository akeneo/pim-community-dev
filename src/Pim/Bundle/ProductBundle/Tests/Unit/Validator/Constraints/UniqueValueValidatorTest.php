...
use Pim\Bundle\ProductBundle\Validator\Constraints\UniqueValueValidator;
...
class UniqueValueValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMock('Pim\Bundle\ProductBundle\Entity\ProductValue');
    }

    public function getProductAttributeMock()
    {
        return $this->getMock('Pim\Bundle\ProductBundle\Entity\ProductAttribute');
    }
}
