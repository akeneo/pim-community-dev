...
define(
    [
        ...
        'oro/translator',
        'pim/form',
        'text!team-work-assistant/templates/grid/view-selector/remove-project',
        'pim/dialog',
        'pim/user-context',
        'pim/fetcher-registry',
        'team-work-assistant/remover/project',
        'oro/messenger'
    ],
    function (
        $,
        ...
        return BaseForm.extend({
            ...
            render: function () {
                ...
                this.$el.html(this.template({
                    label: __('team_work_assistant.grid.view_selector.remove')
                }));
            ...
            promptDeletion: function () {
                Dialog.confirm(
                    __('team_work_assistant.grid.view_selector.confirmation.remove'),
                    __('team_work_assistant.grid.view_selector.confirmation.delete'),
                    function () {
