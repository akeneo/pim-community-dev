...
Feature: Browse imports
  ...
  Scenario: Successfully view, sort and filter import jobs
    ...
    And I should be able to use the following filters:
      ...
      | Connector | Akeneo CSV Connector | product_import, category_import, association_type_import, variant_group_import, group_import, attribute_import, family_import and option_import |
      | Status    | Ready                | product_import, category_import, association_type_import, variant_group_import, group_import, attribute_import, family_import and option_import |
