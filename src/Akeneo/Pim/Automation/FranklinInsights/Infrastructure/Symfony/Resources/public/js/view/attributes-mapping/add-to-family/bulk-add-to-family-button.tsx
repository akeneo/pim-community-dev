...
export class BulkAddToFamilyButton extends Component<Props> {
  public render() {
    return (
      <ActionButton
  ...
  private onClick() {
    const modal = new (Backbone as any).BootstrapModal({
      ...
      subtitle: __('akeneo_franklin_insights.entity.attributes_mapping.modal.bulk_add_to_family.subtitle'),
      innerDescription: __(
      ...
      `,
      okText: __('akeneo_franklin_insights.entity.attributes_mapping.modal.bulk_add_to_family.ok'),
      cancelText: ''
    });
...
export default BulkAddToFamilyButton;
