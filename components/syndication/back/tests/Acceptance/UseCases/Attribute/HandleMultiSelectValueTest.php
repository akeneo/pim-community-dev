...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\AttributeOption\InMemoryFindAttributeOptionLabels;
...
final class HandleMultiSelectValueTest extends AttributeTestCase
{
    ...
    private function loadOptions(): void
    {
        ...
        $attributeOptionLabels = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindAttributeOptionLabelsInterface');
