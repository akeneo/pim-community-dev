 ...
 */
class GetVariantAttributeSetAxesCodes
{
    /** @var Connection */
    private $connection;
...
JOIN pim_catalog_variant_attribute_set_has_axes pcvasha on pcfvas.id = pcvasha.variant_attribute_set_id
JOIN pim_catalog_attribute pca on pcvasha.axes_id = pca.id 
