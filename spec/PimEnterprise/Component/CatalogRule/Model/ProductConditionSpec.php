...
namespace spec\PimEnterprise\Component\CatalogRule\Model;
...
class ProductConditionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('PimEnterprise\Component\CatalogRule\Model\ProductCondition');
    }
    ...
    {
        $this->shouldHaveType('PimEnterprise\Component\CatalogRule\Model\ProductConditionInterface');
    }
