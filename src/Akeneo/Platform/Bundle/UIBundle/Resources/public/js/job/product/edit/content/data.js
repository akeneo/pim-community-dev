  ...
  return BaseForm.extend({
    ...
    configure: function () {
      this.onExtensions(
        'add-attribute:add',
        function (event) {
          this.addFilters(event.codes).then(
            function () {
              this.updateModel();
              this.render();
            }.bind(this)
    ...
    updateModel: function () {
      ...
      dataFilterCollection = dataFilterCollection.filter(filter => {
        return (
          this.filterViews.findIndex(filterView => {
      ...
      const newData = PropertyAccessor.updateProperty(data, 'configuration.filters.data', dataFilterCollection);
