...
unit-back-supplier: #Doc: Run unit back tests for the supplier part of Onboarder Serenity
	$(DOCKER_COMPOSE_RUN_PHP_TEST_ENV) vendor/bin/phpunit --testsuite Supplier_Portal_Unit_Test --configuration components/onboarder-supplier/back/tests/phpunit.xml.dist ${ARGS}
...
ifeq ($(CI),true)
	vendor/akeneo/pim-community-dev/.circleci/run_phpunit.sh . vendor/akeneo/pim-community-dev/.circleci/find_phpunit.php Supplier_Portal_Integration_Test
else
	$(DOCKER_COMPOSE_RUN_PHP_TEST_ENV) vendor/bin/phpunit --testsuite Supplier_Portal_Integration_Test --configuration components/onboarder-supplier/back/tests/phpunit.xml.dist ${ARGS}
endif
