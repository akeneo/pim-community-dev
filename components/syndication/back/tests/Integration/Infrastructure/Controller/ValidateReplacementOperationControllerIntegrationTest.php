...
{
    private const ROUTE = 'pimee_syndication_validate_replacement_operation_action';
    ...
    public function test_it_returns_errors_if_replacement_operation_is_not_valid(): void
    {
        ...
        Assert::assertSame('akeneo.syndication.validation.max_length_reached', $responseContent[0]['messageTemplate']);
