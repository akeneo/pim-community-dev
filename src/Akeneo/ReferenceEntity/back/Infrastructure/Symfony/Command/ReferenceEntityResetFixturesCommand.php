...
SQL;
    ...
    private function loadDesigners(): void
    {
        ...
        $sql = <<<SQL
INSERT INTO `akeneo_reference_entity_reference_entity` (`identifier`, `labels`, `image`)
VALUES ('designer','{\"en_US\": \"Designer\", \"fr_FR\": \"Concepteur\"}', '${designer}');
...
INSERT INTO `akeneo_reference_entity_record` (`identifier`, `code`, `reference_entity_identifier`, `labels`, `image`, `value_collection`)
VALUES
  ('designer_starck_1','starck','designer','{"en_US": "Philippe Starck"}','${philippeStarck}','{"birthdate_designer_87939c45-1d85-4134-9579-d594fff65030": {"data": "12", "locale": null, "channel": null, "attribute": "birthdate_designer_87939c45-1d85-4134-9579-d594fff65030"}, "nationality_designer_df90ead4-8aea-42a0-a517-5554e12631bb_en_US": {"data": "French", "locale": "en_US", "channel": null, "attribute": "nationality_designer_df90ead4-8aea-42a0-a517-5554e12631bb"}, "wikipediapage_designer_8b2aa74c-cc2e-486f-a514-496800214bde_en_US": {"data": "<iframe width=\\\"600\\\" height=\\\"400\\\" src=\\\"https://www.youtube.com/embed/6yAVvlc0_sg\\\" frameBorder=\\\"0\\\"></iframe>\\\\n<p></p>\\\\n", "locale": "en_US", "channel": null, "attribute": "wikipediapage_designer_8b2aa74c-cc2e-486f-a514-496800214bde"}}'),
  ('designer_dyson_2','dyson','designer','{"en_US": "James Dyson"}','${jamesDyson}','[]'),
  ('designer_newson_3','newson','designer','{"en_US": "Marc Newson"}','${marcNewson}','[]'),
...
SQL;
    ...
    private function loadBrands(): void
    {
        ...
        $sql = <<<SQL
INSERT INTO `akeneo_reference_entity_reference_entity` (`identifier`, `labels`, `image`)
VALUES ('brand','{\"en_US\": \"Brand\", \"fr_FR\": \"Marque\"}', '${brand}');
...
SQL;
    ...
    public function loadColors(): void
    {
        ...
        $sql = <<< SQL
INSERT INTO `akeneo_reference_entity_reference_entity` (`identifier`, `labels`, `image`)
VALUES ('color','{\"en_US\": \"Color\"}', '${color}');
...
VALUES
  ...
  ('maincolor_color_e27aed6f-6db2-4cbf-ad64-d7a008a3c0ad','maincolor','color','{\"en_US\": \"Main color\"}','text',1,0,0,0,'{\"max_length\": null, \"is_textarea\": false, \"validation_rule\": \"none\", \"regular_expression\": null, \"is_rich_text_editor\": false}')
;

INSERT INTO `akeneo_reference_entity_record` (`identifier`, `code`, `reference_entity_identifier`, `labels`, `image`, `value_collection`)
VALUES
	('color_navyblue_6d3ba943-6353-4d85-970d-2210f5373c2d','navyblue','color','{"en_US": "Navy blue", "fr_FR": "Bleu marine"}','${bleuMarine}','{"maincolor_color_e27aed6f-6db2-4cbf-ad64-d7a008a3c0ad": {"data": "Blue", "locale": null, "channel": null, "attribute": "maincolor_color_e27aed6f-6db2-4cbf-ad64-d7a008a3c0ad"}}'),
...
SQL;
    ...
    private function loadCountries(): void
    {
        ...
        $sql = <<<SQL
INSERT INTO `akeneo_reference_entity_reference_entity` (`identifier`, `labels`, `image`)
VALUES ('country','{\"en_US\": \"Country\"}', '${country}');
