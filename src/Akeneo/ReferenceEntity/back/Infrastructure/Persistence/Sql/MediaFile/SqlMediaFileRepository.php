...
namespace Akeneo\ReferenceEntity\Infrastructure\Persistence\Sql\MediaFile;
...
{
    public function __construct(private ApiResourceRepositoryInterface $fileRepository)
    {
    }
