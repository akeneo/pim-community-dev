...
class LocaleTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetSetDefaultCurrency()
    {
        ...
        $this->assertInstanceOf('Pim\Bundle\ProductBundle\Entity\Currency', $this->locale->getDefaultCurrency());
    ...
    {
        $this->assertInstanceOf('Pim\Bundle\ProductBundle\Entity\Locale', $entity);
    }
}
