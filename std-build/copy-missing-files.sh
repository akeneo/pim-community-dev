...
mkdir -p $STANDARD_DISTRIB_DIR/bin $STANDARD_DISTRIB_DIR/public $STANDARD_DISTRIB_DIR/config/packages
...
cp $STANDARD_DISTRIB_DIR/bin/console $STANDARD_DISTRIB_DIR/bin/
cp $STANDARD_DISTRIB_DIR/public/index.php $STANDARD_DISTRIB_DIR/public/
cp $STANDARD_DISTRIB_DIR/std-build/src/Kernel.php $STANDARD_DISTRIB_DIR/src
