    ...
    public function invalidOperation(): array
    {
        return [
            ...
            'invalid precision should not be blank' => [
                'akeneo.syndication.column_details.sources.operation.measurement_rounding.precision.validation.precision_should_not_be_blank',
                '[precision]',
                [
                    'type' => 'measurement_rounding',
                    'rounding_type' => 'standard',
            ...
            'invalid precision should not be > 12' => [
                'akeneo.syndication.column_details.sources.operation.measurement_rounding.precision.validation.precision_is_out_of_range',
                '[precision]',
                [
                    'type' => 'measurement_rounding',
                    'rounding_type' => 'standard',
