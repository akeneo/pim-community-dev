...
class ReferenceEntityTextAttributeSelectionApplier implements SelectionApplierInterface
{
    ...
    {
        if (!$value instanceof ReferenceEntityValue || !$selection instanceof ReferenceEntityTextAttributeSelection) {
    ...
    {
        return $selection instanceof ReferenceEntityTextAttributeSelection
