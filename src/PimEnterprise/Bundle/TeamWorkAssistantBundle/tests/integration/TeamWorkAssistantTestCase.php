...
class TeamWorkAssistantTestCase extends TestCase
{
    ...
    protected function createProject($label, $owner, $locale, $channel, array $filters)
    {
        ...
        $project = $this->get('pimee_team_work_assistant.factory.project')->create($projectData);
        $this->get('pimee_team_work_assistant.saver.project')->save($project);
    ...
    protected function calculateProject(ProjectInterface $project)
    {
        ...
        $this->get('pimee_team_work_assistant.launcher.job.project_calculation')->launch($project);
    ...
    {
        $remover = $this->get('pimee_team_work_assistant.remover.project');
    ...
    {
        return $this->get('pimee_team_work_assistant.repository.project_completeness')
...
SQL;
        ...
        return (int)$this->getConnection()->fetchColumn($sql, [
            'project_calculation' => $this->getParameter('pimee_team_work_assistant.project_calculation.job_name'),
        ]);
    }
}
