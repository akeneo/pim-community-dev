...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\Channels;
...
class ChannelsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(Channels::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'channels'));
    }
}
