...
Feature: Export of metric values
  ...
  Scenario: Do not convert null metric values
    ...
    Then exported file of "ecommerce_product_export" should contain:
    """
    sku;categories;enabled;family;groups;additional_colors;color;cost-EUR;cost-GBP;cost-USD;country_of_manufacture;cross_sell-groups;cross_sell-productmodels;cross_sell-products;customer_rating-ecommerce;customs_tax-de_DE-EUR;customs_tax-de_DE-GBP;customs_tax-de_DE-USD;datasheet;description-de_DE-ecommerce;description-en_GB-ecommerce;description-en_US-ecommerce;description-fr_FR-ecommerce;handmade;image;legend-de_DE;legend-en_GB;legend-en_US;legend-fr_FR;manufacturer;material;name-de_DE;name-en_GB;name-en_US;name-fr_FR;number_in_stock-ecommerce;pack-groups;pack-productmodels;pack-products;price-EUR;price-GBP;price-USD;related-groups;related-productmodels;related-products;release_date-ecommerce;similar-groups;similar-productmodels;similar-products;size;substitute-groups;substitute-productmodels;substitute-products;thumbnail;upsell-groups;upsell-productmodels;upsell-products;variant-groups;variant-productmodels;variant-products;washing_temperature;washing_temperature-unit;weight;weight-unit
