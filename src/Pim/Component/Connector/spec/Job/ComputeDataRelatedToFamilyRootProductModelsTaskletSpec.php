 ...
 */
class ComputeDataRelatedToFamilyRootProductModelsTaskletSpec extends ObjectBehavior
{
    function let(
    ...
    function it_computes_root_product_models(
        $cacheClearer,
        $familyReader,
        $familyRepository,
        $keepOnlyValuesForVariation,
    ...
    function it_saves_only_valid_root_product_models(
        $cacheClearer,
        $familyReader,
        $familyRepository,
        $keepOnlyValuesForVariation,
