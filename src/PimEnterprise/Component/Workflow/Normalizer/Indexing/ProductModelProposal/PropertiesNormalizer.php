...
namespace PimEnterprise\Component\Workflow\Normalizer\Indexing\ProductModelProposal;
...
class PropertiesNormalizer implements NormalizerInterface, SerializerAwareInterface
{
    ...
    public function normalize($productModelProposal, $format = null, array $context = []): array
    {
        ...
        $attributeAsLabelCode = null !== $productModel->getFamily() ?
            $productModel->getFamily()->getAttributeAsLabel()->getCode() : null;
