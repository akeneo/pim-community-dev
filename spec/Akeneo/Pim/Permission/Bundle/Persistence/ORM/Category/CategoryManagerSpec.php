...
namespace spec\Akeneo\Pim\Permission\Bundle\Persistence\ORM\Category;
...
class CategoryManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Pim\Permission\Bundle\Persistence\ORM\Category\CategoryManager');
    }
