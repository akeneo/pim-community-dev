...
Feature: Browse export profiles
  ...
  Scenario: Successfully view, sort and filter export jobs
    ...
    And I should be able to use the following filters:
      ...
      | Connector | Akeneo Connector     | footwear_product_export, footwear_category_export, footwear_association_type_export, footwear_group_export, footwear_variant_group_export, footwear_attribute_export, footwear_family_export and footwear_option_export |
