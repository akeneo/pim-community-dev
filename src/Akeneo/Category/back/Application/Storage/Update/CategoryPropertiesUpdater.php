 ...
 */
class CategoryPropertiesUpdater implements CategoryUpdater
{
    public function __construct(
        private UpsertCategoryProperties $updateCategoryProperties,
    ...
    public function update(Category $categoryModel): void
    {
        ...
        $this->updateCategoryProperties->execute($categoryModel);
    }
