...
import {Badge, Button, Checkbox, Dropdown, IconButton, Image, Table, Toolbar} from '../../components';
                ...
                <SpaceContainer height={600} style={{overflow: 'hidden'}}>
                    ...
                    <Toolbar isVisible={!!selectionState}>
                        <Toolbar.SelectionContainer>
                            ...
                            <Dropdown>
                                <IconButton size='small' ghost='borderless' icon={<ArrowDownIcon />} title='Select' onClick={open} />
                                {isOpen && (
                                    <Dropdown.Overlay onClose={close}>
                                        ...
                                        <Dropdown.ItemCollection>
                                            <Dropdown.Item onClick={() => {onSelectAllChange(true); close();}}>Select all</Dropdown.Item>
                                            <Dropdown.Item onClick={() => {onSelectAllChange(true); close();}}>Select all visible</Dropdown.Item>
                                            <Dropdown.Item onClick={() => {onSelectAllChange(false); close();}}>Select none</Dropdown.Item>
                                        </Dropdown.ItemCollection>
                                    </Dropdown.Overlay>
                                )}
                            </Dropdown>
