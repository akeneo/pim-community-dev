...
namespace spec\Akeneo\Tool\Component\FileTransformer\Transformation;
...
class TransformationRegistrySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('\Akeneo\Tool\Component\FileTransformer\Transformation\TransformationRegistry');
    }
