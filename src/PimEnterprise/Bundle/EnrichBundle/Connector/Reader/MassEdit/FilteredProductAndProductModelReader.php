...
namespace PimEnterprise\Bundle\EnrichBundle\Connector\Reader\MassEdit;
 ...
 * TODO - note for PIM-6367 - Do not used this class, use @pim_enrich.reader.database.filtered_product_and_product_model instead
 *
