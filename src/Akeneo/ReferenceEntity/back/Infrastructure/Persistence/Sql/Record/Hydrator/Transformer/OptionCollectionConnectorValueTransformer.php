...
class OptionCollectionConnectorValueTransformer implements ConnectorValueTransformerInterface
{
    ...
    {
        return array_values(array_filter($normalizedOptionCodes, static fn ($normalizedOptionCode) => $attribute->hasAttributeOption(OptionCode::fromString($normalizedOptionCode))));
    }
}
