Feature: Edit a text attribute of an asset family
  ...
  Scenario: ValuePerLocale is not editable
    Given an asset family with an attribute 'name' having a single value for all locales
  ...
  Scenario: ValuePerChannel is not editable
    Given an asset family with an attribute 'name' having a single value for all channels
  ...
  Scenario: Updating the label
    Given an asset family with a text attribute 'name' and the label 'en_US' equal to 'Name'
  ...
  Scenario: Updating max length
    Given an asset family with a text attribute 'name' and max length 100
  ...
  Scenario: Updating the is text area flag to true on a simple text will set the validation rule and regular expression to an empty value
    Given an asset family with a text attribute 'name'
  ...
  Scenario: Updating the is_rich_text_editor flag
    Given an asset family with a text area attribute 'description' with no rich text editor
