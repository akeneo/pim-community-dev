...
Feature: Handle import of invalid XLSX data
  ...
  Scenario: From an association type XLSX import, create an invalid data file and be able to download it
  ...
  Scenario: From a category XLSX import, create an invalid data file and be able to download it
    Given the following XLSX file to import:
      """
  ...
  Scenario: From a family XLSX import, create an invalid data file and be able to download it
    Given the following XLSX file to import:
      """
      code;attributes
  ...
  Scenario: From a group XLSX import, create an invalid data file and be able to download it
    Given the following XLSX file to import:
      """
