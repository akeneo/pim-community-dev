...
Feature: Import proposals
  ...
  Scenario: Update a proposal to add a new attribute
    ...
    And the following product drafts:
      ...
      | my-jacket3 | ready  | clothing_product_proposal_import | {"values":{"name":[{"locale":"en_US","scope":null,"data":null}]}}                                                                             |
    And the following CSV file to import:
    """
  ...
  Scenario: Remove an optional attribute to a proposal
    ...
    And the following product drafts:
      | product    | status | author                           | result                                                                                                                      |
      | my-jacket  | ready  | clothing_product_proposal_import | {"values":{"name":[{"locale":"en_US","scope":null,"data":"My jacket"}],"handmade":[{"locale":null,"scope":null,"data":0}]}} |
    And the following CSV file to import:
    """
    sku;handmade
    my-jacket;
  ...
  Scenario: Remove a proposal if there is no diff
    ...
    And the following product drafts:
      | product    | status | author                           | result                                                          |
      | my-jacket  | ready  | clothing_product_proposal_import | {"values":{"handmade":[{"locale":null,"scope":null,"data":0}]}} |
    And the following CSV file to import:
    """
    sku;handmade
    my-jacket;
