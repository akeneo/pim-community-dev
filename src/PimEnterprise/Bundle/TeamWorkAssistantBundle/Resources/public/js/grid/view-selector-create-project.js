...
define(
    [
        ...
        'backbone',
        'pim/form',
        'text!team-work-assistant/templates/grid/view-selector/create-project',
        'team-work-assistant/project/create-form'
    ],
    function (
        $,
        _,
        ...
        return BaseForm.extend({
            ...
            render: function () {
                ...
                if ('project' === this.getRoot().currentViewType) {
                    label = __('team_work_assistant.grid.view_selector.create');
                    icon = 'plus';
                } else {
                    label = __('team_work_assistant.grid.view_selector.create_from_view');
                    icon = 'tasks';
                }
            ...
            promptCreateProject: function () {
                var modal = new Backbone.BootstrapModal({
                    title: __('team_work_assistant.create_project_modal.title'),
                    content: '',
                    cancelText: __('team_work_assistant.create_project_modal.cancel'),
                    okText: __('team_work_assistant.create_project_modal.confirm'),
                    okCloses: false
                });
