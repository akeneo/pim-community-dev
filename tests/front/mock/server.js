...
app.use('/rest/security', (req, res) => res.json(require('./responses/default/rest_security.json')))
app.use('/localization/format/date', (req, res) => res.json(require('./responses/default/date_format.json')))
app.use('/rest/user', (req, res) => res.json(require('./responses/default/user.json')))
app.use('/dashboard', (req, res) => res.send(dashboard))
app.use('/notification/count_unread', (req, res) => res.send('0'))
app.use('/configuration/locale/rest', (req, res) => res.json(require('./responses/default/activated_locales.json')))
