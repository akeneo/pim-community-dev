...
namespace Akeneo\Test\Pim\Automation\DataQualityInsights\Integration\Consistency\TextChecker;
...
final class AspellDictionaryGeneratorIntegration extends TestCase
{
    public function test_it_generates_dictionaries_from_product_values_to_filesystem()
    {
        ...
        $dictionarySource = $this->get('Akeneo\Pim\Automation\DataQualityInsights\Infrastructure\Consistency\TextChecker\ProductValueInDatabaseDictionarySource');

        $this->get('Akeneo\Pim\Automation\DataQualityInsights\Infrastructure\Consistency\TextChecker\AspellDictionaryGenerator')
