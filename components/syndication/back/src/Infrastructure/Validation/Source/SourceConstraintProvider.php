...
namespace Akeneo\Platform\Syndication\Infrastructure\Validation\Source;
    ...
    public static function getConstraintCollection(): Collection
    {
        return new Collection([
            'fields' => [
                ...
                'type' => new Choice([
                    'choices' => [AttributeSource::TYPE, PropertySource::TYPE, AssociationTypeSource::TYPE, StaticSource::TYPE],
                ]),
            ],
        ]);
    }
