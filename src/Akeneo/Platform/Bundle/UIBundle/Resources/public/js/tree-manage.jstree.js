define([
  ...
  return function (elementId, prefixRoute) {
    ...
    this.config = {
      ...
      plugins: ['tree_selector', 'themes', 'json_data', 'ui', 'crrm', 'types'],
      contextmenu: {
        items: {
          create: {
      ...
      tree_selector: {
        ajax: {
          url: Routing.generate(prefixRoute + '_categorytree_listtree', {
            _format: 'json',
      ...
      json_data: {
        ajax: {
          url: Routing.generate(prefixRoute + '_categorytree_children', {
            _format: 'json',
            context: 'manage',
          }),
          data: function (node) {
            ...
            $.ajax({
              ...
              data: {
                ...
                prev_sibling: this_jstree._get_prev(this, true)
                  ? this_jstree._get_prev(this, true).attr('id').replace('node_', '')
                  : null,
