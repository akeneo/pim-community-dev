...
final class AttributeGroupActivationRepository implements AttributeGroupActivationRepositoryInterface
{
    ...
    {
        $query = <<<SQL
INSERT INTO pim_data_quality_insights_attribute_group_activation (attribute_group_code, activated) 
VALUES (:attributeGroupCode, :activated)
ON DUPLICATE KEY UPDATE activated = :activated;
SQL;
