Feature: Create a draft with a price fields
  ...
  Scenario: Successfully add a draft without add attribute in product
    Given I should get the following product drafts after apply the following updater to it:
      ...
      | akeneo_tshirt | [{"type": "set_data", "field": "price", "data": [{"amount": 4, "currency": "EUR"}, {"amount": "5.00", "currency": "USD"}], "locale": null, "scope": null}] | {}     | Mary     |
    And I should get the following proposals:
      | product       | username | result                                                                                                                                                                                                                       |
      | akeneo_tshirt | Mary     | {"values": {"price": [{"locale": null, "scope": null, "data": [{"amount": 4, "currency": "EUR"}, {"amount": "5.00", "currency": "USD"}]}]}, "review_statuses": {"price": [{"locale": null, "scope": null, "status": "draft"}]}} |
  ...
  Scenario: Successfully add a draft without update attribute in product
    ...
    Then I should get the following product drafts after apply the following updater to it:
      | product       | actions                                                                                                                                                     | result | username |
      | akeneo_tshirt | [{"type": "set_data", "field": "price", "data": [{"amount": 4.00, "currency": "EUR"}, {"amount": 5.00, "currency": "USD"}], "locale": null, "scope": null}] | {}     | Mary     |
    And I should get the following proposals:
      | product       | username | result                                                                                                                                                                                                                           |
      | akeneo_tshirt | Mary     | {"values": {"price": [{"locale": null, "scope": null, "data": [{"amount": 4.00, "currency": "EUR"}, {"amount": 5.00, "currency": "USD"}]}]}, "review_statuses": {"price": [{"locale": null, "scope": null, "status": "draft"}]}} |
    And the product "akeneo_tshirt" should have the following values:
  ...
  Scenario: Do not create a draft with same values as product
    ...
    Then I should get the following product drafts after apply the following updater to it:
      | product       | actions                                                                                                                | result | username |
      | akeneo_tshirt | [{"type": "set_data", "field": "price", "data": [{"amount": 5.00, "currency": "USD"}], "locale": null, "scope": null}] | {}     | Mary     |
