...
class DownloadAndUnpackSource implements ExtractInterface, DownloadInterface, UnpackInterface, ReadInterface
{
    ...
    /**
     * (non-PHPdoc)
     * @see Pim\Bundle\IcecatConnectorBundle\Extract.ExtractInterface::extract()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Pim\Bundle\IcecatConnectorBundle\Extract\DownloadInterface::download()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Pim\Bundle\IcecatConnectorBundle\Extract\UnpackInterface::unpack()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see Pim\Bundle\IcecatConnectorBundle\Extract.ReadInterface::read()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see Pim\Bundle\IcecatConnectorBundle\Extract.ReadInterface::getReadContent()
     */
