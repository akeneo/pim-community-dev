...
final class FileValueFactorySpec extends ObjectBehavior
{
    ...
    public function it_creates_a_localizable_and_scopable_value()
    {
        ...
        $attribute = $this->getAttribute(true, true);
        $value = $this->createByCheckingData($attribute, 'ecommerce', 'fr_FR', $fileInfo);
    ...
    public function it_creates_a_localizable_value()
    {
        ...
        $value = $this->createByCheckingData($attribute, null, 'fr_FR', $fileInfo);
    ...
    public function it_creates_a_scopable_value()
    {
        ...
        $value = $this->createByCheckingData($attribute, 'ecommerce', null, $fileInfo);
    ...
    public function it_creates_a_non_localizable_and_non_scopable_value()
    {
        ...
        $value = $this->createByCheckingData($attribute, null, null, $fileInfo);
        $value->shouldBeLike(MediaValue::value('an_attribute', $fileInfo));
    }


    public function it_creates_a_value_without_checking_data()
    {
        $fileInfo = new FileInfo();
        $attribute = $this->getAttribute(false, false);
        $value = $this->createWithoutCheckingData($attribute, null, null, $fileInfo);
        $value->shouldBeLike(MediaValue::value('an_attribute', $fileInfo));
    }
