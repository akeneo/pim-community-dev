Feature: Edit a text attribute of an reference entity
  ...
  Scenario: ValuePerLocale is not editable
    Given an reference entity with an attribute 'name' having a single value for all locales
  ...
  Scenario: ValuePerChannel is not editable
    Given an reference entity with an attribute 'name' having a single value for all channels
  ...
  Scenario: Updating the label
    Given an reference entity with a text attribute 'name' and the label 'en_US' equal to 'Name'
  ...
  Scenario: Updating is required property
    Given an reference entity with a text attribute 'name' non required
  ...
  Scenario: Updating max length
    Given an reference entity with a text attribute 'name' and max length 100
  ...
  Scenario: Updating the is text area flag to false on a text area will set the is rich text editor to false
    Given an reference entity with a text area attribute 'description'
  ...
  Scenario: Updating the is text area flag to true on a simple text will set the validation rule and regular expression to an empty value
    Given an reference entity with a text attribute 'name'
  ...
  Scenario: Updating the validation rule
    Given an reference entity with a text attribute 'email' with no validation rule
  ...
  Scenario: Remove a validation rule from a text attribute (also removes the regular expression)
    Given an reference entity with a text attribute 'regex' with a regular expression '"[0-9]+"'
  ...
  Scenario: Updating the is_rich_text_editor flag
    Given an reference entity with a text area attribute 'description' with no rich text editor
