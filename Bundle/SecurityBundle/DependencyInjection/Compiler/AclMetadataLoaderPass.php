...
{
    const ACL_ANNOTATION_METADATA_PROVIDER = 'oro_security.acl_annotation_metadata_provider';
    const ACL_ANNOTATION_METADATA_PROVIDER_TAG = 'oro_security.acl_metadata_loader';
