...
class RecordIdentifierSpec extends ObjectBehavior
{
    public function let()
    {
        $this->beConstructedThrough('create', ['an_enriched_identifier', 'a_record_identifier', 'fingerprint']);
    }
    ...
    {
        $this->normalize()->shouldReturn('an_enriched_identifi_a_record_identifier_fingerprint');
    }

    public function it_can_be_transformed_into_a_string()
    {
        $this->__toString()->shouldReturn('an_enriched_identifi_a_record_identifier_fingerprint');
    }
}
