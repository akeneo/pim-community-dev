...
const NoAttribute = ({onRedirectAttributeCreation, referenceEntityLabel}: {onRedirectAttributeCreation: () => void, referenceEntityLabel: string}) => {
  const createAttributePath = `#${router.generate(`pim_enrich_attribute_create`)}`;

  return (<div className="AknGridContainer-noData">
