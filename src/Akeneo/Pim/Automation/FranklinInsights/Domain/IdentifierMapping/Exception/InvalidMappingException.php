...
namespace Akeneo\Pim\Automation\FranklinInsights\Domain\IdentifierMapping\Exception;
...
{
    /** @var string */
    private const IDENTIFIER_MAPPING_CONSTRAINT_KEY = 'akeneo_franklin_insights.entity.identifier_mapping.constraint.%s';
