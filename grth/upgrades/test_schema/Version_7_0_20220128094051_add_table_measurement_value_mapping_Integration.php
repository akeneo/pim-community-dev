...
final class Version_7_0_20220128094051_add_table_measurement_value_mapping_Integration extends TestCase
{
    private const MIGRATION_LABEL = '_7_0_20220128094051_add_table_measurement_value_mapping';
    ...
    private function mappingExists(): bool
    {
        ...
        return isset($fieldMappings['table_values_measurement']);
    }
    ...
    private function recreateProductIndexWithoutMapping(): void
    {
        ...
        foreach ($configFiles as $configFile) {
            ...
            foreach ($parsedConfigFile['mappings']['dynamic_templates'] ?? [] as $index => $template) {
                if (\array_key_exists('table_values_measurement', $template)) {
