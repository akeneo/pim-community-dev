...
Feature: Define the attribute requirement
  ...
  Scenario: Succesfully display all the channel attribute requirements
    ...
    Then attribute "Description" should be required in channels Mobile and Ecommerce
    And attribute "Name" should be required in channels Mobile and Ecommerce
  ...
  Scenario: Succesfully make an attribute non required for a channel
    ...
    Then attribute "Description" should not be required in channel Mobile
    But attribute "Description" should be required in channel Ecommerce
    And attribute "Name" should be required in channels Mobile and Ecommerce
