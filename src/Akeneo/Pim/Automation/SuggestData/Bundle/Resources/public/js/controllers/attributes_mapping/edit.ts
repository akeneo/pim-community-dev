...
class EditAttributeMappingController extends BaseController {
  public renderForm(route: Route): BaseView {
    return FetcherRegistry.getFetcher('suggest_data_family_mapping')
      ...
      .then((familyMapping: FamilyMapping) => {
        ...
        return FormBuilder.build('pim-suggest-data-settings-attributes-mapping-edit').then((form: BaseView) => {
