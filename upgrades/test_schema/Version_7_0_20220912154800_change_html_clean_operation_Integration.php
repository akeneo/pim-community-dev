...
final class Version_7_0_20220912154800_change_html_clean_operation_Integration extends TestCase
{
    ...
    public function writeJobInstance()
    {
        ...
        if (empty($jobInstance)) {
            ...
            $this->connection->executeQuery($sql, $job);
        }
    }
