...
/**
 * Register product query sorters
 *
 * @author    Nicolas Dupont <nicolas@akeneo.com>
 * @copyright 2014 Akeneo SAS (http://www.akeneo.com)
 * @license   http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class RegisterQuerySortersPass implements CompilerPassInterface
{
    /** @staticvar string */
    const QUERY_BUILDER_SERVICE = 'pim_catalog.doctrine.product_query_builder';

    /** @staticvar string */
    const QUERY_FILTER_TAG = 'pim_catalog.doctrine.query.sorter';
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($taggedServices as $id => $attributes) {
            ...
            $service->addMethodCall('registerSorter', [new Reference($id), $priority]);
        }
    }
}
