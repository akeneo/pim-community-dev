...
class StandardUnitCodeOperationShouldBeMultiplyByOneValidator extends ConstraintValidator
{
     ...
     * @param SaveMeasurementFamilyCommand $saveMeasurementFamily
     */
    private function standardUnit(\Akeneo\Tool\Bundle\MeasureBundle\Application\SaveMeasurementFamily\SaveMeasurementFamilyCommand $saveMeasurementFamily): array
    {
