...
const DefaultValue = ({
  ...
  return (
    <Collapse
      ...
      label={
        <>
          {translate('akeneo.syndication.data_mapping_details.sources.operation.default_value.title')}
    ...
    >
      <TextField
        ...
        label={translate('akeneo.syndication.data_mapping_details.sources.operation.default_value.label')}
        placeholder={translate('akeneo.syndication.data_mapping_details.sources.operation.default_value.placeholder')}
