...
class ReferenceEntityCollectionOptionAttributeLabelSelectionApplierSpec extends ObjectBehavior
{
    public function let(
    ...
    public function it_applies_the_selection(
        ...
        $selection = new ReferenceEntityCollectionOptionAttributeLabelSelection(
            ',',
        ...
        $this->applySelection($selection, $value)->shouldReturn('Option 1 FR,Option 2 FR,Option 3 FR');
    }
    ...
    public function it_applies_the_selection_ignoring_case_and_mapped_values(
        ...
        $this->applySelection($selection, $value)->shouldReturn('Option 1 FR,I AM MAPPED,Option 3 FR');
    }
    ...
    public function it_applies_the_selection_and_fallbacks_on_code_when_no_translation_is_found(
        ...
        $this->applySelection($selection, $value)->shouldReturn('Option 1 FR;;[option_code3]');
    }
