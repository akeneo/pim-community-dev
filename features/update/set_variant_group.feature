Feature: Update variant group fields
  ...
  Scenario: Successfully update the variant group field and the group field
    ...
    Then I should get the following products after apply the following updater to it:
      | product | actions                                                                                                                                                                                                                                                                 | result                                                     |
      | tshirt1 | [{"type": "set_data", "field": "variant_group", "data": "TSHIRT1"}, {"type": "set_data", "field": "groups", "data": ["PACK1", "PACK2"]}]                                                                                                                                | {"groups": ["PACK1", "PACK2"], "variant_group": "TSHIRT1"} |
      ...
      | tshirt3 | [{"type": "set_data", "field": "variant_group", "data": "TSHIRT3"}, {"type": "set_data", "field": "groups", "data": ["PACK1", "PACK2"]}, {"type": "set_data", "field": "variant_group", "data": "TSHIRT1"}, {"type": "set_data", "field": "groups", "data": ["PACK1"]}] | {"groups": ["PACK1"], "variant_group": "TSHIRT1"}          |
      | tshirt4 | [{"type": "set_data", "field": "variant_group", "data": "TSHIRT3"}]                                                                                                                                                                                                     | {"variant_group": "TSHIRT3"}                               |
      | tshirt4 | [{"type": "set_data", "field": "groups", "data": ["PACK1", "PACK2"]}]                                                                                                                                                                                                   | {"groups": ["PACK1", "PACK2"], "variant_group": "TSHIRT3"} |
      | tshirt4 | [{"type": "set_data", "field": "variant_group", "data": "TSHIRT1"}]                                                                                                                                                                                                     | {"groups": ["PACK1", "PACK2"], "variant_group": "TSHIRT1"} |
      | tshirt4 | [{"type": "set_data", "field": "groups", "data": ["PACK1"]}]                                                                                                                                                                                                            | {"groups": ["PACK1"], "variant_group": "TSHIRT1"}          |
