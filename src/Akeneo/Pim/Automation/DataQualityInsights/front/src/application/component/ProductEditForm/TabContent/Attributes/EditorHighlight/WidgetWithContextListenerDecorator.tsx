...
const WidgetWithContextListenerDecorator = <P extends WidgetProps>(WidgetComponent:  ComponentType<P>): FunctionComponent<WidgetWithContextListenerDecoratorProps & P> => {
  return (props) => {
    const {widget} = props;
