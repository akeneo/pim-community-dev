...
Feature: Export groups in XLSX
  ...
  Scenario: Successfully export groups in XLSX into several files
    ...
    And I launch the export job
    And I wait for the "xlsx_group_export" job to finish
    Then I press "xlsx_group_export_1.xlsx" on the "Download generated files" dropdown button
    And I press "xlsx_group_export_2.xlsx" on the "Download generated files" dropdown button
