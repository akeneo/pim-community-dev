...
const useSupplier = (identifier: string) => {
    const getSupplierRoute = useRoute('supplier_portal_retailer_supplier_edit', {identifier});
    const saveSupplierRoute = useRoute('supplier_portal_retailer_supplier_update', {identifier});
