...
class FilterAssetsTest extends SearchIntegrationTestCase
{
    ...
    private function loadLinkedAssetAttribute(string $attributeIdentifier, string $assetType, bool $isScopable = false, bool $isLocalizable = false): void
    {
        $this->attributeIdentifier = AttributeIdentifier::fromString($attributeIdentifier);
        ...
        /** @var AttributeRepositoryInterface $attributeRepository */
        $attributeRepository = $this->get('akeneo_assetmanager.infrastructure.persistence.repository.attribute');
        $attributeRepository->create($assetAttribute);
    }

    private function loadLinkedAssetCollectionAttribute(string $attributeIdentifier, int $order, string $assetType, bool $isScopable = false, bool $isLocalizable = false): void
    {
        $this->attributeIdentifier = AttributeIdentifier::fromString($attributeIdentifier);
