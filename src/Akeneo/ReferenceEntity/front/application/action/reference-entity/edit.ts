...
export const saveReferenceEntity =
  () =>
...
export const refreshReferenceEntity =
  (referenceEntityIdentifier: ReferenceEntityIdentifier, refreshDataForm: boolean = false) =>
...
export const referenceEntityLabelUpdated =
