...
CSV;
    ...
    {
        $this->createProduct('productA', [new SetCategories(['master', 'categoryA1'])]);
...
CSV;
    ...
    public function testToSkipProductsWithNotViewableCategoriesWithPermissions()
    {
        $this->createProduct('productA', [
            ...
            new SetTextValue('a_text', null, null, 'my text'),
        ]);
...
CSV;
    ...
    public function testSuccessfullyToImportProductWithViewableCategoryWithPermissions()
    {
        ...
        $this->createProduct('productB', [
            new SetCategories(['categoryA1']),
            new SetTextValue('a_text', null, null, 'a simple text'),
            ]);
...
CSV;
    ...
    public function testToSkipProductDraftWhenFieldsAreUpdatedForRedactorWithPermissions()
    {
        ...
        $this->createProduct('productC', [
            new SetFamily('familyA'),
            new SetCategories(['categoryA'])
        ]);
        $this->createProduct('productD', [
            new SetGroups(['groupA']),
            new SetCategories(['categoryA'])
        ]);
        $this->createProduct('productE', [new SetCategories(['categoryA'])]);
        $this->createProduct('productF', [new SetCategories(['categoryA'])]);
...
CSV;
    ...
    {
        $this->createProduct('productA', [new SetCategories(['master'])]);
        $this->createProduct('productB', [new SetCategories(['categoryA'])]);
        $this->createProduct('productC', [new SetCategories(['categoryA1'])]);
        $this->createProduct('productD', [new SetCategories(['categoryB'])]);
