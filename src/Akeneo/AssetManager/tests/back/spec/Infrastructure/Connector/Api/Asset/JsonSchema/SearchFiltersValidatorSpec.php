...
class SearchFiltersValidatorSpec extends ObjectBehavior
{
    ...
    public function it_returns_an_error_when_the_operator_of_the_code_filter_is_not_supported()
    {
        $invalidSearchFilters = [
            'code' => [
                ['operator' => '=', 'value' => ['code']],
    ...
    public function it_returns_an_error_when_the_value_of_the_code_filter_is_not_an_array()
    {
        $invalidSearchFilters = [
            'code' => [
                ['operator' => 'IN', 'value' => 'code'],
            ],
        ];
