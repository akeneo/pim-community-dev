...
class AssetCategoryAccessUpdaterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Pim\Permission\Component\Updater\AssetCategoryAccessUpdater');
    }
    ...
    function it_throws_an_exception_if_group_not_found(
        ...
        $this->shouldThrow(
            InvalidPropertyException::validEntityCodeExpected(
                ...
                'Akeneo\Pim\Permission\Component\Updater\AssetCategoryAccessUpdater',
                'foo'
            )
