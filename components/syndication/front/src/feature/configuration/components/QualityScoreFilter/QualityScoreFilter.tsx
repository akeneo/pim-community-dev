      ...
      {null !== filter.value && null !== filter.operator && (
        <>
          ...
          <LocalesSelector
            ...
            label={translate('akeneo.syndication.filters.quality_score.locales.label')}
            placeholder={translate('akeneo.syndication.filters.quality_score.locales.placeholder')}
            removeLabel={translate('akeneo.syndication.filters.quality_score.locales.remove')}
          />
        </>
      )}
    </Container>
