...
namespace spec\Akeneo\Pim\WorkOrganization\TeamworkAssistant\Bundle\Command;
...
class ProjectRecalculationCommandSpec extends ObjectBehavior
{
    ...
    function it_recalculated_all_project(
        ...
        $container->getParameter('pimee_teamwork_assistant.project_calculation.job_name')
