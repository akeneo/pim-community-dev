...
test('it throws an error if there is no item', () => {
  ...
  const paginationRender = () => {
    render(<Pagination currentPage={1} totalItems={0} onClick={jest.fn()} />);
  };
...
test('it throws an error if the current page is out of bound', () => {
  ...
  const paginationRender = () => {
    render(<Pagination currentPage={1200} totalItems={50} itemsPerPage={25} onClick={jest.fn()} />);
  };
...
test('it renders a pagination of two pages', () => {
  const result = render(<Pagination currentPage={1} totalItems={50} itemsPerPage={25} onClick={jest.fn()} />);
...
test('it renders all pagination items where there are 4 or less items', () => {
  const result = render(<Pagination currentPage={1} totalItems={8} itemsPerPage={2} onClick={jest.fn()} />);
  expect(result.container.textContent).toBe(expectedPagination(['1', '2', '3', '4']));

  result.rerender(<Pagination currentPage={1} totalItems={9} itemsPerPage={2} onClick={jest.fn()} />);
...
test('it renders the 2 first pagination items and the last page if the current page is the first one', () => {
  const result = render(<Pagination currentPage={1} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
...
test('it renders the 3 first pagination item and the last page if the current page is the second one', () => {
  const result = render(<Pagination currentPage={2} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
  expect(result.container.textContent).toBe(expectedPagination(['1', '2', '3', '…', '25']));
});

test('it renders the 4 first pagination item and the last page if the current page is the third one', () => {
  const result = render(<Pagination currentPage={3} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
...
test('it renders the 3 last pagination item and the first page if the last page is the current page', () => {
  const result = render(<Pagination currentPage={25} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
...
test('it renders the 3 last pagination item and the first page if the current page is the second last page', () => {
  const result = render(<Pagination currentPage={24} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
  expect(result.container.textContent).toBe(expectedPagination(['1', '…', '23', '24', '25']));
});

test('it renders the 4 last pagination item and the first page if the current page is the third last page', () => {
  const result = render(<Pagination currentPage={23} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
...
test('it renders the first page, the last page and the previous and next page of any current page', () => {
  const result = render(<Pagination currentPage={12} totalItems={50} itemsPerPage={2} onClick={jest.fn()} />);
...
test('it ensures pagination item is clickable', () => {
  ...
  render(<Pagination currentPage={12} totalItems={50} itemsPerPage={2} onClick={onClickPage} />);
...
test('it ensures separator click does nothing', () => {
  ...
  const result = render(<Pagination currentPage={12} totalItems={50} itemsPerPage={2} onClick={onClickSeparator} />);
