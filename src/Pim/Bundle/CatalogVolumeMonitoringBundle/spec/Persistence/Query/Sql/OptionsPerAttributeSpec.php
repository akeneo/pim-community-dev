...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\OptionsPerAttribute;
...
class OptionsPerAttributeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(OptionsPerAttribute::class);
    }
