...
/**
 * Element object for datagrid generated by the OroGridBundle
 *
...
class Grid extends Index
{
    ...
    {
        return $this->find('css', 'div.grid-toolbar');
    }
    ...
    public function changePageSize($num)
    {
        ...
        $element = $this->getGridToolbar()->find('css', '.page-size');
    ...
    {
        return $this->find('css', 'div.filter-box');
    }
