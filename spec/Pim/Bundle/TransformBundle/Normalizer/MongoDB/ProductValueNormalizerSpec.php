...
class ProductValueNormalizerSpec extends ObjectBehavior
{
    ...
    function it_supports_normalization_of_product_value_in_mongodb_document(AbstractProductValue $value)
    {
    ...
    function it_does_not_support_normalization_of_product_value_into_other_format(AbstractProductValue $value)
    {
