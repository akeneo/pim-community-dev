...
use Akeneo\Connectivity\Connection\Infrastructure\Apps\Persistence\Query\DeleteConnectedAppQuery;
...
class DeleteConnectedAppQueryIntegration extends TestCase
{
    ...
    public function test_it_delete_a_connected_app_from_the_database()
    {
