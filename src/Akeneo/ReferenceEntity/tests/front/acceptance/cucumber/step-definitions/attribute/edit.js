...
module.exports = async function(cucumber) {
	...
	Then(
		"the user edits the attribute property {string} with value {string}",
	...
	Then("the user can't edit the attribute property {string}", async function(
		property
	) {
		const attributeEdit = await await getElement(this.page, "AttributeEdit");
	...
	Then("the attribute property {string} should not be visible", async function(
		property
	) {
		const attributeEdit = await await getElement(this.page, "AttributeEdit");
