...
lint-back: #Doc: launch PHPStan for tailored export
	$(PHP_RUN) vendor/bin/phpstan analyse --configuration components/tailored-export/back/src/Akeneo/Platform/Bundle/TailoredExportBundle/tests/phpstan-grth.neon
...
ifeq ($(CI),true)
	APP_ENV=test_fake $(PHP_RUN) vendor/bin/phpunit -c components/tailored-export/back/src/Akeneo/Platform/Bundle/TailoredExportBundle/tests/phpunit-grth.xml --log-junit var/tests/phpunit/phpunit_$$(uuidgen).xml --testsuite TailoredExport_Acceptance_Test
else
	APP_ENV=test_fake $(PHP_RUN) vendor/bin/phpunit -c components/tailored-export/back/src/Akeneo/Platform/Bundle/TailoredExportBundle/tests/phpunit-grth.xml --testsuite TailoredExport_Acceptance_Test $(O)
endif
