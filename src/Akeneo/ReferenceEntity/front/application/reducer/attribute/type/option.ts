...
const optionAttributeReducer = (normalizedAttribute: NormalizedOptionAttribute | NormalizedOptionCollectionAttribute): NormalizedOptionAttribute | NormalizedOptionCollectionAttribute => {
  // Nothing to edit
