...
namespace spec\Akeneo\Pim\WorkOrganization\Workflow\Bundle\Security;
...
class ProductDraftVoterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Pim\WorkOrganization\Workflow\Bundle\Security\ProductDraftVoter');
    }
