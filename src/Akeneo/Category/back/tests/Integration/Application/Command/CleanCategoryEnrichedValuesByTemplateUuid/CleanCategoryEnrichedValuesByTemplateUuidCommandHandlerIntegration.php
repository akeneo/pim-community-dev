...
use Akeneo\Category\Application\Command\CleanCategoryEnrichedValuesByTemplateUuid\CleanCategoryEnrichedValuesByTemplateUuidCommandHandler;
 ...
 */
class CleanCategoryEnrichedValuesByTemplateUuidCommandHandlerIntegration extends CategoryTestCase
{
    public function testItCleansValueCollectionOnTemplateDeactivation(): void
    {
        ...
        $command = new CleanCategoryEnrichedValuesByTemplateUuidCommand('6344aa2a-2be9-4093-b644-259ca7aee50c');
        $commandHandler = $this->get(CleanCategoryEnrichedValuesByTemplateUuidCommandHandler::class);
