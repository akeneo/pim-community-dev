 ...
 */
final class Version_5_0_20211018125135_migrate_longtext_to_json extends AbstractMigration
{
    private array $columnsToMigrate = [
        [
            'table' => 'akeneo_rule_engine_rule_definition',
            'column' => 'content',
            'null' => true,
        ],
        [
        ...
        [
            'table' => 'pimee_workflow_product_model_draft',
            'column' => 'changes',
            'null' => false,
        ],
    ];
