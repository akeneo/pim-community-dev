...
use Pim\Bundle\ProductBundle\Form\Type\ChannelType;
...
class ChannelTypeTest extends AbstractFormTypeTest
{
    ...
    public function testFormType()
    {
        ...
        // Assert option class
        $this->assertEquals(
            'Pim\Bundle\ProductBundle\Entity\Channel',
    ...
    public function testBindValidData($formData)
    {
        ...
        $object = new ObjectTestEntity('\Pim\Bundle\ProductBundle\Entity\Channel', $formData);
