...
Feature: Mass Edit Families
  ...
  Scenario: Successfully mass edit attribute requirements by attribute group
    ...
    And attribute "Price" should be optional in family "sneakers" for channel "Tablet"
    And attribute "Price" should be optional in family "sandals" for channel "Tablet"
    And attribute "Price" should be optional in family "boots" for channel "Mobile"
    And attribute "Price" should be optional in family "sneakers" for channel "Mobile"
    And attribute "Price" should be optional in family "sandals" for channel "Mobile"
    Then attribute "Rate of sale" should be optional in family "boots" for channel "Tablet"
    And attribute "Rate of sale" should be optional in family "sneakers" for channel "Tablet"
    And attribute "Rate of sale" should be optional in family "sandals" for channel "Tablet"
    And attribute "Rate of sale" should be optional in family "boots" for channel "Mobile"
    And attribute "Rate of sale" should be optional in family "sneakers" for channel "Mobile"
    And attribute "Rate of sale" should be optional in family "sandals" for channel "Mobile"
    Then attribute "Rating" should be optional in family "boots" for channel "Tablet"
    And attribute "Rating" should be optional in family "sneakers" for channel "Tablet"
    And attribute "Rating" should be optional in family "sandals" for channel "Tablet"
    And attribute "Rating" should be optional in family "boots" for channel "Mobile"
    And attribute "Rating" should be optional in family "sneakers" for channel "Mobile"
    And attribute "Rating" should be optional in family "sandals" for channel "Mobile"