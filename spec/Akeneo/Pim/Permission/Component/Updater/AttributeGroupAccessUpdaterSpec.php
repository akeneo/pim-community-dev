...
class AttributeGroupAccessUpdaterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Pim\Permission\Component\Updater\AttributeGroupAccessUpdater');
    }
    ...
    function it_throw_an_exception_when_trying_to_update_anything_else_than_an_asset_category_access()
    {
        $this->shouldThrow(
            InvalidObjectException::objectExpected(
                'stdClass',
                'Akeneo\Pim\Permission\Component\Model\AttributeGroupAccessInterface'
            )
    ...
    function it_throws_an_exception_if_group_not_found(
        ...
        $this->shouldThrow(
            InvalidPropertyException::validEntityCodeExpected(
                ...
                'Akeneo\Pim\Permission\Component\Updater\AttributeGroupAccessUpdater',
                'foo'
            )
