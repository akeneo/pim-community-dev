...
communication-channel-lint-back:
	$(PHP_RUN) vendor/bin/phpstan analyse --level=7 src/Akeneo/Platform/Bundle/CommunicationChannelBundle/back/Application src/Akeneo/Platform/Bundle/CommunicationChannelBundle/back/Domain
...
ifeq ($(CI),true)
	...
	APP_ENV=test ${PHP_RUN} vendor/bin/phpunit -c app --testsuite Akeneo_Communication_Channel_Integration $(0)
endif
