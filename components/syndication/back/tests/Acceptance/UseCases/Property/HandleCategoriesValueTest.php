...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\Category\InMemoryFindCategoryLabels;
...
final class HandleCategoriesValueTest extends PropertyTestCase
{
    ...
    private function loadCategoryLabels(): void
    {
        ...
        $categoryLabelsRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindCategoryLabelsInterface');
