...
define([
  ...
  'jquery.select2',
], function ($, _, __, Routing, BaseFilter, FetcherRegistry, UserContext, i18n, template) {
  return BaseFilter.extend({
    ...
    getTemplateContext: function () {
      return FetcherRegistry.getFetcher('attribute')
        ...
        .then(
          function (attribute) {
            return this.cleanInvalidValues(attribute, this.getValue()).then(
              function (cleanedValues) {
    ...
    getSelect2Options: function (attribute) {
      ...
      return {
        ...
        initSelection: function (element, callback) {
          this.getChoices(attribute).then(
            function (response) {
    ...
    cleanInvalidValues: function (attribute, currentValues) {
      return this.getChoices(attribute).then(
        function (response) {
