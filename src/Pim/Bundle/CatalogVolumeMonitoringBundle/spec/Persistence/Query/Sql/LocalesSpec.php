...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\Locales;
...
class LocalesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(Locales::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'locales'));
    }
}
