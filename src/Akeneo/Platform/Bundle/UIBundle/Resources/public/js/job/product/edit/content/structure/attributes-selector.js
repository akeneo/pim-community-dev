  ...
  return Backbone.View.extend({
    ...
    render: function () {
      $.when(
        ...
        function (attributeGroups, selectedAttributes) {
          var scrollPositions = {};
          ...
          if (null === this.currentGroup) {
            attributeCount = _.reduce(
              attributeGroups,
              function (count, attributeGroup) {
    ...
    initializeSortable: function () {
      this.$('.attributes ul, .selected-attributes ul')
        .sortable({
