...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\ProductModels;
...
class ProductModelsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ProductModels::class);
    }
