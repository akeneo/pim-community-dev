...
class CountProductModelChildrenIntegration extends TestCase
{
    public function test_it_counts_the_number_of_product_model_children_for_product_models(): void
    {
        $repository = $this->get('pim_catalog.repository.product_model');
        $query = $this->get('pim_catalog.query.count_product_model_children');
