...
/**
 * The Array Reader allows to read file CSV file, where cells contains an array of items. The main function will return
 * elements one by one.
 * This class is stateful because it contains the next items to return.
 *
 * For example, a CSV asset configurations file contains lines like this:
 * code;tags
