...
Feature: Filter attributes
  ...
  Scenario Outline: Successfully filter attributes
    ...
    Examples:
      ...
      | type          | in list  | Image  | Side view and Top view                                                                                                                                                                                                                                     | 2     |
      | scopable      |          | yes    | Description, Cap color and Lace fabric                                                                                                                                                                                                                     | 3     |
      ...
      | localizable   |          | yes    | Name, Description, Cap color and Lace fabric                                                                                                                                                                                                               | 4     |
