...
final class IsJobDueTest extends TestCase
{
    ...
    public function test_it_return_true_if_last_execution_date_is_in_the_past()
    {
    ...
    public function test_it_return_false_if_too_early_for_the_next_execution()
    {
    ...
    public function test_it_return_false_if_configured_too_late_to_be_run()
    {
