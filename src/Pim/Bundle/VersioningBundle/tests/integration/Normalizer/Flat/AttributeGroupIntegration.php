...
class AttributeGroupIntegration extends AbstractFlatNormalizerTestCase
{
    public function testAttributeGroup()
    {
        ...
        $this->assertSame($flatAttributeGroup, [
            ...
            'sort_order'  => 1,
            'attributes'  => 'sku,a_date,a_file,a_price,a_price_without_decimal,a_ref_data_multi_select,a_ref_data_simple_select,a_text,a_regexp,a_text_area,a_yes_no,a_scopable_price,a_localized_and_scopable_text_area,a_text_collection,a_localizable_text_collection',
