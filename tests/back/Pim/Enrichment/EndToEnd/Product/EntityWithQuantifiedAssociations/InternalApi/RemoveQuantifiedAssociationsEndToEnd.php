...
class RemoveQuantifiedAssociationsEndToEnd extends InternalApiTestCase
{
    ...
    public function it_add_quantified_associations_to_a_product(): void
    {
        ...
        $normalizedProductWithoutQuantifiedAssociations = $this->updateNormalizedProduct($normalizedProduct, [
        ...
        $this->client->request(
            ...
            json_encode($normalizedProductWithoutQuantifiedAssociations)
        );
