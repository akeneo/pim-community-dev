 ...
 */
final class GetCatalogIdsUsingLocalesAsFilterQuery implements GetCatalogIdsUsingLocalesAsFilterQueryInterface
{
    ...
    public function execute(array $localeCodes): array
    {
        ...
        FROM akeneo_catalog
        WHERE JSON_OVERLAPS(JSON_EXTRACT(product_value_filters, '$.locales' ), :localeCodes)
