...
namespace Pim\Bundle\CatalogVolumeMonitoringBundle\tests\Integration\Command;

use Pim\Bundle\CatalogVolumeMonitoringBundle\Command\AggregateVolumesCommand;
