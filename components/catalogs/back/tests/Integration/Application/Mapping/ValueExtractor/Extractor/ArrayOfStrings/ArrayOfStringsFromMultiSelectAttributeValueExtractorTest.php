...
{
    private ?ArrayOfStringsFromMultiSelectAttributeValueExtractor $extractor;
    ...
    protected function setUp(): void
    {
        ...
        $this->extractor = self::getContainer()->get(ArrayOfStringsFromMultiSelectAttributeValueExtractor::class);
    }
