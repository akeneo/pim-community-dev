...
final class GenerateHeadersFromAttributeCodes implements GenerateFlatHeadersFromAttributeCodesInterface
{
    ...
    public function __construct(
        ...
        GenerateFlatHeadersFromAttributeCodesInterface $generateHeadersWithoutPermission
    ) {
    ...
    public function __invoke(
        ...
        $attributesData = $this->fetchGrantedAttributesData($attributeCodes, $userId);
        $headers = [];
...
SQL;
     ...
     */
    private function fetchGrantedAttributesData(array $attributeCodes, int $userId): array
    {
