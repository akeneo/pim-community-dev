...
use Akeneo\Pim\Enrichment\Component\Product\Connector\Job\JobParameters\ConstraintCollectionProvider\ProductMassEdit;
...
class ProductMassEditSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ProductMassEdit::class);
    ...
    public function it_provides_a_collection_of_constraints(): void
    {
        ...
        $fields['realTimeVersioning']->shouldBeAnInstanceOf(Required::class);
        $fields['realTimeVersioning']->constraints[0]->shouldBeAnInstanceOf(Type::class);
        $fields['realTimeVersioning']->constraints[0]->type->shouldBe('bool');
