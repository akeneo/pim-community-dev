...
use Akeneo\Platform\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\CountScopableAttributes;
...
class CountScopableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(CountScopableAttributes::class);
    }
