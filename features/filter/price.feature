Feature: Filter on number attributes
  ...
  Scenario: Successfully filter on number attributes
    ...
    Then I should get the following results for the given filters:
      ...
      | [{"field":"price", "operator":"<",     "value": {"data": 25, "currency": "EUR"}   }] | ["BOOTBL", "BOOTBXS"]                      |
      | [{"field":"price", "operator":"<=",    "value": {"data": 44, "currency": "EUR"}}] | ["BOOTWXS", "BOOTBS", "BOOTBL", "BOOTBXS"] |
      | [{"field":"price", "operator":">=",    "value": {"data": 35, "currency": "EUR"}}] | ["BOOTBS", "BOOTWXS"]                      |
      | [{"field":"price", "operator":">",     "value": {"data": 30, "currency": "USD"}}] | ["BOOTBS"]                                 |
      | [{"field":"price", "operator":"EMPTY", "value": {"data": null, "currency": "USD"} }] | ["BOOTRXS"]|
