...
class FetchConsistencyForProductModelRows implements AddAdditionalProductModelProperties
{
    /**
     * {@inheritdoc}
     */
    public function add(FetchProductAndProductModelRowsParameters $queryParameters, array $rows): array
    {
        ...
        foreach ($rows as $row) {
            $property = new AdditionalProperty('data_quality_insights_consistency', null);
