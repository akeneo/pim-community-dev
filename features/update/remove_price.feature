Feature: Remove price fields
  ...
  Scenario: Successfully remove a price field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | BOX2    | [{"type": "remove_data", "field": "price", "data": [{"amount": null, "currency": "EUR"}, {"amount": null, "currency": "USD"}], "locale": "fr_FR", "scope": null}]                                                                                      | {"values": {"price": [{"locale": "fr_FR", "scope": null, "data": []}, {"locale": "en_US", "scope": null, "data": [{"data": "5", "currency": "USD"}, {"amount": "10", "currency": "EUR"}]}]}}                                    |
