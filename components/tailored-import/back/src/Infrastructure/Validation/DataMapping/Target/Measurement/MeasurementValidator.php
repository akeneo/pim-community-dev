...
use Akeneo\Platform\TailoredImport\Infrastructure\Validation\DataMapping\Target\Measurement\MeasurementSourceParameter;
        ...
        $validator->inContext($this->context)->validate($value, new Collection([
            'fields' => [
                ...
                'target' => new AttributeTarget([
                    'source_parameter' => new MeasurementSourceParameter(),
                ]),
