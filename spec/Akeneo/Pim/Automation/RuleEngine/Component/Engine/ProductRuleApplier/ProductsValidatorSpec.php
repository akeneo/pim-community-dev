...
namespace spec\Akeneo\Pim\Automation\RuleEngine\Component\Engine\ProductRuleApplier;
...
class ProductsValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Pim\Automation\RuleEngine\Component\Engine\ProductRuleApplier\ProductsValidator');
    }
