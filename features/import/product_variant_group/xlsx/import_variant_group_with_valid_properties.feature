@javascript
Feature: Execute an Xlsx import with valid properties
  ...
  Scenario: Successfully import a XLSX file of variant group to create a new one
    ...
    When I am on the "xlsx_footwear_variant_group_import" import job page
  ...
  Scenario: Successfully import a XLSX file of variant group to update an existing one
    Given the following XLSX file to import:
      """
      code;type;axis;label-en_US
