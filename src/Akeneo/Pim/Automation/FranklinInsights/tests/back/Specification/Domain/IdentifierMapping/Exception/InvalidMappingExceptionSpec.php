...
namespace Specification\Akeneo\Pim\Automation\FranklinInsights\Domain\IdentifierMapping\Exception;
...
class InvalidMappingExceptionSpec extends ObjectBehavior
{
    ...
    public function it_is_thrown_if_an_attribute_is_mapped_several_times(): void
    {
        ...
        $this->getMessage()->shouldReturn(
            'akeneo_franklin_insights.entity.identifier_mapping.constraint.duplicate_attribute_code'
        );
    }
    ...
    public function it_is_thrown_if_identifier_mapping_is_missing_or_invalid(): void
    {
        ...
        $this->getMessage()->shouldReturn(
            'akeneo_franklin_insights.entity.identifier_mapping.constraint.missing_or_invalid_identifiers'
        );
    }
    ...
    public function it_is_thrown_if_a_mapped_attribute_was_not_found(): void
    {
        ...
        $this->getMessage()->shouldReturn(
            'akeneo_franklin_insights.entity.identifier_mapping.constraint.attribute_not_found'
        );
    }
    ...
    public function it_is_thrown_if_it_miss_a_mandatory_attribute(): void
    {
        ...
        $this->getMessage()->shouldReturn(
            'akeneo_franklin_insights.entity.identifier_mapping.constraint.mandatory_identifier_mapping'
        );
    ...
    public function it_is_thrown_in_case_of_wrong_attribute_type(): void
    {
        ...
        $this->getMessage()->shouldReturn(
            'akeneo_franklin_insights.entity.identifier_mapping.constraint.attribute_type'
        );
        $this->getPath()->shouldReturn('brand');
    }
    ...
    public function it_is_thrown_in_case_of_locale_specific_attribute(): void
    {
        ...
        $this->getMessage()->shouldReturn(
            'akeneo_franklin_insights.entity.identifier_mapping.constraint.locale_specific_not_allowed'
        );
