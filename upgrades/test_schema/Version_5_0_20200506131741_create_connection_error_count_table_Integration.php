 ...
 */
class Version_5_0_20200506131741_create_connection_error_count_table_Integration extends TestCase
{
    ...
    {
        $this->dbalConnection->executeQuery('DROP TABLE IF EXISTS akeneo_connectivity_connection_audit_error_count');
        $this->reExecuteMigration(self::MIGRATION_LABEL);

        Assert::assertTrue($this->schemaManager->tablesExist('akeneo_connectivity_connection_audit_error_count'));
        ...
        $tableColumns = $this->schemaManager->listTableColumns('akeneo_connectivity_connection_audit_error_count');
