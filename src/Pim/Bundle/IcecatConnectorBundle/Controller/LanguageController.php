...
class LanguageController extends Controller
{
    ...
    public function loadFromIcecatAction()
    {
        ...
        return $this->redirect($this->generateUrl('pim_icecatconnector_language_list'));
    }
    ...
    public function listAction()
    {
        ...
        $source = new GridEntity('PimIcecatConnectorBundle:SourceLanguage');
        $grid = $this->get('grid');
        $grid->setSource($source);
        // manage the grid redirection, exports response of the controller
        return $grid->getGridResponse('PimIcecatConnectorBundle:Language:grid.html.twig');
    }
}