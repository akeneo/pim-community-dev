...
class DefaultController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $class = $productManager->getGroupClass();
        $group = new $class();
...
/*
        ...
        $product = $odm->getRepository('PimCatalogBundle:ProductMongo')
...
/*
        ...
        echo '-----------<br/>';
        $value = $manager->getRepository('Pim\Bundle\CatalogBundle\Entity\Product\Value')->find(21);
        ...
        echo '-----------<br/>';
        $value = $manager->getRepository('Pim\Bundle\CatalogBundle\Entity\Product\Value')->find(22);
        echo $value->getData().'<br/>';
        $value->setTranslatableLocale('fr_FR');
        $manager->refresh($value);
        echo $value->getData().'<br/>';
        ...
        echo '-----------<br/>';
        $product = $manager->getRepository('Pim\Bundle\CatalogBundle\Entity\Product\Entity')->find(7);
