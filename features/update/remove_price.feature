Feature: Remove price fields
  ...
  Scenario: Successfully remove a price field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | BOX2    | [{"type": "remove_data", "field": "price", "data": [{"amount": null, "currency": "EUR"}, {"amount": null, "currency": "USD"}], "locale": "fr_FR", "scope": null}]                                                                                      | {"values": {"price": [{"locale": "en_US", "scope": null, "data": [{"amount": "5", "currency": "USD"}, {"amount": "10", "currency": "EUR"}]}, {"locale": "fr_FR", "scope": null, "data": []}]}}                                  |
      | BOX3    | [{"type": "remove_data", "field": "price", "data": [{"amount": 5.3, "currency": "EUR"}], "locale": "fr_FR", "scope": null}]                                                                                                                            | {"values": []}                                                                                                                                                                                                                  |
      | BOX4    | [{"type": "remove_data", "field": "price", "data": [{"amount": "5", "currency": "USD"}], "locale": "fr_FR", "scope": null}, {"type": "remove_data", "field": "price", "data": [{"amount": "5", "currency": "EUR"}], "locale": "en_US", "scope": null}] | {"values": {"price": [{"locale": "en_US", "scope": null, "data": [{"amount": "5", "currency": "USD"}]}, {"locale": "fr_FR", "scope": null, "data": [{"amount": "5", "currency": "EUR"}]}]}}                                     |
