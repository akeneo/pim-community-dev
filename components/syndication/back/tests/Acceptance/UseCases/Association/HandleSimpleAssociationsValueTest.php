...
namespace Akeneo\Platform\Syndication\Test\Acceptance\UseCases\Association;
...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\Product\InMemoryFindProductLabels;
...
final class HandleSimpleAssociationsValueTest extends AssociationTestCase
{
    ...
    private function loadAssociatedEntityLabels(): void
    {
        ...
        $productLabelRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindProductLabelsInterface');
        ...
        $productLabelRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindProductModelLabelsInterface');
        $productLabelRepository->addProductModelLabel('diana', 'ecommerce', 'en_US', 'Diana');

        /** @var InMemoryFindGroupLabels $groupLabelRepository */
        $groupLabelRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindGroupLabelsInterface');
