...
final class ContainsFilterIntegration extends AbstractFilterIntegration
{
    ...
    /** @test */
    public function it_filters_on_contains_operator(): void
    {
        ...
        $this->assertFilter(
            'nutrition',
            ['column' => 'additional_info', 'row' => 'sugar', 'value' => 'another'],
            []
        );
        $this->assertFilter(
            'nutrition',
            ['column' => 'additional_info', 'row' => 'egg', 'value' => 'nothe'],
            ['product_with_another_text']
        );
    ...
    /** @test */
    public function it_filters_on_contains_operator_with_locale_and_scope(): void
    {
        ...
        $this->assertFilter(
            'localizable_scopable_nutrition',
            ['column' => 'additional_info', 'locale' => 'en_US', 'scope' => 'mobile', 'value' => 'a'],
            ['product']
        );
