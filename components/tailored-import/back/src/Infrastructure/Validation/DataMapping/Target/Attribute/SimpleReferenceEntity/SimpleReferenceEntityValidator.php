...
final class SimpleReferenceEntityValidator extends ConstraintValidator
{
    public function validate($value, Constraint $constraint): void
    {
        if (!$constraint instanceof SimpleReferenceEntity) {
            throw new UnexpectedTypeException($constraint, SimpleReferenceEntity::class);
        }
