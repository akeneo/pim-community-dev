...
Feature: Filter products by label or identifier field
  ...
  Scenario: Successfully filter products on their label identifier or uuid
    ...
    And I should be able to use the following filters:
      ...
      | label_identifier_or_uuid | equals   | 125824                               | 125824                         |
      | label_identifier_or_uuid | equals   | post                                 | 125824                         |
      | label_identifier_or_uuid | equals   | post it                              | 125824                         |
      | label_identifier_or_uuid | equals   | paper                                | 6589                           |
      | label_identifier_or_uuid | equals   | 2412                                 | mug                            |
      | label_identifier_or_uuid | equals   | pape                                 | 6589                           |
      | label_identifier_or_uuid | equals   | shade                                | 50_shades_of_grey              |
      | label_identifier_or_uuid | equals   | 24                                   | 125824, mug, 50_shades_of_grey |
      | label_identifier_or_uuid | equals   | ebd75aa5-43bb-4908-9dff-5f8eefa4e3a9 | mug                            |
