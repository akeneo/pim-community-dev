...
return [
    ...
    Akeneo\Tool\Bundle\FileTransformerBundle\AkeneoFileTransformerBundle::class => ['all' => true],
    ...
    Akeneo\Pim\Enrichment\Asset\Bundle\AkeneoPimEnrichmentAssetBundle::class => ['all' => true],
    ...
    AkeneoEnterprise\Test\IntegrationTestsBundle\AkeneoEnterpriseIntegrationTestsBundle::class => ['dev' => true, 'test' => true],
