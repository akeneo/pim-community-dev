...
use Akeneo\Tool\Bundle\MeasureBundle\Controller\ExternalApi\MeasurementOffsetHalPaginator;
...
class MeasurementOffsetHalPaginatorSpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType(MeasurementOffsetHalPaginator::class);
    }
    ...
    {
        $router
            ->generate('measurement_family_get',
                ['page' => 3, 'limit' => 2],
                UrlGeneratorInterface::ABSOLUTE_URL)
            ->willReturn('http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=3');

        $router
            ->generate('measurement_family_get',
                ['page' => 1, 'limit' => 2],
                UrlGeneratorInterface::ABSOLUTE_URL)
            ->willReturn('http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=1');

        $router
            ->generate('measurement_family_get',
                ['page' => 2, 'limit' => 2],
                UrlGeneratorInterface::ABSOLUTE_URL)
            ->willReturn('http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=2');

        $router
            ->generate('measurement_family_get',
                ['page' => 4, 'limit' => 2],
                UrlGeneratorInterface::ABSOLUTE_URL)
            ->willReturn('http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=4');
        ...
        $expectedItems = [
            '_links' => [
                'self' => [
                    'href' => 'http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=3',
                ],
                'first' => [
                    'href' => 'http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=1',
                ],
                'previous' => [
                    'href' => 'http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=2',
                ],
                'next' => [
                    'href' => 'http://akeneo.com/api/rest/v1/measurement-family?limit=2&page=4',
                ],
            ],
            'current_page' => 3,
            '_embedded' => [
        ...
        $parameters = [
            ...
            'list_route_name' => 'measurement_family_get',
        ];
