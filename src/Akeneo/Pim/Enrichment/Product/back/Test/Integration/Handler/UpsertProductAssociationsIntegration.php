...
class UpsertProductAssociationsIntegration extends EnrichmentProductTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $command = new UpsertProductCommand($this->getUserId('peter'), 'identifier');
        $this->commandMessageBus->dispatch($command);
        $product = $this->productRepository->findOneByIdentifier('identifier');
        Assert::assertNotNull($product);
        Assert::assertEmpty($product->getAssociations());

        $command = new UpsertProductCommand($this->getUserId('peter'), 'associated_product_identifier');
        $this->commandMessageBus->dispatch($command);
    ...
    public function it_replaces_product_associations(): void
    {
        ...
        $command = new UpsertProductCommand($this->getUserId('peter'), 'other_associated_product_identifier');
        $this->commandMessageBus->dispatch($command);
