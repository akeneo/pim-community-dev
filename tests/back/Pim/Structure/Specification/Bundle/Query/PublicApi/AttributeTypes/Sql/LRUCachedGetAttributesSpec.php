...
namespace Specification\Akeneo\Pim\Structure\Bundle\Query\PublicApi\AttributeTypes\Sql;
...
final class LRUCachedGetAttributesSpec extends ObjectBehavior
{
    ...
    public function it_can_gets_more_than_the_cache_size(GetAttributes $getAttributes) {
        ...
        for ($i = 0; $i < 1500; $i++) {
            ...
            $attributes[$attributeCode] = new Attribute($attributeCode, AttributeTypes::TEXT, [], false, false, null, false);
        }
