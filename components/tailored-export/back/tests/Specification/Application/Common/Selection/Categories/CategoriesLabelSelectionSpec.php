...
namespace Specification\Akeneo\Platform\TailoredExport\Application\Common\Selection\Categories;

use PhpSpec\ObjectBehavior;

class CategoriesLabelSelectionSpec extends ObjectBehavior
{
    public function let()
    {
