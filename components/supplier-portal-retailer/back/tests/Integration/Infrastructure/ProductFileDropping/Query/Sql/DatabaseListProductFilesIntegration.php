...
final class DatabaseListProductFilesIntegration extends SqlIntegrationTestCase
{
    ...
    public function itPaginatesTheProductFilesList(): void
    {
        ...
        $supplierFiles = $this->get(ListProductFiles::class)('44ce8069-8da1-4986-872f-311737f46f00', 2);
    ...
    public function itSortsTheSupplierFilesListByUploadedDateDescending(): void
    {
        ...
        $supplierFiles = $this->get(ListProductFiles::class)('44ce8069-8da1-4986-872f-311737f46f00');
