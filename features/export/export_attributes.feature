...
Feature: Display available field options
  ...
  Scenario: Successfully export attribute with read only parameter
    ...
    """
    code;label-en_US;label-fr_FR;label-en_GB;label-de_DE;allowed_extensions;available_locales;date_max;date_min;decimals_allowed;default_metric_unit;group;is_read_only;localizable;max_characters;max_file_size;metric_family;minimum_input_length;negative_allowed;number_max;number_min;reference_data_name;scopable;sort_order;type;unique;useable_as_grid_filter;validation_regexp;validation_rule;wysiwyg_enabled
