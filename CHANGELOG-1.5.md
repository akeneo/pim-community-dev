...
- Change constructor of `Pim\Component\Localization\Normalizer\ProductValueNormalizer`. Add `Akeneo\Component\Localization\Localizer\LocalizerRegistryInterface`.
