...
namespace Akeneo\Platform\Syndication\Application\Common\Selection\SimpleAssociations;

use Akeneo\Platform\Syndication\Application\Common\Selection\SelectionInterface;

interface SimpleAssociationsSelectionInterface extends SelectionInterface
{
