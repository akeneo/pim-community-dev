...
use Pim\Bundle\IcecatConnectorBundle\Entity\SourceProduct;
...
class ProductsTransform implements TransformInterface
{
    ...
    public function transform()
    {
        ...
        $suppliers = $this->entityManager->getRepository('PimIcecatConnectorBundle:SourceSupplier')->findAll();
        ...
        if (($handle = fopen($this->filePath, 'r')) !== false) {
            ...
            while (($data = fgetcsv($handle, $length, $delimiter)) !== false) {
                ...
                $product = $this->entityManager->getRepository('PimIcecatConnectorBundle:SourceProduct')
