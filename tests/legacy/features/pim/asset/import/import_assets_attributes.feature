...
Feature: Import attributes
  ...
  Scenario: Successfully show validation errors on assets collection attributes import
    ...
    And the following CSV file to import:
      """
      type;code;label-en_US;group;unique;useable_as_grid_filter;allowed_extensions;metric_family;default_metric_unit;reference_data_name;localizable;scopable;sort_order;available_locales
      ...
      pim_assets_collection;locale_specific_attribute;;info;0;0;;;;assets;1;0;3;fr_FR
    ...
    Then I should see the text "skipped 4"
    ...
    And I should see the text "The assets collection attribute can not be scopable nether localizable: [locale_specific_attribute]"
