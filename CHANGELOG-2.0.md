...
- PIM-7753: Fix computation of completeness of variant products when an attribute at product model level is updated on a bulk action
...
- Remove the interface `PimEnterprise\Bundle\CatalogBundle\Doctrine\CompletenessGeneratorInterface` in favor of `PimEnterprise\Component\ProductAsset\Completeness\CompletenessRemoverInterface`.
