    ...
    podTemplate(label: "pubsub", containers: [
        ...
        node("pubsub") {
            container("gcloud") {
                ...
                sh "sed -i 's#PIM_IMAGE#eu.gcr.io/akeneo-ci/pim-community-dev:pull-request-${env.CHANGE_ID}-build-${env.BUILD_NUMBER}-ce#g' /home/jenkins/pim/.ci/k8s/pubsub_consumer_job.yaml"
