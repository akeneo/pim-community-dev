...
class UpdateCategoryTemplateAttributesOrderSqlIntegration  extends CategoryTestCase
{
    ...
    public function testItUpdatesAttributesOrderByAttributeUuids(): void
    {
        $longDescriptionAttribute =  $this->getAttribute->byTemplateUuid($this->templateUuid)
            ->getAttributeByCode('long_description');

        $shortDescription = Attribute::fromType(
            type: new AttributeType(AttributeType::TEXT),
            uuid: AttributeUuid::fromUuid(Uuid::uuid4()),
            code: new AttributeCode('short_description'),
            order: AttributeOrder::fromInteger(3),
            isRequired: AttributeIsRequired::fromBoolean(false),
            isScopable: AttributeIsScopable::fromBoolean(false),
            isLocalizable: AttributeIsLocalizable::fromBoolean(false),
            labelCollection: LabelCollection::fromArray([]),
        ...
        $urlSlug = Attribute::fromType(
            type: new AttributeType(AttributeType::TEXT),
            uuid: AttributeUuid::fromUuid(Uuid::uuid4()),
            code: new AttributeCode('short_description'),
            order: AttributeOrder::fromInteger(4),
            isRequired: AttributeIsRequired::fromBoolean(false),
            isScopable: AttributeIsScopable::fromBoolean(false),
            isLocalizable: AttributeIsLocalizable::fromBoolean(false),
            labelCollection: LabelCollection::fromArray([]),
        ...
        $image1 = Attribute::fromType(
            type: new AttributeType(AttributeType::IMAGE),
            uuid: AttributeUuid::fromUuid(Uuid::uuid4()),
            code: new AttributeCode('image_1'),
        ...
        $this->categoryTemplateAttributeSaver->insert($this->templateUuid, AttributeCollection::fromArray([$shortDescription, $urlSlug, $image1]));

        $attributes = $this->getAttribute->byTemplateUuid($this->templateUuid);

        $attributesUuid = array_map(fn ($attribute) => $attribute->getUuid()->getValue(), $attributes->getAttributes());

        $expectedAttributesOrder = [
            $longDescriptionAttribute->getUuid()->getValue(),
            $shortDescription->getUuid()->getValue(),
            $urlSlug->getUuid()->getValue(),
            $image1->getUuid()->getValue(),
        ];
        $this->assertSame($expectedAttributesOrder, $attributesUuid);
        ...
        $this->updateCategoryTemplateAttributesOrder->fromAttributeUuids($toUpdateAttributes);
