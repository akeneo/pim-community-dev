...
Feature: Export published products
  ...
  Scenario: Successfully export published products
    ...
    """
    sku;categories;description-de_DE-mobile;description-en_US-mobile;description-fr_FR-mobile;enabled;family;groups;main_color;manufacturer;name-de_DE;name-en_US;name-fr_FR;price-EUR;price-USD;size
