...
final class DatabaseMarkCommentsAsReadBySupplierIntegration extends SqlIntegrationTestCase
{
    ...
    /** @test */
    public function itMarksProductFileCommentsReadAsSupplierByInsertingANewLineWhenReadTheFirstTime(): void
    {
        $this->get(MarkCommentsAsReadBySupplier::class)('8a1c76ce-4efe-11ed-bdc3-0242ac120002', new \DateTimeImmutable('2022-10-19 10:05:30'));

        self::assertSame('2022-10-19 10:05:30', $this->findProductFilesCommentsReadDate());
    }

    /** @test */
    public function itUpdatesProductFileCommentsReadDateAsSupplier(): void
    {
        $sql = <<<SQL
        ...
        $this->get(MarkCommentsAsReadBySupplier::class)('8a1c76ce-4efe-11ed-bdc3-0242ac120002', new \DateTimeImmutable('2022-10-20 10:05:30'));
    ...
    private function findProductFilesCommentsReadDate(): ?string
    {
        $sql = <<<SQL
            SELECT last_read_at
            FROM `akeneo_supplier_portal_product_file_comments_read_by_supplier`
