...
class Version_8_0_20230811162400_create_akeneo_workflow_entity_workflow_table_Integration extends TestCase
{
    use ExecuteMigrationTrait;

    private const MIGRATION_LABEL = '_8_0_20230811162400_create_akeneo_workflow_entity_workflow_table';
    private const TABLE_NAME = 'akeneo_workflow_entity_workflow';
