...
use Akeneo\Pim\WorkOrganization\Workflow\Bundle\Command\V20221005122309CleanProductDraftsWithReadOnlyAttributesZddMigration;
use Akeneo\Test\Integration\TestCase;
use Doctrine\DBAL\Connection;
use Doctrine\DBAL\Types\Types;
use PHPUnit\Framework\Assert;

class V20221005122309CleanProductDraftsWithReadOnlyAttributesZddMigrationIntegration extends TestCase
{
    ...
    private function getUserId(string $username): int
    {
        ...
        SQL;
        $stmt = $this->connection->executeQuery($query, ['username' => $username]);
        $id = $stmt->fetchOne();
        if (null === $id) {
    ...
    private function getMigration(): V20221005122309CleanProductDraftsWithReadOnlyAttributesZddMigration
    {
        return $this->get(V20221005122309CleanProductDraftsWithReadOnlyAttributesZddMigration::class);
    }
