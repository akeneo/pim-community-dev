...
const CategoryTreeNode: FunctionComponent<CategoryTreeNodeProps> = ({
  ...
  return (
    <li
      className={`jstree-root jstree-last ${hasChildren ? (isOpen ? 'jstree-open' : 'jstree-closed') : 'jstree-leaf'} ${
        selectedCategory === categoryCode ? 'jstree-checked' : ''
      }`}
    >
      ...
      <a href="#" onClick={event => event.preventDefault()}>
        ...
        <span onClick={() => onSelectCategory(categoryCode, categoryLabel)}>
