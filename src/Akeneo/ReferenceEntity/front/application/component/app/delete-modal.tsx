      ...
      <div className="AknFullPage AknFullPage--modal ">
        <div className="AknFullPage-content AknFormContainer--withPadding AknFormContainer--centered AknFormContainer--expanded">
          <div className="AknFullPage-left">
            <div className="AknFullPage-image AknFullPage-illustration AknFullPage-illustration--delete"></div>
          </div>
          <div className="AknFullPage-right">
            ...
            <div className="AknFullPage-description AknFullPage-description--bottom">
              {message}
            </div>
            <div className="AknButtonList">
              ...
              <button
                className="AknButtonList-item AknButton AknButton--important ok"
                onClick={onConfirm}
              >
