...
class FindAllAssetsTest extends SqlIntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->query = $this->get('akeneo_assetmanager.infrastructure.persistence.query.onboarder.find_all_assets');
        $this->resetDB();
    ...
    public function it_finds_all_asset()
    {
        ...
        Assert::assertContainsEquals(new Onboarder\Asset(
        ...
        Assert::assertContainsEquals(new Onboarder\Asset(
            (string)$this->identifiers['packshot_1'],
            ['de_DE' => null, 'en_US' => null, 'fr_FR' => null],
            'packshot_1',
            'packshot',
            [
                'packshot_image_en_US' => [
                    'data' => [
                        'size' => 5596,
