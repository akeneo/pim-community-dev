...
SQL;
    ...
    private function saveProductAssociation(int $newAssociationId, int $ownerProductModelId): void
    {
...
SQL;
    ...
    private function saveProductModelAssociation(int $newAssociationId, int $ownerProductModelId): void
    {
        $insertProductAssociation = <<<SQL
