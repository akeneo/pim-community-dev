...
Browse example stories now by navigating to them in the sidebar.ssqz
...
<div class="link-list">
  <a class="link-item" onClick={linkTo('Components/Dummy', 'Standard')}>
    <span>
      <strong>Dummy component</strong>
      The bumbest component ever
    </span>
  </a>
