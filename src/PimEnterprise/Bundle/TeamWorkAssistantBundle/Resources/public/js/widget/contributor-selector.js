...
define(
    [
        ...
        'text!team-work-assistant/templates/widget/contributor-selector',
        'text!team-work-assistant/templates/widget/contributor-selector-line'
    ],
            ...
            initializeSelect: function () {
                ...
                var options = {
                                ...
                                .search(searchParameters).then(function (contributors) {
                                    ...
                                    if (1 === page && '' === searchParameters.search) {
                                        choices.unshift({
                                            ...
                                            text: __('team_work_assistant.widget.all_contributors')
                                        });
                                    }
                    ...
                    initSelection: function (element, callback) {
                        var choice = {id: '_all_contributors', text: __('team_work_assistant.widget.all_contributors')};
                    ...
                    ' team-work-assistant-widget-contributor-dropdown',
                ...
                $select.on('change', function (event) {
                    ...
                    this.trigger('team-work-assistant:widget:contributor-selected', code);
                }.bind(this));
                $select.on('select2-open', function () {
                    $('.team-work-assistant-widget-contributor-dropdown .select2-search')
                        .prepend('<i class="icon-search select2-searchIcon"></i>');
                    $('.team-work-assistant-widget-contributor-dropdown .select2-input')
                        .attr('placeholder', __('team_work_assistant.widget.placeholder.contributor_selector'));
                });
                $select.on('select2-close', function () {
                    $('.team-work-assistant-widget-contributor-dropdown .select2-search .icon-search').remove();
                    $('.team-work-assistant-widget-contributor-dropdown .select2-input').attr('placeholder', null);
                });
            },
