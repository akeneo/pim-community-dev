...
namespace Pim\Bundle\ImportExportBundle\tests\integration\Export\ProductQueryBuilder;

use Pim\Bundle\ImportExportBundle\tests\integration\Export\AbstractExportTestCase;
