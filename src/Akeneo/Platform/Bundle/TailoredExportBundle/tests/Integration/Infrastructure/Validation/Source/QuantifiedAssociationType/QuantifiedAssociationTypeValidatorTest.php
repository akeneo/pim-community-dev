...
namespace Akeneo\Platform\TailoredExport\Test\Integration\Infrastructure\Validation\Source\QuantifiedAssociationType;
...
class QuantifiedAssociationTypeValidatorTest extends AbstractValidationTest
{
    /**
    ...
    {
        $violations = $this->getValidator()->validate($value, new QuantifiedAssociationTypeSourceConstraint());
    ...
    {
        return [
            'a valid quantified association products code selection' => [
                [
            ...
            'a valid quantified association product models code selection' => [
                [
                    'uuid' => '51120b12-a2bc-41bf-aa53-cd73daf330d0',
                    'code' => 'attribute_code',
                    'type' => 'attribute',
            ...
            'a valid quantified association products quantity selection' => [
                [
                    'uuid' => '51120b12-a2bc-41bf-aa53-cd73daf330d0',
                    'code' => 'attribute_code',
                    'type' => 'attribute',
            ...
            'a valid quantified association products label selection' => [
                [
                    'uuid' => '51120b12-a2bc-41bf-aa53-cd73daf330d0',
                    'code' => 'attribute_code',
                    'type' => 'attribute',
            ...
            'a valid quantified association product models label selection' => [
                [
                    'uuid' => '51120b12-a2bc-41bf-aa53-cd73daf330d0',
                    'code' => 'attribute_code',
                    'type' => 'attribute',
