...
namespace PimEnterprise\Bundle\CatalogBundle\DependencyInjection\Compiler;
...
class ResolveDoctrineTargetModelPass extends AbstractResolveDoctrineTargetModelPass
{
    ...
    {
        return [
            'PimEnterprise\Component\Catalog\Model\ProductValueInterface' => 'pim_catalog.entity.product_value.class',
        ];
    }
}
