 ...
 */
class Version_1_7_20161219666666_team_work_assistant extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $sql = <<<'SQL'
DROP TABLE IF EXISTS `pimee_team_work_assistant_project`;
CREATE TABLE `pimee_team_work_assistant_project` (
...
ALTER TABLE `pimee_team_work_assistant_project` ADD CONSTRAINT FK_5C87483D1E2E9CAF FOREIGN KEY (datagrid_view_id) REFERENCES `@pim_datagrid.entity.datagrid_view@` (id);
ALTER TABLE `pimee_team_work_assistant_project` ADD CONSTRAINT FK_5C87483D7E3C61F9 FOREIGN KEY (owner_id) REFERENCES `@pim_user.entity.user@` (id);
ALTER TABLE `pimee_team_work_assistant_project` ADD CONSTRAINT FK_5C87483D72F5A1AA FOREIGN KEY (channel_id) REFERENCES `@pim_catalog.entity.channel@` (id);
ALTER TABLE `pimee_team_work_assistant_project` ADD CONSTRAINT FK_5C87483DE559DFD1 FOREIGN KEY (locale_id) REFERENCES `@pim_catalog.entity.locale@` (id);
SQL;
...
SQL;
        ...
        $sql .= <<<'SQL'
DROP TABLE IF EXISTS `pimee_team_work_assistant_project_user_group`;
CREATE TABLE `pimee_team_work_assistant_project_user_group` (
  `project_id` INT NOT NULL,
...
ALTER TABLE `pimee_team_work_assistant_project_user_group` ADD CONSTRAINT FK_826785A5166D1F9C FOREIGN KEY (project_id) REFERENCES `pimee_team_work_assistant_project` (id);
ALTER TABLE `pimee_team_work_assistant_project_user_group` ADD CONSTRAINT FK_826785A51ED93D47 FOREIGN KEY (user_group_id) REFERENCES `@pim_user.entity.group@` (id);

DROP TABLE IF EXISTS `pimee_team_work_assistant_project_status`;
CREATE TABLE `pimee_team_work_assistant_project_status` (
...
ALTER TABLE `pimee_team_work_assistant_project_status` ADD CONSTRAINT FK_2A911294A76ED395 FOREIGN KEY (user_id) REFERENCES `@pim_user.entity.user@` (id);
ALTER TABLE `pimee_team_work_assistant_project_status` ADD CONSTRAINT FK_2A911294166D1F9C FOREIGN KEY (project_id) REFERENCES `pimee_team_work_assistant_project` (id) ON DELETE CASCADE;
...
SQL;
        ...
        $sql = $this->container->get('pimee_team_work_assistant.table_name_mapper')->createQuery($sql);
