...
use Akeneo\Platform\Syndication\Test\Integration\IntegrationTestCase;
...
class FindViewableAttributesIntegrationTest extends IntegrationTestCase
{
    ...
    {
        $this->logAs('admin');
        $viewableAttributesResult = $this->getQuery()->execute('en_US', 3, 0, null, 'string');
        ...
        $viewableAttributesResult = $this->getQuery()->execute('en_US', 3, 3, null, 'string');
        ...
        $viewableAttributesResult = $this->getQuery()->execute('en_US', 3, 6, null, 'string');
        $this->assertEquals(7, $viewableAttributesResult->getOffset());
        $this->assertResultContainAttributeCodes([
            'sku',
        ], $viewableAttributesResult);

        $viewableAttributesResult = $this->getQuery()->execute('en_US', 3, 7, null, 'string');
        $this->assertEquals(7, $viewableAttributesResult->getOffset());
    ...
    {
        $this->logAs('admin');
        $viewableAttributesResult = $this->getQuery()->execute('en_US', 10, 0, null, 'string');
        $this->assertEquals(7, $viewableAttributesResult->getOffset());
        $this->assertResultContainAttributeCodes([
            'text_viewable_by_all',
            'image_viewable_by_all',
    ...
    {
        $this->logAs('admin');
        $viewableAttributesResult = $this->getQuery()->execute('en_US', 3, 0, 'by_admin_and_manager', 'string');
