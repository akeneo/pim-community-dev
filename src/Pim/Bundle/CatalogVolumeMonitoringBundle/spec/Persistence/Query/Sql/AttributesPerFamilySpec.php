...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\AttributesPerFamily;
...
class AttributesPerFamilySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(AttributesPerFamily::class);
    }
