...
final class DatabaseGetProductFileWithCommentsForSupplierIntegration extends SqlIntegrationTestCase
{
    /** @test */
    public function itGetsNullIfThereIsNoProductFileForTheGivenIdentifier(): void
    {
        static::assertNull($this->get(GetProductFileWithCommentsForSupplier::class)('82a69bc5-111b-4b79-9fc1-2421e1d304e7'));
    }
    ...
    public function itDoesNotGetAnyCommentIfThereIsNone(): void
    {
        ...
        $productFile = $this->get(GetProductFileWithCommentsForSupplier::class)('5d001a43-a42d-4083-8673-b64bb4ecd26f');
