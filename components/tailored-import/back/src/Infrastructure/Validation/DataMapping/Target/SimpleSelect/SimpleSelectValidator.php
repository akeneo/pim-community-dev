...
namespace Akeneo\Platform\TailoredImport\Infrastructure\Validation\DataMapping\Target\SimpleSelect;
...
final class SimpleSelectValidator extends ConstraintValidator
{
    public function validate($value, Constraint $constraint): void
    {
        if (!$constraint instanceof SimpleSelect) {
            throw new UnexpectedTypeException($constraint, SimpleSelect::class);
        }
