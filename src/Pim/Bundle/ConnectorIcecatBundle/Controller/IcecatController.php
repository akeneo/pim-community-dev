...
class IcecatController extends Controller
{
    ...
    public function emptyTablesAction()
    {
        ...
        try {
            ...
            $connection->executeUpdate($platform->getTruncateTableSQL('AkeneoCatalog_Product_Attribute', true));
            $connection->executeUpdate($platform->getTruncateTableSQL('AkeneoCatalog_Product_Group', true));
            $connection->executeUpdate($platform->getTruncateTableSQL('AkeneoCatalog_Product_Group_Attribute', true));
