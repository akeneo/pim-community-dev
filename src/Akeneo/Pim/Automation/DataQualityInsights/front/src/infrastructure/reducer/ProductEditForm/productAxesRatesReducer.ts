...
export const getProductAxesRatesAction: ActionCreator<ProductAxesRatesAction> = (productId: number, axesRates: ProductAxesRates) => {
  return {
...
const productAxesRatesReducer: Reducer<ProductAxesRatesState, ProductAxesRatesAction> = (previousState = initialState, {type, payload}) => {
  switch (type) {
