...
class DefaultPresenterSpec extends ObjectBehavior
{
    ...
    function it_supports_all_the_product_values(AbstractProductValue $value)
    {
        $this->supports($value, [])->shouldBe(true);
    }

    function it_presents_change_using_the_injected_renderer(RendererInterface $renderer, AbstractProductValue $value)
    {
