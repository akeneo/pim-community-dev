...
use Akeneo\Category\Domain\Component\CategoryTree\Query;
 ...
 */
class ListGrantedChildrenCategoriesWithCountNotIncludingSubCategories implements Query\ListChildrenCategoriesWithCountNotIncludingSubCategories
{
    /** @var Connection */
    private $connection;
    ...
    private function getRecursivelyCategories(
        ...
        foreach ($categoriesWithCount as $category) {
            $childrenCategoriesToExpand = null !== $subchildCategoryId && $subchildCategoryId === (int) $category['child_id'] ?
                $this->getRecursivelyCategories($userId, $categoryIdsInPath, $translationLocaleCode, $categoryIdToFilterWith): [];
