...
class UpdateUserGroupLocalesPermissionsValidatorSpec extends ObjectBehavior
{
    public function let(
    ...
    public function it_does_nothing_if_valid(
        ...
        $constraint = new UpdateUserGroupLocalesPermissions();
        $validator->validate(Argument::cetera())->willReturn($violations);
        $violations->count()->willReturn(0);
        $context->buildViolation(Argument::any())->shouldNotBeCalled();

        $this->validate('valid', $constraint);
    }
