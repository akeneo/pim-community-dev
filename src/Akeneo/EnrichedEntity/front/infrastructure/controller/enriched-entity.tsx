...
import createStore from 'akeneoenrichedentity/infrastructure/store/enriched-entity/index';
...
class EnrichedEntityController extends BaseController {
  renderRoute() {
...
export = EnrichedEntityController;
