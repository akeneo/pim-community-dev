...
final class MultiReferenceEntityValidator extends ConstraintValidator
{
    public function validate($value, Constraint $constraint): void
    {
        if (!$constraint instanceof MultiReferenceEntity) {
            throw new UnexpectedTypeException($constraint, MultiReferenceEntity::class);
        }
