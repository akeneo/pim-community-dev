 ...
 *
 * A user who wants to search assets given:
 * - A asset family identifier
 * - A channel
 * - A locale
 *
 ...
 */
class SearchAssetsIndexConfigurationTest extends SearchIntegrationTestCase
{
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', []);
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['year']);
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['play']);
        sort($matchingidentifiers);
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['display']);
        sort($matchingidentifiers);
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search(
            'brand',
            'ecommerce',
            'en_US',
            ['experience', 'senses']
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['bang', 'olufsen']);
        sort($matchingidentifiers);
        assert::assertsame(['brand_bangolufsen'], $matchingidentifiers);
    }
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['olufsen', 'bang']);
        sort($matchingidentifiers);
        assert::assertsame(['brand_bangolufsen'], $matchingidentifiers);
    }
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['bangolufsen']);
        sort($matchingidentifiers);
        assert::assertsame(['brand_bangolufsen'], $matchingidentifiers);
    }
    ...
    {
        $matchingidentifiers = $this->searchAssetIndexHelper->search('brand', 'ecommerce', 'en_US', ['88', 'year']);
        sort($matchingidentifiers);
        assert::assertsame(['brand_bangolufsen'], $matchingidentifiers);
    }
