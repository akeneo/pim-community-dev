...
Feature: Notify users after a project creation
  ...
  Scenario: Successfully notify users when creating a project on clothing
    ...
    And I should see notification:
      | type    | message                                                                                 |
      | success | You have new products to enrich for "2016 summer collection". Due date is "12/13/2066". |
    When I logout
  ...
  Scenario: Successfully notify users
    ...
    Then I should have 1 new notification
    Then I open the notification panel
    And I should see the text "You have new products to enrich for \"2016 summer collection\". Due date is \"12/13/2066\"."
    And I am on the products grid
