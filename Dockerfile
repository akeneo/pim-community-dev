...
RUN cp app/config/parameters_test.yml.dist app/config/parameters_test.yml \
  ...
  && chmod 777 -R /tmp/pim app/file_storage app/uploads app/archive tests/legacy/features/Context/fixtures/ vendor/akeneo/pim-community-dev/tests/legacy/features/Context/fixtures/
