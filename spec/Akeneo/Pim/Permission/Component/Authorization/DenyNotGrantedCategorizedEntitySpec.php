...
namespace spec\Akeneo\Pim\Permission\Component\Authorization;
...
class DenyNotGrantedCategorizedEntitySpec extends ObjectBehavior
{
    ...
    function it_does_nothing_for_granted_product_models(
        ...
        $this
            ->shouldNotThrow('Akeneo\Pim\Permission\Component\Exception\ResourceViewAccessDeniedException')
            ->during('denyIfNotGranted', [$productModel]);
