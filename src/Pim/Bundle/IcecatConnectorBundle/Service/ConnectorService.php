<?php
namespace Pim\Bundle\IcecatConnectorBundle\Service;

use Pim\Bundle\IcecatConnectorBundle\Entity\Config;
use Pim\Bundle\IcecatConnectorBundle\Entity\ConfigManager;
use Pim\Bundle\IcecatConnectorBundle\Entity\SourceSupplier;

use Pim\Bundle\IcecatConnectorBundle\Extract\ProductXmlExtractor;
use Pim\Bundle\IcecatConnectorBundle\Extract\SuppliersXmlExtractor;
use Pim\Bundle\IcecatConnectorBundle\Extract\DownloadAndUnpackSource;

use Pim\Bundle\IcecatConnectorBundle\Transform\LanguagesTransform;
use Pim\Bundle\IcecatConnectorBundle\Transform\ProductsTransform;
use Pim\Bundle\IcecatConnectorBundle\Transform\SuppliersTransform;
use Pim\Bundle\IcecatConnectorBundle\Transform\ProductXmlToArrayTransformer;
use Pim\Bundle\IcecatConnectorBundle\Transform\ProductArrayToCatalogProductTransformer;

use Pim\Bundle\IcecatConnectorBundle\Load\BatchLoader;
/**
...
class ConnectorService
{
    ...
    public function importProductFromIcecatXml($productId)
    {
        ...
        $baseProduct = $em->getRepository('PimIcecatConnectorBundle:SourceProduct')->find($productId);
    ...
    {
        $em = $this->container->get('doctrine.orm.entity_manager');
        $products = $em->getRepository('PimIcecatConnectorBundle:SourceProduct')->findBySupplier($supplier);
