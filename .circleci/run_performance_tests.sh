...
docker-compose run -T -u www-data --rm php ./vendor/bin/phpunit -c phpunit.xml.dist --log-junit var/tests/phpunit/phpunit_$(uuidgen).xml --testsuite PIM_Performance_Test
