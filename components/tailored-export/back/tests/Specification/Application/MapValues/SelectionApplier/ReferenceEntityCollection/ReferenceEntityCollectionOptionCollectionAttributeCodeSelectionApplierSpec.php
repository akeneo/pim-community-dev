...
class ReferenceEntityCollectionOptionCollectionAttributeCodeSelectionApplierSpec extends ObjectBehavior
{
    ...
    {
        $selection = new ReferenceEntityCollectionOptionCollectionAttributeCodeSelection(
            ',',
        ...
        $findRecordsAttributeValue->find(
            ...
            'record_code2' => ['option_code3', 'option_code1'],
            'record_code3' => null,
        ]);

        $this->applySelection($selection, $value)->shouldReturn('option_code1|option_code2,option_code3|option_code1,');
    }
    ...
    public function it_applies_the_selection_ignoring_case_and_mapped_values(FindRecordsAttributeValueInterface $findRecordsAttributeValue): void
    {
        ...
        $findRecordsAttributeValue->find(
            ...
            'recOrD_CODe1' => ['option_code1', 'option_code2'],
            'record_code2' => ['option_code3', 'option_code1'],
            'rECORd_code3' => ['option_code5'],
        ]);

        $this->applySelection($selection, $value)->shouldReturn('option_code1;option_code2,I AM MAPPED,option_code5');
    }
    ...
    public function it_applies_the_selection_and_fallback_when_no_value_is_found(
        ...
        $findRecordsAttributeValue->find(
            ...
            'record_code2' => ['option_code2', 'option_code3'],
        ]);

        $this->applySelection($selection, $value)->shouldReturn(',option_code2,option_code3,');
    }
