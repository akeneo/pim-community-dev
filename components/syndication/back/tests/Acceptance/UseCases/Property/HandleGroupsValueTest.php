...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\Group\InMemoryFindGroupLabels;
...
final class HandleGroupsValueTest extends PropertyTestCase
{
    ...
    private function loadGroupLabels(): void
    {
        ...
        $groupLabelsRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindGroupLabelsInterface');
