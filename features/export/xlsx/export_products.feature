...
Feature: Export products in XLSX
  ...
  Scenario: Successfully export products into several files
    ...
    And I launch the export job
    And I wait for the "xlsx_tablet_product_export" job to finish
    Then I press "xlsx_tablet_product_export_1.xlsx" on the "Download generated files" dropdown button
    And I press "xlsx_tablet_product_export_2.xlsx" on the "Download generated files" dropdown button
