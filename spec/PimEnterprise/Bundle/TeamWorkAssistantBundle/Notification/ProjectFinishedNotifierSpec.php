...
class ProjectFinishedNotifierSpec extends ObjectBehavior
{
    ...
    function it_notifies_owner_that_a_project_is_finished(
        ...
        $context = [
            ...
            'buttonLabel' => 'team_work_assistant.notification.project_finished.show',
        ];
        ...
        $projectNotificationFactory->create(
            ...
            $parameters,
            $context,
            'team_work_assistant.notification.project_finished.owner'
    ...
    function it_notifies_contributors_that_a_project_is_finished(
        ...
        $projectNotificationFactory->create(
            ...
            $parameters,
            $context,
            'team_work_assistant.notification.project_finished.contributor'
        )->willReturn($notification);
