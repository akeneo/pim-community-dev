...
Feature: Import attributes with reference data
  ...
  Scenario: Successfully import attributes with reference data
    ...
    pim_reference_data_simpleselect;mycolor;My color;info;0;1;0;0;;;;color
  ...
  Scenario: Fail to import attributes with unregistered reference
    ...
    And I launch the import job
    And I wait for the "footwear_attribute_import" job to finish
    Then I should see "Reference data \"test\" does not exist. Values allowed are: fabrics, color"
