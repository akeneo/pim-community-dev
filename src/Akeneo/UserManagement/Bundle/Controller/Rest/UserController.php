...
final class UserController
{
    ...
    public function postAction(Request $request, int $identifier): Response
    {
        ...
        if (isset($data['roles'])) {
            if ($this->editRolePermissionsUserRepository->isLastRoleWithEditRolePermissionsRoleForUser($data['roles'], $data['username'])) {
    ...
    public function deleteAction(Request $request, int $identifier): Response
    {
        ...
        if ($this->editRolePermissionsUserRepository->isLastUserWithEditRolePermissionsRole($user->getRoles(), $user->getUserIdentifier())) {
