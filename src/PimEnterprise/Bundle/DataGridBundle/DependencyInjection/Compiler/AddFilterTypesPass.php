...
{
    /** @staticvar string */
    const FILTER_PROPOSAL_EXTENSION_ID = 'pimee_datagrid.extension.filter.proposition_filter';
    ...
    {
        $propositionExtension = $container->getDefinition(self::FILTER_PROPOSAL_EXTENSION_ID);
