...
SQL;
        $cityCodes = ['nantes', 'vertou', 'niort', 'limoge', 'bordeaux', 'toulouse', 'dijon', 'digouin', 'puy_en_velay', 'marseille', 'olonne_sur_mer'];
        ...
        return sprintf($fakeCity, $code, $uuid, $code, str_replace('-', '_', $uuid), $label, $label, $temp, $speed, $label, $label, $label, $label, $label);
    }
