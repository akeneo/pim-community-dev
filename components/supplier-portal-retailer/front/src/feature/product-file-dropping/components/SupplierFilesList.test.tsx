...
test('it renders a list of supplier files with supplier column', () => {
    ...
    expect(screen.getByText('supplier_portal.product_file_dropping.supplier_files.columns.supplier')).toBeInTheDocument();
});
...
test('it renders a list of supplier files without supplier column', () => {
    ...
    expect(screen.queryByText('supplier_portal.product_file_dropping.supplier_files.columns.supplier')).not.toBeInTheDocument();
});
