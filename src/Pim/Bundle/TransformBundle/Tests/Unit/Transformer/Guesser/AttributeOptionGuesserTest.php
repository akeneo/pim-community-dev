...
use Pim\Bundle\TransformBundle\Transformer\Guesser\AttributeOptionGuesser;
...
class AttributeOptionGuesserTest extends GuesserTestCase
{
    ...
    public function testMatching($type, $multiple)
    {
        ...
        $repository = $this->getMock('Akeneo\Bundle\StorageUtilsBundle\Repository\IdentifiableObjectRepositoryInterface');
