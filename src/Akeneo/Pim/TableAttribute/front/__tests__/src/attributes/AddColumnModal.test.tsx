...
describe('AddColumnModal', () => {
  it('should render the component', async () => {
    ...
    expect(
      screen.getByText('pim_table_attribute.form.attribute.add_column')
    ).toBeInTheDocument();
  ...
  it('should add column', async () => {
    ...
    const dataTypeInput = screen.getByLabelText(
      'pim_table_attribute.form.attribute.data_type'
    ) as HTMLInputElement;
    ...
    expect(
      screen.getByText('pim_table_attribute.properties.data_type.text')
    ).toBeInTheDocument();
    fireEvent.click(
      screen.getByText('pim_table_attribute.properties.data_type.text')
    );
  ...
  it('should display validation errors', async () => {
    ...
    expect(
      screen.getByText('pim_table_attribute.validations.invalid_code')
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByText(
        'pim_table_attribute.validations.column_code_must_be_filled'
      )
    ).toBeInTheDocument();
    expect(createButton.disabled).toEqual(true);
    ...
    expect(
      screen.getByText('pim_table_attribute.validations.duplicated_column_code')
    ).toBeInTheDocument();
    expect(createButton.disabled).toEqual(true);
