...
use Akeneo\Catalogs\Infrastructure\Validation\ProductMapping\AttributeSourceContainsValidCurrency;
 ...
 */
final class AttributePriceCollectionSource extends Compound
{
    /**
    ...
    protected function getConstraints(array $options = []): array
    {
        return [
            new Assert\Sequentially([
                ...
                new AttributeSourceContainsValidCurrency(),
            ]),
        ];
    }
}
