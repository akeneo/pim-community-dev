...
Feature: Publish many products at once
  ...
  Scenario: Succesfully mass publish associated product
    ...
    """
    sku;categories;datasheet;description-de_DE-mobile;description-en_US-mobile;description-fr_FR-mobile;enabled;family;groups;handmade;length;length-unit;main_color;manufacturer;name-de_DE;name-en_US;name-fr_FR;number_in_stock-mobile;PACK-groups;PACK-product_models;PACK-products;price-EUR;price-USD;rating;release_date-mobile;secondary_color;side_view;size;SUBSTITUTION-groups;SUBSTITUTION-product_models;SUBSTITUTION-products;top_view;UPSELL-groups;UPSELL-product_models;UPSELL-products;weather_conditions;X_SELL-groups;X_SELL-product_models;X_SELL-products
