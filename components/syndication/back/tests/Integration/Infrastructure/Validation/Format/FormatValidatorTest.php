...
namespace Akeneo\Platform\Syndication\Test\Integration\Infrastructure\Validation\Format;

use Akeneo\Platform\Syndication\Infrastructure\Validation\Format\Format;
    ...
    public function invalidFormat(): array
    {
        return [
            ...
            'max text element reached' => [
                'akeneo.syndication.validation.concatenation.max_text_count_reached',
                '[elements]',
                [
                    'type' => 'concat',
                    'space_between' => false,
