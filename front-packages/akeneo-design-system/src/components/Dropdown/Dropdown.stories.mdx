...
import {PreviewGrid, SpaceContainer, useSelection, fakeFetcher} from '../../storybook';
...
## Position
<Canvas>
  <Story name="Position" height={260}>
    {args => {
        ...
        <SpaceContainer height={300}>
          <PreviewGrid width="40%">
            ...
            <Dropdown>
              ...
              {isOpenBottomLeft && (
                <Dropdown.Overlay verticalPosition="up" onClose={closeBottomLeft}>
                  <Dropdown.Header>
                    <Dropdown.Title>Elements</Dropdown.Title>
                  </Dropdown.Header>
                  <Dropdown.ItemCollection>
            ...
            <Dropdown>
              ...
              {isOpenBottomRight && (
                <Dropdown.Overlay verticalPosition="up" onClose={closeBottomRight}>
                  <Dropdown.Header>
                    <Dropdown.Title>Elements</Dropdown.Title>
                  </Dropdown.Header>
                  <Dropdown.ItemCollection>
