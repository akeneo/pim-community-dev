...
class BooleanTypeSpec extends ObjectBehavior
{
    ...
    {
        $isAvailable->getBackendType()->willReturn(AttributeTypes::BACKEND_TYPE_BOOLEAN);
        $this->prepareValueFormName($value)->shouldReturn(AttributeTypes::BACKEND_TYPE_BOOLEAN);
    }
