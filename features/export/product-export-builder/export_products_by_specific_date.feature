...
Feature: Export products according to a date
  ...
  Scenario: Export only the products updated by the UI since the last export
    ...
    Then exported file of "csv_footwear_product_export" should contain:
      """
      sku;categories;enabled;family;groups;color;description-en_US-mobile;lace_color;manufacturer;name-en_US;PACK-groups;PACK-productmodels;PACK-products;price-EUR;price-USD;rating;side_view;size;SUBSTITUTION-groups;SUBSTITUTION-productmodels;SUBSTITUTION-products;top_view;UPSELL-groups;UPSELL-productmodels;UPSELL-products;weather_conditions;X_SELL-groups;X_SELL-productmodels;X_SELL-products
