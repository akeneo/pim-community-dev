...
namespace spec\Akeneo\Tool\Component\FileMetadata\Adapter;
...
class AdapterRegistrySpec extends ObjectBehavior
{
    ...
    function it_throws_an_exception_if_an_adapter_is_already_registered($exifAdapter, $iptcAdapter)
    {
        ...
        $this->shouldThrow('Akeneo\Tool\Component\FileMetadata\Exception\AlreadyRegisteredAdapterException')
    ...
    function it_throws_an_exception_if_an_adapter_cant_be_found($exifAdapter)
    {
        ...
        $this->shouldThrow('Akeneo\Tool\Component\FileMetadata\Exception\NonRegisteredAdapterException')
            ->during('get', ['iptc']);
    }
