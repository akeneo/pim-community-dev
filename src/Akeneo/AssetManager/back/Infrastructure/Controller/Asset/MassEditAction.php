...
use Akeneo\AssetManager\Application\Asset\MassEditAssets\MassEditAssetsHandler;
...
class MassEditAction
{
    ...
    public function __invoke(Request $request, string $assetFamilyIdentifier): Response
    {
        ...
        ($this->massEditAssetsHandler)($command);
