...
{
    public function let(SendApiEventRequestLogger $sendApiEventRequestLogger): void
    {
    ...
    public function it_sends_webhook_requests_in_bulk(SendApiEventRequestLogger $sendApiEventRequestLogger): void
    {
        $container = [];
