...
class FillMissingPublishedProductValuesSpec extends ObjectBehavior
{
    function let(
        ...
        $familyWithPrice->addAttribute(
            (new Builder())->aPriceCollectionAttribute()->withCode('localizable_scopable_price')->localizable()
                           ->scopable()->build()
        );
    ...
    function it_does_nothing_on_published_products_without_family()
    {
        $this->fromStandardFormat(
            [
                'family' => null,
