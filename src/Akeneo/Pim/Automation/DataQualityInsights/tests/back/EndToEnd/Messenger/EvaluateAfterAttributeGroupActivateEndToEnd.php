...
final class EvaluateAfterAttributeGroupActivateEndToEnd extends MessengerTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->evaluateAfterAttributeGroupActivateQueueStatus->createTopicAndSubscription();
        $this->evaluateAfterAttributeGroupActivateQueueStatus->flushJobQueue();
        $this->launchProductEvaluationsQueueStatus->createTopicAndSubscription();
        $this->launchProductEvaluationsQueueStatus->flushJobQueue();
    }
