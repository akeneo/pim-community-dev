...
final class AssetCollectionValidator extends ConstraintValidator
{
    public function validate($value, Constraint $constraint): void
    {
        if (!$constraint instanceof AssetCollection) {
            throw new UnexpectedTypeException($constraint, AssetCollection::class);
        }
