...
Feature: Export media with products
  ...
  Scenario: Successfully export media
    ...
    And the following product values:
      ...
      | average-joe         | Name        | Average Joe             |
    And the following category:
      | code  | label | parent  | products                                       |
      | sport | Sport | default | bic-core-148, fanatic-freewave-76, average-joe |
    ...
    average-joe;funboard;;sport;;"Average Joe";
