...
class FilterLocaleValueSubscriberSpec extends ObjectBehavior
{
    ...
    function it_removes_locale_when_necessary(FormEvent $event, FormInterface $form, ValueInterface $value, AttributeInterface $attribute)
    {
        $attribute->isLocalizable()->willReturn(true);
        $value->getLocale()->willReturn('de_DE');
    ...
    function it_adds_value_to_the_form(FormEvent $event, FormInterface $form, ValueInterface $value, AttributeInterface $attribute)
    {
