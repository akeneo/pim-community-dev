      ...
      if (isMethodCall) {
        ...
        this.each(function () {
          var instance = instances[$.data(this, 'jstree_instance_id')],
            methodValue =
              instance && $.isFunction(instance[settings]) ? instance[settings].apply(instance, args) : instance;
          if (
          ...
          if (check) {
            ...
            switch (!0) {
              case is_range:
                ...
                obj = obj[obj.index() < this.data.ui.last_selected.index() ? 'nextUntil' : 'prevUntil'](
            ...
            .delegate(
              ...
              $.proxy(function (e) {
                if (
                  ...
                  this._get_settings().dnd.drop_check.call(this, {o: o, r: $(e.target), e: e})
                ) {
                  $.vakata.dnd.helper.children('ins').attr('class', 'jstree-ok');
                }
              }, this)
    ...
    $.jstree.plugin('checkbox', {
      __init: function () {
        ...
        this.get_container()
          ...
          .delegate(
            this.data.ui && this.data.checkbox.noui ? 'a' : 'ins.jstree-checkbox',
            'click.jstree',
            $.proxy(function (e) {
              e.preventDefault();
      ...
      _fn: {
        ...
        _prepare_checkboxes: function (obj) {
          ...
          obj.each(function () {
            t = $(this);
            c =
              t.is('li') && (t.hasClass('jstree-checked') || (rc && t.children(':checked').length))
                ? 'jstree-checked'
                : 'jstree-unchecked';
            t.find('li')
              .addBack()
        ...
        get_checked: function (obj, get_all) {
          ...
          return get_all || this._get_settings().checkbox.two_state
            ...
            : obj.find('> ul > .jstree-checked, .jstree-undetermined > ul > .jstree-checked');
        },
        get_unchecked: function (obj, get_all) {
          obj = !obj || obj === -1 ? this.get_container() : this._get_node(obj);
          return get_all || this._get_settings().checkbox.two_state
            ? obj.find('.jstree-unchecked')
            : obj.find('> ul > .jstree-unchecked, .jstree-undetermined > ul > .jstree-unchecked');
        },
    ...
    $.vakata.context = {
      ...
      parse: function (s, is_callback) {
        ...
        $.each(s, function (i, val) {
          ...
          was_sep = false;
          str +=
            "<li class='" + (val._class || '') + (val._disabled ? ' jstree-contextmenu-disabled ' : '') + "'><ins ";
      ...
      _fn: {
        ...
        create_node: function (obj, position, js, callback, is_loaded, skip_check) {
          if (!skip_check && (is_loaded || this._is_loaded(obj))) {
            var p =
                typeof position === 'string' && position.match(/^before|after$/i) && obj !== -1
          ...
          .bind(
            ...
            $.proxy(function (e, data) {
              this.get_container()
                ...
                .removeClass(
                  'jstree-clicked ' + (this.data.themeroller ? this._get_settings().themeroller.item_a : '')
                );
            }, this)
          )
          .bind(
          ...
          .bind(
            ...
            $.proxy(function (e, data) {
              this.get_container()
                ...
                .removeClass(
                  'jstree-hovered ' + (this.data.themeroller ? this._get_settings().themeroller.item_h : '')
                );
