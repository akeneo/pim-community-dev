...
final class IsTableAttributeConfiguredValidator extends ConstraintValidator
{
    public function validate($value, Constraint $constraint): void
    {
        ...
        if (AttributeTypes::TABLE !== $value->getType() && null !== $value->getRawTableConfiguration()) {
            $this->context
                ->buildViolation('pim_table_configuration.validation.table_configuration.must_not_be_filled', [])
            ...
            $this->context
                ->buildViolation('pim_table_configuration.validation.table_configuration.must_be_filled', [])
