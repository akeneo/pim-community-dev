...
namespace spec\Pim\Component\Connector\Denormalizer\ProductValue;

use PhpSpec\ObjectBehavior;
use Pim\Component\Catalog\Model\AttributeInterface;
use Pim\Component\Catalog\Model\AttributeOptionInterface;
use Pim\Component\Catalog\Model\ProductValueInterface;
use Pim\Component\Connector\Denormalizer\ProductValue\AttributeOptionDenormalizer;
...
class AttributeOptionsDenormalizerSpec extends ObjectBehavior
{
    ...
    function it_denormalizes_attribute_options(
        $denormalizer,
        ...
        $denormalizer->denormalize('1', 'pim_catalog_simpleselect', Argument::cetera())
            ->shouldBeCalled()
            ->willReturn($red);
        $denormalizer->denormalize('2', 'pim_catalog_simpleselect', Argument::cetera())
            ->shouldBeCalled()
            ->willReturn($blue);
        $denormalizer->denormalize('3', 'pim_catalog_simpleselect', Argument::cetera())
            ->shouldBeCalled()
            ->willReturn($green);
