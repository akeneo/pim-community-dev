...
Feature: Export products
  ...
  Scenario: Successfully export products to multiple channels
    ...
    """
    sku;name-en_US;name-en_GB;name-fr_FR;name-de_DE;description-en_US-ecommerce;description-en_GB-ecommerce;description-fr_FR-ecommerce;description-de_DE-ecommerce;price;size;color;manufacturer;country_of_manufacture;material;categories;enabled;family;groups;additional_colors;cost;customer_rating-ecommerce;customs_tax;handmade;image;number_in_stock-ecommerce;release_date-ecommerce;thumbnail;washing_temperature;weight
