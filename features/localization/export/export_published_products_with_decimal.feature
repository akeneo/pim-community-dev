...
Feature: Export published products with localized number
  ...
  Scenario: Successfully export published products
    ...
    Then exported file of "clothing_mobile_published_product_export" should contain:
      ...
      jacket-white;jackets,winter_collection;"Ein sehr elegantes weißes Jacket";"An elegant white jacket";"A really stylish white jacket";"Un Jacket blanc élégant";1;jackets;paint;;white;Volcom;"Weißes Jacket";"White jacket";"White jacket";"Jacket blanc";10,45;15,00;XL
