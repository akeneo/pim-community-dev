...
<Meta
  ...
  args={{level: 'primary', children: 'BreadcrumbBh text'}}
/>
...
<Canvas>
  <Story name="Standard">
    {args => {
      return (
        <BreadcrumbBh>
            <PathItem href="http://www.akeneo.com/settings">Settings</PathItem>
            <Separator>/</Separator>
            <PathItem href="http://www.akeneo.com/attributes">Attributes</PathItem>
            <Separator>/</Separator>
            <PathItem href="http://www.akeneo.com/brand">Brand</PathItem>
        </BreadcrumbBh>
      );
    }}
  </Story>
