...
class MaxShouldBeGreaterThanMinValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldThrow(\InvalidArgumentException::class)->during('validate', [['min' => 0, 'max' => 10], new NotBlank()]);
    }

    function it_should_add_a_violation_when_min_is_greater_than_max(ExecutionContextInterface $context, ConstraintViolationBuilderInterface $violationBuilder){
