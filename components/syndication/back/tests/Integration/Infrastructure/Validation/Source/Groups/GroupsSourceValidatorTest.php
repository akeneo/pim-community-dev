...
namespace Akeneo\Platform\Syndication\Test\Integration\Infrastructure\Validation\Source\Groups;

use Akeneo\Platform\Syndication\Infrastructure\Validation\Source\Groups\GroupsSourceConstraint;
use Akeneo\Platform\Syndication\Test\Integration\Infrastructure\Validation\AbstractValidationTest;
use Akeneo\Test\Integration\Configuration;

class GroupsSourceValidatorTest extends AbstractValidationTest
{
    /**
    ...
    {
        $violations = $this->getValidator()->validate($value, new GroupsSourceConstraint());
    ...
    public function validSource(): array
    {
        return [
            ...
            'a valid groups label selection' => [
                [
                    'uuid' => '51120b12-a2bc-41bf-aa53-cd73daf330d0',
                    'code' => 'groups',
                    'type' => 'property',
            ...
            'a valid groups selection with default value' => [
                [
                    'uuid' => '51120b12-a2bc-41bf-aa53-cd73daf330d0',
                    'code' => 'groups',
                    'type' => 'property',
