...
const SpellcheckPopoverDisclosure: FC<SpellcheckPopoverDisclosureProps> = ({setLocale, setContent, setMistake, setActiveHighlight, setActiveElement, setAnalyze, ...props}) => {
  ...
  const handleSetActiveHighlight = useCallback((highlight: HighlightElement|null) => {
  ...
  return <HighlightPopoverDisclosure {...props} setActiveHighlight={handleSetActiveHighlight} setActiveElement={setActiveElement}/>;
}
