...
namespace AkeneoTestEnterprise\Pim\WorkOrganization\EndToEnd\PublishedProduct\Export;
 ...
 * +----------+-------------------------------+-----------------------------------+-----------------------------------------------------+
 */
class ExportPublishedProductsWithoutPermissionsEndToEnd extends AbstractPublishedProductExportTestCase
{
