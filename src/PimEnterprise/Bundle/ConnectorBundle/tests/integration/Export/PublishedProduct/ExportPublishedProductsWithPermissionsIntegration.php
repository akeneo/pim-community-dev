...
CSV;
    ...
    {
        $expectedCsv = <<<CSV
sku;categories;enabled;family;groups;X_SELL-groups;X_SELL-products;X_SELL-productmodels;UPSELL-groups;UPSELL-products;UPSELL-productmodels;SUBSTITUTION-groups;SUBSTITUTION-products;SUBSTITUTION-productmodels;PACK-groups;PACK-products;PACK-productmodels
