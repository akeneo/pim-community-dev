          ...
          <Dropdown {...args}>
            ...
            {isOpen && (
              <>
                ...
                <Dropdown.Overlay position="down" onClose={close}>
                  <Dropdown.Header>
    ...
    {args => {
      ...
      return (
        <SpaceContainer height={200}>
          <Dropdown>
            <Dropdown.Action onClick={open}>
              <Button>Simple Item Dropdown</Button>
            </Dropdown.Action>
            {isOpen && (
              <>
                <Dropdown.Backdrop onClick={close} />
    ...
    {args => {
      ...
      return (
        <SpaceContainer height={200}>
          <Dropdown>
            <Dropdown.Action onClick={open}>
              <Button>Selectable Item Dropdown</Button>
            </Dropdown.Action>
            {isOpen && (
              <>
                <Dropdown.Backdrop onClick={close} />
                <Dropdown.Overlay position="down" onClose={close}>
                  ...
                  <Dropdown.ItemCollection>
                    <Dropdown.SelectableItem {...firstSelection}>Item 1</Dropdown.SelectableItem>
                    <Dropdown.SelectableItem {...secondSelection}>Item 2</Dropdown.SelectableItem>
                    <Dropdown.SelectableItem {...thirdSelection}>Item 3</Dropdown.SelectableItem>
                    <Dropdown.SelectableItem {...fourthSelection}>Item 4</Dropdown.SelectableItem>
                  </Dropdown.ItemCollection>
                </Dropdown.Overlay>
              </>
            )}
    ...
    {args => {
      ...
      return (
        <SpaceContainer height={300}>
          <Dropdown>
            <Dropdown.Action onClick={open}>
              <Button>Image Item Dropdown</Button>
            </Dropdown.Action>
            {isOpen && (
              <>
                <Dropdown.Backdrop onClick={close} />
