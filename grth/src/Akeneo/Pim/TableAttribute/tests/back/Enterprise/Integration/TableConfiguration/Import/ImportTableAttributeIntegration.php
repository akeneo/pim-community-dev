...
nutrition;pim_catalog_table;0;0;other;0;2;[{"code":"ingredients","data_type":"select","labels":{"en_US":"Ingredients"},"options":[{"code":"salt","labels":{"en_US":"Salt"}}]},{"code":"quantity","data_type":"text","labels":{"en_US":"Quantity"},"validations":{"max_length":50},"is_required_for_completeness":true},{"code":"brand","data_type":"record","is_required_for_completeness":false,"reference_entity_code":"brands"}]
CSV;
        ...
        Assert::assertEqualsCanonicalizing(
            [
                ...
                ['code' => 'brand', 'data_type' => 'record', 'labels' => (object) [], 'validations' => (object) [], 'is_required_for_completeness' => false, 'reference_entity_code' => 'brands'],
            ],
        ...
        $writer->addRows(
            [
                ...
                WriterEntityFactory::createRowFromArray([
                    ...
                    '0',
                    '5',
                    '[{"code":"ingredients","data_type":"select","labels":{"en_US":"Ingredients"},"options":[{"code":"salt","labels":{"en_US":"Salt"}}]},{"code":"quantity","data_type":"text","labels":{"en_US":"Quantity"}},{"code":"brand","data_type":"record","is_required_for_completeness":false,"reference_entity_code":"brands"}]',
                ]),
            ]
        );
        $writer->close();
