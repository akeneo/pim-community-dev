...
use PimEnterprise\Bundle\ProductAssetBundle\Persistence\Query\Sql\CountAssetCategories;
use Prophecy\Argument;

class CountAssetCategoriesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(CountAssetCategories::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'count_asset_categories'));
    }
}
