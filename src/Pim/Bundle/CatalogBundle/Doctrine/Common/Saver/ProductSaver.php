...
class ProductSaver implements SaverInterface, BulkSaverInterface
{
    ...
    public function save($product, array $options = [])
    {
        ...
        $this->eventDispatcher->dispatch(BaseEvents::PRE_SAVE, new GenericEvent($product));
        ...
        $this->eventDispatcher->dispatch(BaseEvents::POST_SAVE, new GenericEvent($product));
    }
    ...
    public function saveAll(array $products, array $options = [])
    {
        ...
        $this->eventDispatcher->dispatch(BaseEvents::PRE_SAVE_ALL, new GenericEvent($products));
        ...
        $this->eventDispatcher->dispatch(BaseEvents::POST_SAVE_ALL, new GenericEvent($products));
    }
}
