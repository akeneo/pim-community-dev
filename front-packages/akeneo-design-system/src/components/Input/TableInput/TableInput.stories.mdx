...
<Canvas>
  <Story name="Standard">
    {args => {
      const {getValue, setValue, searchValue, setSearchValue, match} = useFakeTableInput(6);
      ...
      return (
        <TableInput {...args}>
          ...
          <TableInput.Body>
            {[...Array(linesCount).keys()].map((_,r) => {
              return <TableInput.Row key={r}>
                <TableInput.Cell><TableInput.CellContent rowTitle={true} highlighted={r === 0}>Value</TableInput.CellContent></TableInput.Cell>
                <TableInput.Cell><TableInput.CellContent highlighted={r === 1}>Value</TableInput.CellContent></TableInput.Cell>
                <TableInput.Cell><TableInput.Select onSearchChange={() => {}} value={'Select value'} highlighted={r === 2}/></TableInput.Cell>
                <TableInput.Cell><TableInput.Text value={'Text value'} highlighted={r === 3}/></TableInput.Cell>
                <TableInput.Cell><TableInput.Number value={42} highlighted={r === 4}/></TableInput.Cell>
                <TableInput.Cell><TableInput.Boolean value={true} yesLabel={"Yes"} noLabel={"No"} highlighted={r === 5}/></TableInput.Cell>
              </TableInput.Row>
            })}
          </TableInput.Body>
        </TableInput>
      ...
      return (
        <TableInput {...args}>
          ...
          <TableInput.Body>
            {[...Array(linesCount).keys()].map((_,r) => {
              return <TableInput.Row key={r}>
                <TableInput.Cell><TableInput.CellContent inError={r == 0} rowTitle={true}>Value</TableInput.CellContent></TableInput.Cell>
                <TableInput.Cell><TableInput.CellContent inError={r == 1}>Value</TableInput.CellContent></TableInput.Cell>
                <TableInput.Cell><TableInput.Select onSearchChange={() => {}} value={'Select value'} inError={r == 2}/></TableInput.Cell>
                <TableInput.Cell><TableInput.Text value={'Text value'} inError={r == 3}/></TableInput.Cell>
                <TableInput.Cell><TableInput.Number value={42} inError={r == 4}/></TableInput.Cell>
                <TableInput.Cell><TableInput.Boolean value={true} yesLabel={"Yes"} noLabel={"No"} inError={r == 5}/></TableInput.Cell>
              </TableInput.Row>
            })}
          </TableInput.Body>
        </TableInput>
