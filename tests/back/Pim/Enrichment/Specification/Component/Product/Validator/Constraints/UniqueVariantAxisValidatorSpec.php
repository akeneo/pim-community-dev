...
class UniqueVariantAxisValidatorSpec extends ObjectBehavior
{
    ...
    function it_raises_a_violation_if_there_is_a_duplicate_boolean_value_in_any_sibling_variant_product(
        ...
        UniqueVariantAxis $constraint,
        ConstraintViolationBuilderInterface $violation,
        ScalarValueFactory $scalarValueFactory
    ) {
        ...
        $entity->getValuesForVariation()->willReturn(
            new ValueCollection(
                [
                    $scalarValueFactory->create($booleanAttribute->getWrappedObject(), null, null, false),
                ]
            )
        );
        ...
        $getValuesOfSiblings->for($entity)->willReturn(
            [
                'sibling1' => new ValueCollection(
                    [
                        $scalarValueFactory->create($booleanAttribute->getWrappedObject(), null, null, true),
                    ]
                ),
