...
namespace Specification\Akeneo\Asset\Bundle\Doctrine\ORM\Repository;
...
class AssetRepositorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(AssetRepositoryInterface::class);
    }

    function let(EntityManager $em, Connection $connection) {
        $classMetadata = new ClassMetadata(Asset::class);
