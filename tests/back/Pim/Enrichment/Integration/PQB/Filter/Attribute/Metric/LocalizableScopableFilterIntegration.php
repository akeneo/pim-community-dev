...
class LocalizableScopableFilterIntegration extends AbstractProductQueryBuilderTestCase
{
    ...
    public function testErrorMetricLocalizable()
    {
        ...
        $this->expectExceptionMessage('The a_scopable_localizable_metric attribute requires a locale.');
    ...
    {
        $this->expectException(InvalidPropertyException::class);
        $this->expectExceptionMessage('The a_scopable_localizable_metric attribute requires a value per channel.');
