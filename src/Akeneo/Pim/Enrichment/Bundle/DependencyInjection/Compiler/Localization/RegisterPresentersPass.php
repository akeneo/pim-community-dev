...
{
    public const LOCALIZATION_PRESENTER_REGISTRY = 'pim_catalog.localization.presenter.registry';

    public const LOCALIZATION_PRESENTER_TAG = 'pim_catalog.localization.presenter';
