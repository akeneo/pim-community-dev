...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\ScopableAttributes;
...
class ScopableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ScopableAttributes::class);
    }
