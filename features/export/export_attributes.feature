Feature: Export attributes
  ...
  Scenario: Successfully export attributes
    ...
    """
    type;code;label-en_US;group;unique;useable_as_grid_column;useable_as_grid_filter;is_translatable;is_scopable
    ...
    pim_catalog_image;side_view;"Side view";media;0;0;0;0;0
    pim_catalog_image;top_view;"Top view";media;0;0;0;0;0
