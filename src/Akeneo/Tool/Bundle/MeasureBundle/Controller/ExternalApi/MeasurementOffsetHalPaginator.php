 ...
 */
class MeasurementOffsetHalPaginator implements PaginatorInterface
{
    /** @var RouterInterface */
    protected $router;
    ...
    public function __construct(RouterInterface $router)
    {
        ...
        $this->resolver->setDefaults(['uri_parameters' => []]);

        $this->resolver->setRequired(['query_parameters', 'list_route_name',]);
