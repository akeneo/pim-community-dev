...
class SqlGetConnectorProductsIntegration extends TestCase
{
    ...
    public function test_get_product_from_a_uuid()
    {
        ...
        $connectorProduct = $query->fromProductUuid($this->productB->getUuid(), (int) $userId);
        ...
        $productData = $this->get('database_connection')->executeQuery(
            ...
            ['product_uuid' => [$connectorProduct->uuid()->getBytes()]],
            ['product_uuid' => Connection::PARAM_STR_ARRAY]
        )->fetch();

        $expectedConnectorProduct = new ConnectorProduct(
        ...
        $this->assertEquals($expectedConnectorProduct, $connectorProduct);
    }
    ...
    public function test_get_product_from_uuids()
    {
        ...
        $connectorProductList = $query->fromProductUuids(
            [$this->productA->getUuid(), $this->productB->getUuid()],
            (int) $userId,
            null,
            null,
            null
    ...
    public function test_it_throws_an_exception_when_product_is_not_found()
    {
        ...
        $query = $this->getQuery();
        $query->fromProductUuid(Uuid::fromString('618dc7ab-873e-4d19-b3dd-67dbab63aece'), (int) $userId);
    }
    ...
    private function getQuery(): SqlGetConnectorProducts
    {
