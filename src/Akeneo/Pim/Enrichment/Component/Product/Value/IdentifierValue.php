 ...
 */
final class IdentifierValue implements ValueInterface
{
    private function __construct(private readonly string $attributeCode, private readonly bool $isMainIdentifier, private readonly ?string $data)
    {
    }
