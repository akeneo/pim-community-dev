...
use PimEnterprise\Component\ActivityManager\Calculator\AttributeGroupCompletenessCalculator;
...
class AttributeGroupCompletenessCalculatorSpec extends ObjectBehavior
{
    ...
    function it_pre_processes_completeness_when_all_product_values_are_filled_for_an_attribute_group(
        ...
        $result[0]->shouldBeAnInstanceOf('PimEnterprise\Component\ActivityManager\Model\AttributeGroupCompleteness');
        $result[1]->shouldBeAnInstanceOf('PimEnterprise\Component\ActivityManager\Model\AttributeGroupCompleteness');
