...
Feature: Browse attributes
  ...
  Scenario: Successfully view, sort and filter attributes
    ...
    And I should be able to use the following filters:
      ...
      | Scopable    | no     | sku, name, manufacturer, weather_conditions, price, rating, side_view, top_view, size, color, lace_color and length |
      | Localizable | yes    | name and description                                                                                                |
      | Localizable | no     | sku, manufacturer, weather_conditions, price, rating, side_view, top_view, size, color, lace_color and length       |
