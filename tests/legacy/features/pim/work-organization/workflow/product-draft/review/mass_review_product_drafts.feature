...
Feature: Approve or refuse several product drafts at once
  ...
  Scenario: Successfully approve user proposals
    Given the following product drafts:
      | product        | status | source | source_label | author | author_label  | result                                                                                                                                                                   |
      | leather-jacket | ready  | pim    | PIM          | Sandra | Sandra Harvey | {"values":{"name":[{"locale":"en_US","scope":null,"data":"Awesome leather jacket"}]}, "review_statuses":{"name":[{"locale":"en_US","scope":null,"status":"to_review"}]}} |
      | wool-jacket    | ready  | pim    | PIM          | Mary   | Mary Smith    | {"values":{"name":[{"locale":"en_US","scope":null,"data":"Lame wool jacket"}]}, "review_statuses":{"name":[{"locale":"en_US","scope":null,"status":"to_review"}]}}       |
    And I am on the proposals page
    Then I filter by "author" with operator "in list" and value "Sandra"
    And I select rows Leather jacket
    And I press the "Approve all selected" button
    And I confirm the action
    Then I should not see the text "Sorry, page was not loaded correctly"
  ...
  Scenario: Successfully approve proposals between dates
    Given the following product drafts:
      | product        | status | source | source_label | author                               | author_label                         | result                                                                                                                                                                   | createdAt           |
      | leather-jacket | ready  | pim    | PIM          | csv_clothing_product_proposal_import | CSV Clothing Product Proposal Import | {"values":{"name":[{"locale":"en_US","scope":null,"data":"Awesome leather jacket"}]}, "review_statuses":{"name":[{"locale":"en_US","scope":null,"status":"to_review"}]}} | 2014-01-01 00:00:00 |
      | wool-jacket    | ready  | pim    | PIM          | csv_clothing_product_proposal_import | CSV Clothing Product Proposal Import | {"values":{"name":[{"locale":"en_US","scope":null,"data":"Lame wool jacket"}]}, "review_statuses":{"name":[{"locale":"en_US","scope":null,"status":"to_review"}]}}       | 2015-01-01 00:00:00 |
    And I am on the proposals page
