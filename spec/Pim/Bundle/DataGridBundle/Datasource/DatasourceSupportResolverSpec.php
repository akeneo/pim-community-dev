...
class DatasourceSupportResolverSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith(AkeneoDoctrineHybridSupportExtension::DOCTRINE_MONGODB_ODM);
    ...
    {
        $this->beConstructedWith(AkeneoDoctrineHybridSupportExtension::DOCTRINE_ORM, []);
