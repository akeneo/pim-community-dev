 ...
 */
final class Version_5_0_20200313130000_create_audit_product_table extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $createTableAuditProductSql = <<<SQL
...
SQL;
        $this->addSql($createTableAuditProductSql);
