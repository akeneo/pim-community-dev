...
class GetProductQuery implements GetProductQueryInterface
{
    ...
    public function __construct(
        private IsValidCatalogProductQueryInterface $isValidCatalogProductQuery,
     ...
     * @inheritDoc
     */
    public function execute(string $catalogId, string $productUuid): ?array
    {
        if (!$this->isValidCatalogProductQuery->execute($catalogId, $productUuid)) {
            return null;
        }
        ...
        $valueFilters = $this->getCatalogProductValueFiltersQuery->execute($catalogId);
