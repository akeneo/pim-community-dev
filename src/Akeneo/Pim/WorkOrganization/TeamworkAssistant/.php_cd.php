...
$rules = [
    ...
    $builder->only([
        ...
        'Akeneo\UserManagement\Component\Model\UserInterface',
        'Akeneo\Pim\Enrichment\Component\Product\Model\ProductInterface',
        // TODO the project should not be linked to a project, we should use project filter instead
        ...
        // TODO pre processed data are computed through value complete checker
