import {TabMenuEntry} from './TabMenuEntry';
...
console.log('render TabMenuEntry', TabMenuEntry)
        this.renderReact(TabMenuEntry, {
            active: this.active,
            title: this.getLabel(),
            url: Routing.generateHash(this.getRoute(), this.getRouteParams()),
            iconName: this.config.iconModifier.replace('icon', ''),
        }, this.el);
