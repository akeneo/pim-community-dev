...
const DeletedAttributeSourcePlaceholder = () => {
  ...
  return (
    <SourcePlaceholder>
      {translate('akeneo.syndication.data_mapping_details.sources.deleted_attribute.title')}
    </SourcePlaceholder>
  );
};
...
const DeletedAssociationTypeSourcePlaceholder = () => {
  ...
  return (
    <SourcePlaceholder>
      {translate('akeneo.syndication.data_mapping_details.sources.deleted_association_type.title')}
    </SourcePlaceholder>
  );
};
...
const InvalidAttributeSourcePlaceholder = () => {
  ...
  return (
    <SourcePlaceholder>
      {translate('akeneo.syndication.data_mapping_details.sources.invalid_source.attribute')}
    </SourcePlaceholder>
  );
};
...
const InvalidAssociationTypeSourcePlaceholder = () => {
  ...
  return (
    <SourcePlaceholder>
      {translate('akeneo.syndication.data_mapping_details.sources.invalid_source.association_type')}
    </SourcePlaceholder>
  );
};
...
const InvalidPropertySourcePlaceholder = () => {
  ...
  return (
    <SourcePlaceholder>
      {translate('akeneo.syndication.data_mapping_details.sources.invalid_source.property')}
    </SourcePlaceholder>
  );
};
...
const AssetCollectionMainMediaNotFoundPlaceholder = () => {
  ...
  return (
    <SourcePlaceholder>
      {translate('akeneo.syndication.data_mapping_details.sources.invalid_source.asset_collection_main_media')}
    </SourcePlaceholder>
  );
};
