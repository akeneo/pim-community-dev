...
final class Version_6_0_20211130113100_add_index_to_improve_search_on_job_instance extends AbstractMigration
{
    ...
    {
        $this->skipIf($this->indexExist('code_idx'), 'Index code_idx already exist in akeneo_batch_job_instance');
    ...
    private function indexesExist(string $indexName): bool
    {
