...
use Akeneo\Platform\Syndication\Domain\Query\Attribute\ViewableAttributesResult;
use Akeneo\Platform\Syndication\Infrastructure\Query\Structure\FindViewableAttributes;
...
class FindViewableAttributesSpec extends ObjectBehavior
{
    public function let(
        ...
        $this->beConstructedWith($findFlattenAttributes, $getViewableAttributeCodesForUser, $tokenStorage, ['string' => ['pim_catalog_text'], 'number' => ['pim_catalog_number']]);
    }
    ...
    public function it_searches_for_multiple_viewable_attributes(
        ...
        $this->execute($localeCode, $limit, $offset, $search, 'string')->shouldBeLike(
