 ...
 */
class DoctrineTargetEntityResolverSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('Akeneo\Bundle\StorageUtilsBundle\DependencyInjection\Resolver\DoctrineTargetEntityResolver');
    }
