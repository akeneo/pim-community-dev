...
class GetQuantifiedAssociationOnProductModelEndToEnd extends ApiTestCase
{
    ...
    public function testItOnlyReturnAssociatedProductsAndProductModelsGranted()
    {
        ...
        $client->request('GET', 'api/rest/v1/product-models/product_model_associated_with_product_and_product_model');
