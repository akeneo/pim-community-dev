    ...
    {args => {
      return (
        <Table>
          ...
          <Table.Body>
            <Table.Row>
              <Table.Cell>A biiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiig value without actions</Table.Cell>
              <Table.ActionCell />
            </Table.Row>
            <Table.Row>
              <Table.Cell>A biiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiig value with a button action</Table.Cell>
              <Table.ActionCell>
                <Button level="primary" ghost>
                  A button action
                </Button>
            ...
            <Table.Row>
              <Table.Cell>A biiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiig value with an icon button action</Table.Cell>
              <Table.ActionCell>
...
<Canvas>
    <Story name="Warnable rows">
        {args => {
            return (
                <Scrollable height={250}>
                    <Table hasWarnedRows={true}>
                        <Table.Header sticky={0}>
                            <Table.HeaderCell>Name</Table.HeaderCell>
                            <Table.HeaderCell>Family</Table.HeaderCell>
                            <Table.HeaderCell>Order</Table.HeaderCell>
