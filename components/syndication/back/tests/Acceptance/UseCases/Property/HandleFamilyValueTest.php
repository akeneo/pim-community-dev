...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\Family\InMemoryFindFamilyLabel;
...
final class HandleFamilyValueTest extends PropertyTestCase
{
    ...
    private function loadFamilyLabels(): void
    {
        ...
        $familyLabelsRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindFamilyLabelInterface');
