...
class ChainedRunnerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldImplement('Akeneo\Bundle\RuleEngineBundle\Runner\RunnerInterface');
        $this->shouldImplement('Akeneo\Bundle\RuleEngineBundle\Runner\DryRunnerInterface');
        $this->shouldImplement('Akeneo\Bundle\RuleEngineBundle\Runner\BulkRunnerInterface');
        $this->shouldImplement('Akeneo\Bundle\RuleEngineBundle\Runner\BulkDryRunnerInterface');
    }
