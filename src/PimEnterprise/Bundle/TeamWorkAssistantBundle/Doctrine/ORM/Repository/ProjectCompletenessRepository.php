...
INNER JOIN`@pimee_team_work_assistant.model.project#userGroups@` AS `project_contributor_group`
...
FROM (
	...
	FROM (      
        ...
        FROM `@pimee_team_work_assistant.project_product@` AS `project_product`
    ...
    INNER JOIN `@pimee_team_work_assistant.completeness_per_attribute_group@` AS `completeness_per_attribute_group`
