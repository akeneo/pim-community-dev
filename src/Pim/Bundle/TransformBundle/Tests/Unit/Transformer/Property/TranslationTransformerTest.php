...
use Pim\Bundle\TransformBundle\Transformer\Property\TranslationTransformer;
...
class TranslationTransformerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $column = $this->getMock('Pim\Bundle\TransformBundle\Transformer\ColumnInfo\ColumnInfoInterface');
