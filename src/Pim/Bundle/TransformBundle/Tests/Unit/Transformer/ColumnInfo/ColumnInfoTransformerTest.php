...
use Pim\Bundle\TransformBundle\Transformer\ColumnInfo\ColumnInfoTransformer;
...
{
    const COLUMN_INFO_CLASS = 'Pim\Bundle\TransformBundle\Transformer\ColumnInfo\ColumnInfo';
