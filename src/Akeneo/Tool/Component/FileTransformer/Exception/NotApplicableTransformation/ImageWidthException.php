 ...
 */
namespace Akeneo\Tool\Component\FileTransformer\Exception\NotApplicableTransformation;
...
class ImageWidthException extends GenericTransformationException
{
    ...
    {
        $message = sprintf(
            'Impossible to "%s" the image "%s" with a width bigger than the original.',
            $transformation,
            $image
        );
