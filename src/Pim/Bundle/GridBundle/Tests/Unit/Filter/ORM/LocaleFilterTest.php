...
use Pim\Bundle\GridBundle\Filter\ORM\LocaleFilter;
 ...
 *
 */
class LocaleFilterTest extends FilterTestCase
{
     ...
     * @var array
     */
    protected $testChoices = array('en_US' => 'en_US', 'fr_FR' => 'fr_FR');
    ...
    {
        return new LocaleFilter($this->getTranslatorMock());
    }
    ...
    {
        return array(
            'operator_greater_equals' => array(LocaleFilterType::TYPE_CONTAINS, 'IN'),
            'operator_greater_than'   => array(LocaleFilterType::TYPE_NOT_CONTAINS, 'NOT IN'),
