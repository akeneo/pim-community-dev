...
- Removed event `pim_catalog.pre_remove.association_type` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.pre_remove.attribute` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.post_remove.attribute` use `pim_catalog.post_remove` instead
- Removed event `pim_catalog.pre_remove.attribute_option` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.pre_remove.category` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.pre_remove.tree` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.pre_remove.family` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.pre_remove.group` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.pre_remove.product` use `pim_catalog.pre_remove` instead
- Removed event `pim_catalog.post_remove.product` use `pim_catalog.post_remove` instead
