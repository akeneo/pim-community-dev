...
use Akeneo\Platform\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\CountVariantProducts;
...
class CountVariantProductsSpec extends ObjectBehavior
{
    ...
    function it_gets_count_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'count_variant_products'));
    }
}
