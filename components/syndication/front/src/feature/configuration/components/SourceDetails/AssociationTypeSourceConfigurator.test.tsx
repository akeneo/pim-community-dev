...
test('it displays a simple association type configurator', async () => {
  ...
  userEvent.click(
    screen.getByLabelText('akeneo.syndication.data_mapping_details.sources.selection.collection_separator.title')
  );
  userEvent.click(
    screen.getByText('akeneo.syndication.data_mapping_details.sources.selection.collection_separator.pipe')
  );
...
test('it displays a quantified association type configurator', async () => {
  ...
  userEvent.click(
    screen.getByText('akeneo.syndication.data_mapping_details.sources.selection.quantified_association.quantity')
  );
...
test('it renders an invalid association type placeholder when the source is invalid', async () => {
  ...
  expect(
    screen.getByText('akeneo.syndication.data_mapping_details.sources.invalid_source.association_type')
  ).toBeInTheDocument();
