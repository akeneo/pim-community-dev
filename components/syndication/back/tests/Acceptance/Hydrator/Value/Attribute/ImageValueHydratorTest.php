...
class ImageValueHydratorTest extends AbstractAttributeValueHydratorTest
{
    /**
     * @test
     */
    public function it_hydrates_a_file_value_from_product_value(): void
    {
        ...
        $productValue = MediaValue::value('image_attribute_code', $fileInfo);
    ...
    public function it_hydrates_a_file_value_from_localizable_and_scopable_product_value(): void
    {
        ...
        $productValue = MediaValue::scopableLocalizableValue('image_attribute_code', $fileInfo, 'ecommerce', 'en_US');
