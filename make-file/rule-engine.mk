...
rule-engine-coupling-back: #Doc: ???? configure the coupling detector for rule engine
...
rule-engine-unit-back: var/tests/phpspec #Doc: run unitary tests for rule engine back
ifeq ($(CI),true)
...
rule-engine-acceptance-back: var/tests/behat/rule-engine-acceptance #Doc: run acceptance tests for rule engine back
...
rule-engine-integration-back: var/tests/behat/rule-engine-integration #Doc: run integration tests for rule engine back
