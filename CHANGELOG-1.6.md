...
- Move `Pim\Component\Connector\Reader\File\Product\CsvReader` to `Pim\Component\Connector\Reader\File\Csv\Reader`. Change constructor to add `Pim\Component\Connector\Reader\File\FileIteratorFactory` and `Pim\Component\Connector\ArrayConverter\ArrayConverterInterface`.
