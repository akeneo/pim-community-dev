...
final class UrlImageGeneratorTest extends PreviewGeneratorIntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->urlImageGenerator = $this->get('akeneo_referenceentity.infrastructure.generator.url_image_generator');
        $this->loadFixtures();
    }
    ...
    public function it_get_a_default_preview_for_an_unknown_image_url()
    {
        ...
        $this->assertStringContainsString(
            sprintf('media/cache/%s/pim_reference_entity.default_image.image', $type),
            $previewImage
        );
    }
