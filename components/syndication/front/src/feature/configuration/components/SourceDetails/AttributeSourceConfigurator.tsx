...
const AttributeSourceConfigurator = ({
  source,
  requirement,
  validationErrors,
  onSourceChange,
}: AttributeSourceConfiguratorProps) => {
          ...
          {null !== source.locale && (
            ...
            >
              {attribute.is_locale_specific && (
                <Helper inline>{translate('akeneo.syndication.data_mapping_details.sources.locale_specific')}</Helper>
              )}
            </LocaleDropdown>
          )}
        </Container>
