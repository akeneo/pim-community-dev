...
Feature: Import attributes
  ...
  Scenario: Successfully import attributes
    ...
    """
    type;code;label-en_US;group;unique;useable_as_grid_column;useable_as_grid_filter;localizable;scopable;allowed_extensions;date_type;metric_family;default_metric_unit
  ...
  Scenario: Fail to change immutable properties of attributes during the import
    ...
    And I launch the import job
    And I wait for the job to finish
    Then I should see "dateType: This property cannot be changed."
