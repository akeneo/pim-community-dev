...
define(
    [
        ...
        'pim/user-context',
        'text!team-work-assistant/templates/widget/project-selector',
        'text!team-work-assistant/templates/widget/project-selector-line'
    ],
            ...
            initializeSelect: function () {
                ...
                var options = {
                    ...
                    dropdownCssClass: 'select2-drop--forProjectWidget' +
                        ...
                        ' team-work-assistant-widget-project-dropdown',
                ...
                $select.on('change', function (event) {
                    this.trigger('team-work-assistant:widget:project-selected', event.added.id);
                }.bind(this));
                $select.on('select2-open', function () {
                    $('.team-work-assistant-widget-project-dropdown .select2-search')
                        .prepend('<i class="icon-search select2-searchIcon"></i>');
                    $('.team-work-assistant-widget-project-dropdown .select2-input')
                        .attr('placeholder', __('team_work_assistant.widget.placeholder.project_selector'));
                });
                $select.on('select2-close', function () {
                    $('.team-work-assistant-widget-project-dropdown .select2-search .icon-search').remove();
                    $('.team-work-assistant-widget-project-dropdown .select2-input').attr('placeholder', null);
                });
            },
