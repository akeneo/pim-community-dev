...
namespace Akeneo\Pim\Enrichment\Component\Product\Connector\ReadModel\Uuid;
...
final class ConnectorProduct
{
     ...
     * @param string|null $parentProductModelCode
     * @param array $associations
     * @param array $quantifiedAssociations
     * @param array $metadata metadata are for the status of the product in enterprise edition
     * @param ReadValueCollection $values
     * @param QualityScoreCollection|null $qualityScores
