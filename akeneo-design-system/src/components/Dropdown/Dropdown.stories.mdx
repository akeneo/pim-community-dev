...
import {useSelection} from '../../storybook/PreviewGallery';
...
<Canvas>
  <Story name="Standard" height={220}>
    {args => {
...
<Canvas>
  <Story name="Simple Item" height={220}>
    {() => {
      const [isOpen, open, close] = useBooleanState(true);
      return (
        <Dropdown>
...
<Canvas>
  <Story name="Item with selection" height={220}>
    {() => {
      const [isOpen, open, close] = useBooleanState(true);
...
<Canvas>
  <Story name="Item with image" height={330}>
    {() => {
      const [isOpen, open, close] = useBooleanState(true);
      return (
        <Dropdown>
