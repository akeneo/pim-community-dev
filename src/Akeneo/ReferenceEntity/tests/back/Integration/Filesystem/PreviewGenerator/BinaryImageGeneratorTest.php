...
use Akeneo\ReferenceEntity\Infrastructure\Filesystem\PreviewGenerator\BinaryImageGenerator;
...
final class BinaryImageGeneratorTest extends PreviewGeneratorIntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->binaryImageGenerator = $this->get('akeneo_referenceentity.infrastructure.generator.binary_image_generator');
        $this->loadFixtures();
    }
    /**
     * @test
    ...
    public function it_get_a_default_preview_for_an_unknown_image_url()
    {
        ...
        $this->assertStringContainsString(sprintf('media/cache/%s/pim_reference_entity.default_image.image', BinaryImageGenerator::THUMBNAIL_TYPE), $previewImage);
    }
