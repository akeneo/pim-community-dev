...
Feature: Export variant products through XLSX export
  ...
  Scenario: Export product models through XLSX
    ...
    Then exported xlsx file of "xlsx_summer_2016_models_export" should contain the lines:
      | code      | family_variant      | parent | categories                       | brand | care_instructions | collection  | color | COMPATIBILITY-groups | COMPATIBILITY-products       | COMPATIBILITY-product_models | composition | description-en_US-ecommerce                                                                                                                                                                                                       | erp_name-en_US | eu_shoes_size | image | keywords-en_US | material | meta_description-en_US | meta_title-en_US | name-en_US             | notice | PACK-groups | PACK-products | PACK-product_models | price-EUR | price-USD | size | sole_composition | SUBSTITUTION-groups | SUBSTITUTION-products | SUBSTITUTION-product_models | supplier | top_composition | UPSELL-groups | UPSELL-products | UPSELL-product_models | variation_image                               | variation_name-en_US | wash_temperature | weight | weight-unit | X_SELL-groups | X_SELL-products       | X_SELL-product_models |
