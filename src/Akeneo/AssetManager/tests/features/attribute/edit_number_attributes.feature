Feature: Edit a number attribute of an asset family
  ...
  Scenario: Updating the label
    Given an asset family with a number attribute 'area' and the label 'en_US' equal to 'Area'
  ...
  Scenario: Updating is decimal property
    Given an asset family with a number attribute 'area' non decimal
  ...
  Scenario: Updating the min value property
    Given an asset family with a number attribute 'area' no min value
    When the user sets the min value of 'area' to 10
    Then 'area' min value should be 10

  @acceptance-back
  Scenario: Unsetting the min value
    Given an asset family with a number attribute 'area' with a min value
  ...
  Scenario: Updating the max value property
    Given an asset family with a number attribute 'area' no max value
    When the user sets the max value of 'area' to 10
    Then 'area' max value should be 10

  @acceptance-back
  Scenario: Unsetting the max value
    Given an asset family with a number attribute 'area' with a max value
  ...
  Scenario: Min value should not be greater than the max value
    Given an asset family with a number attribute 'area'
