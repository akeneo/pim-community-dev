...
Feature: Import rules
  ...
  Scenario: Skip rules without locale key for condition and set action
    ...
    And I should see the text "actions[0]: Attribute or field \"description\" expects valid data, scope and locale. Attribute \"description\" expects a locale, none given."
    When I am on the "description" attribute page
    And I visit the "Rules" tab
    And I should see the text "Another good description"
  ...
  Scenario: Skip rules with nonexistent locale key for condition and set action
    ...
    And I should see the text "actions[0]: Attribute or field \"description\" expects valid data, scope and locale. Attribute \"description\" expects an existing and activated locale, \"kj_KL\" given."
    When I am on the "description" attribute page
    And I visit the "Rules" tab
    And I should see the text "Another good description"
  ...
  Scenario: Skip rules without scope key for condition and set action
    ...
    And I should see the text "actions[0]: Attribute or field \"description\" expects valid data, scope and locale. Attribute \"description\" expects a scope, none given."
    When I am on the "description" attribute page
    And I visit the "Rules" tab
    And I should see the text "Another good description"
  ...
  Scenario: Skip rules with nonexistent scope key for condition and set action
    ...
    And I should see the text "actions[0]: Attribute or field \"description\" expects valid data, scope and locale. Attribute \"description\" expects an existing scope, \"nonexistent\" given."
    When I am on the "description" attribute page
    And I visit the "Rules" tab
    And I should see the text "Another good description"
  ...
  Scenario: Skip rules with wrong locale fields for copy action
    ...
    And I wait for the "clothing_rule_import" job to finish
    Then I should see the text "skipped 2"
    And I should see the text "actions[0]: Attribute or field \"name\" expects valid data, scope and locale. Attribute \"name\" expects an existing and activated locale, \"wrong\" given."
    When I am on the "description" attribute page
    And I visit the "Rules" tab
    Then the row "sony_beautiful_description" should contain the texts:
      | column | value                                                                          |
  ...
  Scenario: Skip rules with wrong scope fields for copy action
    ...
    And I wait for the "clothing_rule_import" job to finish
    Then I should see the text "skipped 2"
    And I should see the text "actions[0]: Attribute or field \"description\" expects valid data, scope and locale. Attribute \"description\" expects an existing scope, \"wrong\" given."
    When I am on the "description" attribute page
    And I visit the "Rules" tab
    Then the row "sony_beautiful_description" should contain the texts:
      | column | value                                                                          |
