...
final class LowerThanFilterIntegration extends AbstractFilterIntegration
{
    protected function getTestedOperator(): string
    {
        return Operators::LOWER_THAN;
    }

    /** @test */
    public function it_filters_on_lower_than_operator(): void
    {
        ...
        $this->assertFilter(
            'nutrition',
            ['column' => 'quantity', 'row' => 'sugar', 'value' => 301],
            ['cheese_cake', 'chocolate_cake']
        );
        $this->assertFilter(
            'nutrition',
    ...
    /** @test */
    public function it_filters_on_lower_than_operator_with_locale_and_scope(): void
    {
        ...
        $this->assertFilter(
            'localizable_scopable_nutrition',
            ['column' => 'quantity', 'locale' => 'en_US', 'scope' => 'mobile', 'value' => 101],
            ['cheese_cake']
        );
        $this->assertFilter(
            'localizable_scopable_nutrition',
        ...
        $this->assertFilter(
            'localizable_scopable_nutrition',
            ['column' => 'quantity', 'locale' => 'en_US', 'scope' => 'ecommerce', 'value' => 201],
            []
        );
        $this->assertFilter(
            'localizable_scopable_nutrition',
        ...
        $this->assertFilter(
            'localizable_scopable_nutrition',
            ['column' => 'quantity', 'locale' => 'fr_FR', 'scope' => 'mobile', 'value' => 151],
            ['cheese_cake']
        );
        $this->assertFilter(
            'localizable_scopable_nutrition',
        ...
        $this->assertFilter(
            'localizable_scopable_nutrition',
            ['column' => 'quantity', 'row' => 'cheese', 'locale' => 'fr_FR', 'scope' => 'mobile', 'value' => 301],
            ['cheese_cake']
        );
        $this->assertFilter(
            'localizable_scopable_nutrition',
        ...
        $this->assertFilter(
            'localizable_scopable_nutrition',
            ['column' => 'quantity', 'row' => 'cheese', 'locale' => 'en_US', 'scope' => 'mobile', 'value' => 201],
            ['cheese_cake']
        );
    }

    /** @test */
    public function it_filters_lower_than_values_for_a_measurement_column(): void
    {
