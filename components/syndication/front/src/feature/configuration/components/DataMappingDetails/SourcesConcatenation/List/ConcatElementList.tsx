...
import {AssociationTypeSourceRow, AttributeSourceRow, PropertySourceRow, StaticSourceRow} from './SourceRow';
      ...
      <Table.Body>
        {format.elements.map(element => {
          ...
          switch (source.type) {
            ...
            case 'static':
              return <StaticSourceRow source={source} key={element.uuid} />;
