...
/**
 * This migration will create the app audits table.
 *
 * @author Pierre Jolly <pierre.jolly@akeneo.com>
 * @copyright 2019 Akeneo SAS (http://www.akeneo.com)
 * @license http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 */
final class Version_4_0_20191202144736_create_app_audits_table extends AbstractMigration
{
...
CREATE TABLE IF NOT EXISTS akeneo_app_audit(
    ...
    event_date DATE NOT NULL COMMENT '(DC2Type:datetime)',
    count INT NOT NULL,
    event_type ENUM('product_created', 'product_updated') NOT NULL,
    updated DATETIME NOT NULL COMMENT '(DC2Type:datetime)' DEFAULT CURRENT_TIMESTAMP,
