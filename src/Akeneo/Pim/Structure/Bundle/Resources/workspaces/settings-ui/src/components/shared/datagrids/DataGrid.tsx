...
const DataGrid: CompoundDataGrid<any> = ({
     children,
     isDraggable,
     dataSource,
     handleAfterMove,
    ...
    return (
        <DataGridStateProvider isDraggable={isDraggable || false} dataSource={dataSource} handleAfterMove={handleAfterMove} compareData={compareData}>
            <TableContainer>
