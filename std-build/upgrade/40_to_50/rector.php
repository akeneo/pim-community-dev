...
/*
 * Install:  docker-compose run  --rm php composer require --dev rector/rector-prefixed
 * Test:  docker-compose run  --rm php vendor/bin/rector -c std-build/migration/40_to_50/rector.php process ./std-build/migration/40_to_50/test-src
 */
