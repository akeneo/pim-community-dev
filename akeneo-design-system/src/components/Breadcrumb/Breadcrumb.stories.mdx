  ...
  <Story name="Standard">
    {args => {
      return <Breadcrumb {...args} >
        <Item href="https://www.akeneo.com" color={args.color} gradient={120}>first</Item>
        <Separator>/</Separator>
        <Item color={args.color} gradient={120}>second</Item>
        <Separator>/</Separator>
        <Item color={args.color} gradient={100}>last</Item>
      </Breadcrumb>;
    }}
  </Story>
</Canvas>
