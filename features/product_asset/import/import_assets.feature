...
Feature: Import assets
  ...
  Scenario: Import asset with invalid value for field en_of_use_at
    ...
    And I launch the import job
    And I wait for the "csv_clothing_asset_import" job to finish
    Then I should see the text "Asset expects a string with the format \"yyyy-mm-dd\" as data, \"2006/05/12\" given"
    And I should see the text "read lines 1"
    And I should see the text "Skipped 1"
  ...
  Scenario: Import assets with non existent category
    ...
    And I should see the text "Category with \"wrong\" code does not exist"
    And I should see the text "Category with \"not a category\" code does not exist"
  ...
  Scenario: Import assets with several categories including a non existent one
    ...
    Then I should see the text "read lines 1"
    And I should see the text "skipped 1"
    And I should see the text "Category with \"nonexistent\" code does not exist"
