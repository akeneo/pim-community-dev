 ...
 */
final class ListProductModelIdsQueryHandler
{
    ...
    public function handle(ListProductModelsQuery $query): ProductModelIdentifierList
    {
        ...
        return new ProductModelIdentifierList($result->count(), $identifiers);
    }
