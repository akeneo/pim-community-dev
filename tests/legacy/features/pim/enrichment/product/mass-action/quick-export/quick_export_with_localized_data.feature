...
Feature: Quick export many products with localized attributes from datagrid
  ...
  Scenario: Successfully quick export XLSX products with localized attributes
    ...
    And exported xlsx file of "xlsx_product_quick_export" should contain:
      ...
      | %uuid% | boots    | winter_collection | black |                          |                          | 28/12/1999      | 1       | boots    |        |            |              | Amazing boots |            | 20,80     | 25,35     | 75,50     |        |           | 40   |          |                    | 250    | GRAM        |
      | %uuid% | sneakers | summer_collection | white |                          |                          |                 | 1       | sneakers |        |            |              | Sneakers      |            | 50        | 60        | 75        |        |           | 42   |          |                    | 125,50 | GRAM        |
      | %uuid% | sandals  | summer_collection | red   |                          |                          |                 | 1       | sandals  |        |            |              | Sandals       |            | 5         | 5         | 75        |        |           | 40   |          |                    | 0,50   | GRAM        |
      | %uuid% | pump     | summer_collection | blue  |                          |                          |                 | 1       |          |        |            |              | Pump          |            | 15        | 20        |           |        |           | 41   |          |                    |        |             |
