...
import {SimpleReferenceEntityConfigurator} from './SimpleReferenceEntityConfigurator';
import {createAttributeDataMapping, createPropertyDataMapping} from '../../../../models';
import {ValidationError} from '@akeneo-pim-community/shared';
import {renderWithProviders} from 'feature/tests';

const getSimpleReferenceEntityAttribute = () => ({
  code: 'color',
...
test('it displays a simple reference entity configurator', async () => {
  const attribute = getSimpleReferenceEntityAttribute();
...
test('it throws an error if we setup this component with a wrong target', async () => {
  ...
  }).rejects.toThrow('Invalid target data "family" for simple reference entity configurator');
