...
use Pim\Bundle\TransformBundle\Transformer\Guesser\ChainedGuesser;
...
class ChainedGuesserTest extends GuesserTestCase
{
    ...
    {
        return $this->getMock('Pim\Bundle\TransformBundle\Transformer\Property\PropertyTransformerInterface');
    }
}
