...
class LocalizableScopableFilterIntegration extends AbstractProductQueryBuilderTestCase
{
    ...
    public function testErrorOptionLocalizable()
    {
        ...
        $this->expectExceptionMessage('The a_localizable_scopable_simple_select attribute requires a locale.');
    ...
    {
        $this->expectException(InvalidPropertyException::class);
        $this->expectExceptionMessage('The a_localizable_scopable_simple_select attribute requires a value per channel.');
