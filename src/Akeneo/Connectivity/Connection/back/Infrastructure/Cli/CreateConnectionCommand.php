    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $output->writeln([
                ...
                sprintf('Label: %s', $connectionWithCredentials->label()),
                sprintf('Flow type: %s', $connectionWithCredentials->flowType()),
                sprintf('Client ID: %s', $connectionWithCredentials->clientId()),
                sprintf('Secret: %s', $connectionWithCredentials->secret()),
                '<comment>Make sure to save this password somewhere as we won\'t show it to you twice.</comment>',
