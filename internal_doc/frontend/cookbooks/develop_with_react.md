...
![../images/cookbook_develop_with_react_in_backbone_controller.gif](../images/cookbook_develop_with_react_in_backbone_controller.gif)
...
class MyBridgeAppController extends ReactController {
  ...
  renderRoute() {
    ...
    mediator.trigger('pim_menu:highlight:item', {extension: 'pim-menu-settings-my-app'});
