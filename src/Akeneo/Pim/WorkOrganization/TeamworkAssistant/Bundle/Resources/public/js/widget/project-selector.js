  ...
  return BaseForm.extend({
    ...
    initializeSelect: function() {
      ...
      var options = {
        ...
        dropdownCssClass:
          'select2-drop--forProjectWidget' + ' select2--withArrowRight' + ' teamwork-assistant-widget-project-dropdown',
      ...
      $select.on('select2-open', function() {
        $('.teamwork-assistant-widget-project-dropdown .select2-input').attr(
          'placeholder',
          __('teamwork_assistant.widget.placeholder.project_selector')
        );
      });
