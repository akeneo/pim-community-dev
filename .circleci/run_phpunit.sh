...
for TEST_FILE in $TEST_FILES; do
    ...
    set +e
    APP_ENV=test docker-compose run -u www-data -T php ./vendor/bin/phpunit -c $CONFIG_DIRECTORY --log-junit var/tests/phpunit/phpunit_$(uuidgen).xml $TEST_FILE || true
    TEST_RESULT=$?
