...
describe('useDragTreeNode', () => {
  ...
  test('it tests the node is draggable when reorder is active', () => {
    const root = aTreeNode('a_root', 1111, [2222], 'a_root', '', true, null, 'root');
    const node = aTreeNode('a_node', 2222, [3333], 'a_node', '', true, 1111, 'node');
    const leaf = aTreeNode('a_leaf', 3333, [], 'a_leaf', '', true, 2222, 'leaf');
  ...
  test('it drags the node', () => {
    const node = aTreeNode('a_node', 1234, [], 'a_node', '', true, 1, 'node');
