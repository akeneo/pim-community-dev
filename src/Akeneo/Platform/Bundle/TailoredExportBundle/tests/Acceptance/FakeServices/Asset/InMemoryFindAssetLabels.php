...
final class InMemoryFindAssetLabels implements FindAssetLabelsInterface
{
    ...
    public function addAssetLabel(string $assetFamilyCode, string $assetCode, string $locale, string $label): void
    {
        $this->assetLabels[$assetFamilyCode][$assetCode][$locale] = $label;
    }

    public function byAssetFamilyCodeAndAssetCodes(string $assetFamilyCode, array $assetCodes, string $locale): array
    {
