...
// TODO : refactor this part to be able to load storage configuration from others bundles than catalog
use Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
use Pim\Bundle\CatalogBundle\DependencyInjection\PimCatalogExtension;
use Pim\Bundle\CatalogBundle\DependencyInjection\Configuration;
...
class PimDataGridExtension extends Extension
{
    ...
    {
        return array(PimCatalogExtension::DOCTRINE_ORM, PimCatalogExtension::DOCTRINE_MONGODB_ODM);
    }
