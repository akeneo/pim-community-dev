Feature: Expose product data via a REST API
  ...
  Background:
    ...
    And the following product:
      ...
      | sandals    | My sandals | My great sandals         | My great new sandals     | 20        | 30        | sandals      |
      | oldsandals | My sandals | My great sandals         | My great new sandals     | 20        | 30        | old_sandals  |
  ...
  Scenario: Fail to fetch a not granted product
    Given I am authenticating as "admin" with "admin_api_key" api key
