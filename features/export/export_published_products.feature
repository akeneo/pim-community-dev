...
Feature: Export published products
  ...
  Scenario: Successfully export published products
    ...
    """
    sku;categories;description-de_DE-mobile;description-en_US-mobile;description-fr_FR-mobile;enabled;family;groups;main_color;manufacturer;name-de_DE;name-en_US;name-fr_FR;price-EUR;price-GBP;price-USD;size
    jacket-white;jackets,winter_collection;"Ein sehr elegantes weißes Jacket";"A really stylish white jacket";"Un Jacket blanc élégant";1;jackets;;white;Volcom;"Weißes Jacket";"White jacket";"Jacket blanc";10.00;9.00;15.00;XL
    jacket-black;jackets,winter_collection;;;;1;jackets;;black;Volcom;"Weißes Jacket";"White jacket";"Jacket blanc";10.00;9.00;15.00;XL
    """
