...
class LocalizableAndScopableRawValuesBuilderSpec extends ObjectBehavior
{
    ...
    function it_adds_missing_localizable_raw_values_for_locale_specific_attributes(
        $attributeRepository,
        $channelRepository,
        $localeRepository,
        AttributeInterface $attribute,
        ...
        $attribute->getLocaleSpecificCodes()->willReturn(['en_US', 'de_DE']);
    ...
    function it_adds_missing_localizable_and_scopable_raw_values(
        ...
        $ecommerce->getCode()->willReturn('ecommerce');
        $ecommerceLocales->toArray()->willReturn([$fr, $en]);
    ...
    function it_adds_missing_localizable_and_scopable_raw_values_for_locale_specific_attributes(
        $attributeRepository,
        $channelRepository,
        $localeRepository,
        AttributeInterface $attribute,
        ...
        $channelRepository->findAll()->willReturn([$print, $ecommerce]);
        $print->getCode()->willReturn('print');
        $printLocales->toArray()->willReturn([$fr, $en, $de]);
        $print->getLocales()->willReturn($printLocales);
        $ecommerce->getCode()->willReturn('ecommerce');
        $ecommerceLocales->toArray()->willReturn([$fr, $en, $de]);
        $ecommerce->getLocales()->willReturn($ecommerceLocales);
        $localeRepository->getActivatedLocales()->willReturn([$fr, $en, $de]);
        $en->getCode()->willReturn('en_US');
        $fr->getCode()->willReturn('fr_FR');
