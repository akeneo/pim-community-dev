...
use Akeneo\Pim\Automation\DataQualityInsights\Infrastructure\Persistence\Query\GetUpdatedProductModelsWithoutUpToDateEvaluationQuery;
...
final class GetUpdatedProductModelsWithoutUpToDateEvaluationQueryIntegration extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->criterionEvaluationRepository = $this->get('akeneo.pim.automation.data_quality_insights.repository.product_model_criterion_evaluation');
    }
    ...
    {
        $query = <<<SQL
UPDATE pimee_data_quality_insights_product_model_criteria_evaluation SET created_at = :created_at WHERE product_id = :product_id;
SQL;
...
SQL;
    ...
    {
        $query = <<<SQL
UPDATE pim_catalog_product_model SET updated = :updated_at WHERE id = :product_model_id;
SQL;
