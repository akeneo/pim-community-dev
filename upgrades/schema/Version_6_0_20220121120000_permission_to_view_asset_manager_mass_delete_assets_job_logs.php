...
/**
 * Add the permission to download logs for the "asset_manager_mass_delete_assets" job.
 */
final class Version_6_0_20220121120000_permission_to_view_asset_manager_mass_delete_assets_job_logs extends AbstractMigration
{
    private const JOB_CODE = 'asset_manager_mass_delete_assets';
