...
class ConvertToPriceOperationSpec extends ObjectBehavior
{
    public function let()
    {
        $this->beConstructedWith('00000000-0000-0000-0000-000000000000', ',', 'EUR');
    }

    public function it_is_initializable()
    {
        $this->shouldHaveType(ConvertToPriceOperation::class);
    }
