...
namespace spec\Akeneo\Test\Acceptance\Structure\FamilyVariant;

use Akeneo\Component\StorageUtils\Repository\IdentifiableObjectRepositoryInterface;
use Akeneo\Component\StorageUtils\Saver\SaverInterface;
use Akeneo\Test\Common\NotImplementedException;
use Akeneo\Test\Acceptance\Structure\FamilyVariant\InMemoryFamilyVariantRepository;
...
class InMemoryFamilyVariantRepositorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(\Akeneo\Test\Acceptance\Structure\FamilyVariant\InMemoryFamilyVariantRepository::class);
    }
