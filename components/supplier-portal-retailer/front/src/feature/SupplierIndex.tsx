...
const SecondaryActions = () => {
    ...
    const exportRoute = useRoute('supplier_portal_retailer_supplier_export');
    const importRoute = '#' + useRoute('pim_importexport_import_profile_index');
    const downloadTemplateRoute = useRoute('supplier_portal_retailer_supplier_download_import_template');
