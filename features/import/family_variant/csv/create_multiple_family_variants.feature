...
Feature: Create variants of family through CSV import
  ...
  Scenario: I successfully create and use a family variant import in CSV
    ...
    Then there should be the following family variants:
      ...
      | another_clothing_color_size     | clothing | Kleidung nach Farbe/Größe     | Clothing by color/size     | Vêtements par couleur/taille    | color,size     |                | color,size,name,image,variation_image,composition |                      |
