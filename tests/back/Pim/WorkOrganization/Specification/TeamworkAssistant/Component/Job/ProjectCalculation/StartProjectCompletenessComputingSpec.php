...
use Akeneo\Pim\WorkOrganization\TeamworkAssistant\Component\Job\ProjectCalculation\StartProjectCompletenessComputing;
...
class StartProjectCompletenessComputingSpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType(StartProjectCompletenessComputing::class);
    }
    ...
    function it_starts_the_project_completeness_computing(
        $projectRepository,
        $projectSaver,
        ...
        $project->startCompletenessComputing()->shouldBeCalled();
