...
define(
    [
        ...
        'backbone',
        'pim/form',
        'text!team-work-assistant/templates/grid/view-selector/edit-project',
        ...
        return BaseForm.extend({
            ...
            render: function () {
                ...
                this.$el.html(this.template({
                    label: __('team_work_assistant.grid.view_selector.edit')
                }));
            ...
            promptEditProject: function () {
                var modal = new Backbone.BootstrapModal({
                    title: __('team_work_assistant.edit_project_modal.title'),
                    content: '',
                    cancelText: __('team_work_assistant.edit_project_modal.cancel'),
                    okText: __('team_work_assistant.edit_project_modal.confirm'),
                    okCloses: false
                });
