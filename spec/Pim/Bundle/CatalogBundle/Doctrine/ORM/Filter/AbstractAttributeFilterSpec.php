...
class AbstractAttributeFilterSpec extends ObjectBehavior
{
    ...
    {
        $this->beAnInstanceOf('spec\Pim\Bundle\CatalogBundle\Doctrine\ORM\Filter\ConcreteAttributeFilter');
        $this->beConstructedWith($attrValidatorHelper);
    }

    function it_is_a_filter()
    {
        $this->shouldHaveType('Pim\Bundle\CatalogBundle\Query\AttributeFilterInterface');
    }
