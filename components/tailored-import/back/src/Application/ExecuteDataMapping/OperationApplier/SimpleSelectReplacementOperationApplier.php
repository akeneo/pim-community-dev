...
final class SimpleSelectReplacementOperationApplier implements OperationApplierInterface
{
    ...
    {
        return match (true) {
            !$operation instanceof SimpleSelectReplacementOperation => throw new UnexpectedValueException($operation, SimpleSelectReplacementOperation::class, self::class),
    ...
    private function replace(SimpleSelectReplacementOperation $operation, StringValue $value): StringValue
    {
