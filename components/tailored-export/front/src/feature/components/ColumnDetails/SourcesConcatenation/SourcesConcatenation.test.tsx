...
test('it can add a text element when clicking the add text button', async () => {
  ...
  userEvent.click(screen.getByText('akeneo.tailored_export.column_details.concatenation.add_text'));
...
test('it disables add text button when max text limit is reached', async () => {
  ...
  const addTextButton = screen.getByText('akeneo.tailored_export.column_details.concatenation.add_text');
...
test('it can change the space between property when clicking on the space between checkbox', async () => {
  ...
  userEvent.click(screen.getByLabelText('akeneo.tailored_export.column_details.concatenation.space_between'));
