...
class EditAction
{
    public function __construct(private EditAttributeCommandFactoryInterface $editAttributeCommandFactory, private EditAttributeHandler $editAttributeHandler, private CanEditReferenceEntityQueryHandler $canEditReferenceEntityQueryHandler, private TokenStorageInterface $tokenStorage, private NormalizerInterface $normalizer, private ValidatorInterface $validator, private SecurityFacade $securityFacade)
    {
    }
