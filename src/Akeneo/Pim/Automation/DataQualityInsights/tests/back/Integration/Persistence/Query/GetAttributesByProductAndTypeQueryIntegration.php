...
class GetAttributesByProductAndTypeQueryIntegration extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->givenAttributes([
            ['code' => 'a_readonly_textarea', 'type' => AttributeTypes::TEXTAREA, 'properties' => ['is_read_only' => true]],
    ...
    public function test_it_gets_product_attributes_by_type()
    {
        ...
        $result = $this
            ->get(GetAttributesByTypeFromProductQuery::class)
    ...
    private function createProduct(): ProductId
    {
        ...
        $data = [
            'values' => [
                ...
                'a_readonly_textarea' => [['scope' => null, 'locale' => null, 'data' => 'some text']],
            ]
        ];
