...
/**
 * Export category have single table inheritance with Export entity
 *
 ...
 * @ORM\Entity()
 */
class ExportCategory extends Export implements ExportInterface
{
    /**
     ...
     * @param Category $tree
     *
     * @return \Pim\Bundle\ImportExportBundle\Entity\ExportCategory
     */
    public function setTree(Category $tree)
    {
        $this->tree = $tree;
