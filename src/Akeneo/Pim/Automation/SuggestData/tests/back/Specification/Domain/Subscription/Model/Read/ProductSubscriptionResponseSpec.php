...
class ProductSubscriptionResponseSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith(42, 'subscription-id', [], false);
    ...
    {
        $this->beConstructedWith(42, '', [], false);
    ...
    {
        $this->beConstructedWith(42, 'some-subscription-id', [], false);
        $this->getProductId()->shouldReturn(42);
    }

    public function it_exposes_the_subscription_id(): void
    {
        $this->beConstructedWith(42, 'a-random-id', [], false);
    ...
    public function it_exposes_the_suggested_data(): void
    {
        ...
        $this->beConstructedWith(42, 'subscription-id', $suggestedData, false);
