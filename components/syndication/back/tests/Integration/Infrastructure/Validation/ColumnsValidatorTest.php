...
final class ColumnsValidatorTest extends AbstractValidationTest
{
    ...
    public function invalidColumns(): array
    {
        return [
            'empty column name' => [
                'akeneo.syndication.validation.columns.target.should_not_be_blank',
            ...
            'too long column name' => [
                'akeneo.syndication.validation.columns.target.max_length_reached',
                '[018e1a5e-4d77-4a15-add8-f142111d4cd0][target]',
                [
                    [
                        'uuid' => '018e1a5e-4d77-4a15-add8-f142111d4cd0',
            ...
            'duplicate column name' => [
                'akeneo.syndication.validation.columns.target.should_be_unique',
            ...
            'too much columns' => [
                'akeneo.syndication.validation.columns.max_column_count_reached',
                '',
                array_fill(0, 1001, [
                    'uuid' => '018e1a5e-4d77-4a15-add8-f142111d4cd0',
                    'target' => '',
