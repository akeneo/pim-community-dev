...
const TabContentWithPortalDecorator = <P extends object, C extends PageContextState>(TabContentComponent:  ComponentType<P>, usePageContextHook: PageContextHook<C>): FC<TabContentWithPortalDecoratorProps & P> => {
  return (props) => {
    ...
    const isVisible = useCallback((currentTab: string|null) => {
