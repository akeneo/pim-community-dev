...
namespace Specification\Akeneo\Pim\Automation\SuggestData\Infrastructure\Subscriber\Channel;
...
class ChannelUpdateSubscriberSpec extends ObjectBehavior
{
    ...
    public function it_deactivates_suggest_data_if_all_english_locales_are_deactivated(
        $localeRepository,
