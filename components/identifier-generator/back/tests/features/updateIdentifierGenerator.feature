...
Feature: Update Identifier Generator
  ...
  Scenario: Cannot update an identifier generator with empty label
    When I try to update an identifier generator with 'de_DE' label ''
    Then I should get an error on update with message 'labels[de_DE]: This value should not be blank.'
