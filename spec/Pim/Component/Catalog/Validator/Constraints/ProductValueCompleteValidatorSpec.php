...
use Pim\Component\Catalog\Validator\Constraints\ProductValueComplete;
...
class ProductValueCompleteValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Pim\Component\Catalog\Validator\Constraints\ProductValueCompleteValidator');
    }
