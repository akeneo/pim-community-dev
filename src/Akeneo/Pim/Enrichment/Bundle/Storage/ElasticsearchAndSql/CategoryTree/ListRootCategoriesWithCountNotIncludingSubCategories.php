 ...
 */
class ListRootCategoriesWithCountNotIncludingSubCategories implements \Akeneo\Category\Domain\Component\CategoryTree\Query\ListRootCategoriesWithCountNotIncludingSubCategories
{
    /** @var Connection */
    private $connection;
