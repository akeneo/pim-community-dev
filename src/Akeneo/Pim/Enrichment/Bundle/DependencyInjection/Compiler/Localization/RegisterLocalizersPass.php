...
{
    public const LOCALIZATION_LOCALIZER_REGISTRY = 'pim_catalog.localization.localizer.registry';

    public const LOCALIZATION_LOCALIZER_TAG = 'pim_catalog.localization.localizer';
