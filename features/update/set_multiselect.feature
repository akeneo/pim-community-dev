Feature: Update multi select fields
  ...
  Scenario: Successfully update a multi select field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | reverted        | [{"type": "set_data", "field": "additional_colors", "data": [], "locale": null, "scope": null}]                                                                                                                                  | {"values": {}}                                                                                                         |
      | reverted        | [{"type": "set_data", "field": "additional_colors", "data": ["additional_red"], "locale": null, "scope": null}, {"type": "set_data", "field": "additional_colors", "data": [], "locale": null, "scope": null}]                   | {"values": {}}                                                                                                         |
