 ...
 */
class DeleteCategoryTreeTemplateByCategoryIdAndTemplateUuidSqlIntegration extends CategoryTestCase
{
    public function testItDeletesLinkBetweenCategoryTreeAndTemplate(): void
    {
        ...
        ($this->get(DeleteCategoryTreeTemplateByCategoryIdAndTemplateUuid::class))($category->getId(), $templateModel->getUuid());
