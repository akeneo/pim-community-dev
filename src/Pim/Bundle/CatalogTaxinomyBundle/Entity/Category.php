...
class Category
{
    ...
    /**
     * Set parent
     * @param Pim\Bundle\CatalogTaxinomyBundle\Entity\Category $parent
     *
     * @return Category
     */
    public function setParent(\Pim\Bundle\CatalogTaxinomyBundle\Entity\Category $parent = null)
    {
        $this->parent = $parent;
     ...
     * @return Category
     */
    public function addChildren(\Pim\Bundle\CatalogTaxinomyBundle\Entity\Category $children)
    {
