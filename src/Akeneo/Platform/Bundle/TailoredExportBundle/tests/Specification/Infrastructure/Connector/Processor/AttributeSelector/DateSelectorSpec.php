...
class DateSelectorSpec extends ObjectBehavior
{
    ...
    public function it_selects_the_date_properly_formatted(
        ...
        $this->applySelection(['format' => 'yyyy-mm-dd'], $entity, $dateAttribute, $value)->shouldReturn('1989-05-08');
        $this->applySelection(['format' => 'yyyy/mm/dd'], $entity, $dateAttribute, $value)->shouldReturn('1989/05/08');
        $this->applySelection(['format' => 'yyyy.mm.dd'], $entity, $dateAttribute, $value)->shouldReturn('1989.05.08');
        $this->applySelection(['format' => 'yy.m.dd'], $entity, $dateAttribute, $value)->shouldReturn('89.5.08');
        $this->applySelection(['format' => 'mm-dd-yyyy'], $entity, $dateAttribute, $value)->shouldReturn('05-08-1989');
        $this->applySelection(['format' => 'mm/dd/yyyy'], $entity, $dateAttribute, $value)->shouldReturn('05/08/1989');
        $this->applySelection(['format' => 'dd-mm-yyyy'], $entity, $dateAttribute, $value)->shouldReturn('08-05-1989');
        $this->applySelection(['format' => 'dd/mm/yyyy'], $entity, $dateAttribute, $value)->shouldReturn('08/05/1989');
        $this->applySelection(['format' => 'dd.mm.yyyy'], $entity, $dateAttribute, $value)->shouldReturn('08.05.1989');
        $this->applySelection(['format' => 'mm.dd.yyyy'], $entity, $dateAttribute, $value)->shouldReturn('05.08.1989');
        $this->applySelection(['format' => 'dd-mm-yy'], $entity, $dateAttribute, $value)->shouldReturn('08-05-89');
        $this->applySelection(['format' => 'dd/mm/yy'], $entity, $dateAttribute, $value)->shouldReturn('08/05/89');
        $this->applySelection(['format' => 'dd.mm.yy'], $entity, $dateAttribute, $value)->shouldReturn('08.05.89');
        $this->applySelection(['format' => 'dd-m-yy'], $entity, $dateAttribute, $value)->shouldReturn('08-5-89');
        $this->applySelection(['format' => 'dd/m/yy'], $entity, $dateAttribute, $value)->shouldReturn('08/5/89');
        $this->applySelection(['format' => 'dd.m.yy'], $entity, $dateAttribute, $value)->shouldReturn('08.5.89');
    }
