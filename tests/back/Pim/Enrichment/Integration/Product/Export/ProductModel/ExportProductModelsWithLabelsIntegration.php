...
[code];"Variante de famille";Parent;Catégories;"Vente croisée Groupes";"Vente croisée Produits";"Vente croisée Modèles de produits";"Vente incitative Groupes";"Vente incitative Produits";"Vente incitative Modèles de produits";"Remplacement Groupes";"Remplacement Produits";"Remplacement Modèles de produits";"Pack Groupes";"Pack Produits";"Pack Modèles de produits";"Association avec des quantitées Produits";"Association avec des quantitées Produits Quantité";"Association avec des quantitées Modèles de produits";"Association avec des quantitées Modèles de produits Quantité";Couleurs;"Description (anglais États-Unis) - customer_description-en_US";"Couleur principale";Nom;"Prix (Ecommerce) (euro)";"Prix (Ecommerce) (dollar des États-Unis)";"Date de sortie (Ecommerce)";"Description (anglais États-Unis) - seller_description-en_US";"Nom de la variation"
...
apollon_pink;"Vêtement par couleur et par taille";apollon;"Col rond,T-shirts";;[a_product];apollon;;;;;;;;;;[a_product];12;apollon;5;Bleu,Rose;"The beautiful Apollon";Rose;apollon;12.30;12.60;2011-08-21;"Apollon is the most beautiful tshirt, buy it";"my pink tshirt"
...
[code];[family_variant];[parent];[categories];"[X_SELL] [groups]";"[X_SELL] [products]";"[X_SELL] [product_models]";"[UPSELL] [groups]";"[UPSELL] [products]";"[UPSELL] [product_models]";"[SUBSTITUTION] [groups]";"[SUBSTITUTION] [products]";"[SUBSTITUTION] [product_models]";"[PACK] [groups]";"[PACK] [products]";"[PACK] [product_models]";"[QUANTITY] [products]";"[QUANTITY] [products] [quantity]";"[QUANTITY] [product_models]";"[QUANTITY] [product_models] [quantity]";[colors];"[customer_description] ([en_US])";[main_color];[name];"[price] ([ecommerce]) ([EUR])";"[price] ([ecommerce]) ([USD])";"[release_date] ([ecommerce])";"[seller_description] ([en_US])";[variation_name]
...
apollon_pink;[clothing_color_size];apollon;[round-neck],[tshirt];;[a_product];apollon;;;;;;;;;;[a_product];12;apollon;5;[blue],[pink];"The beautiful Apollon";[pink];apollon;12.30;12.60;2011-08-21;"Apollon is the most beautiful tshirt, buy it";"my pink tshirt"
