...
test('it displays an invalid property placeholder the error is an InvalidPropertySourceError', () => {
  ...
  expect(
    screen.getByText('akeneo.syndication.data_mapping_details.sources.invalid_source.property')
  ).toBeInTheDocument();
  mockedConsole.mockRestore();
});
...
test('it displays an invalid asset collection main media placeholder the error is an AssetCollectionMainMediaNotFoundError', () => {
  ...
  expect(
    screen.getByText('akeneo.syndication.data_mapping_details.sources.invalid_source.asset_collection_main_media')
  ).toBeInTheDocument();
  mockedConsole.mockRestore();
});
