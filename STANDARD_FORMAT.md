...
| price collection             	| array          | `[    0 => ["data" => "45.00","currency" => "USD"],    1 => ["data" => "56.53","currency" => "EUR"] ]` | *data* and *currency* keys are expected for each price *currency* should be a known currency                      |
