...
const recordAttributeReducer = (normalizedAttribute: NormalizedRecordAttribute | NormalizedRecordCollectionAttribute): NormalizedRecordAttribute | NormalizedRecordCollectionAttribute => {
  // Nothing to edit
