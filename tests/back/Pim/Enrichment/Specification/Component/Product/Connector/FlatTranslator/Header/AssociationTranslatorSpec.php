...
class AssociationTranslatorSpec extends ObjectBehavior
{
    ...
    function it_translates_associations_and_quantified_associations_columns(
        ...
        $getAssociationTypeTranslations->byAssociationTypeCodeAndLocale(['ASSOC_TYPE_1', 'ASSOC_TYPE_2'], 'fr_FR')
            ->willReturn(['ASSOC_TYPE_1' => 'premiere association', 'ASSOC_TYPE_2' => 'deuxieme association']);
        ...
        $this->translate('QUANTIFIED_ASSOC_TYPE_1-products', 'fr_FR')->shouldReturn('[QUANTIFIED_ASSOC_TYPE_1] Produits');
        $this->translate('QUANTIFIED_ASSOC_TYPE_1-products-quantity', 'fr_FR')->shouldReturn('[QUANTIFIED_ASSOC_TYPE_1] Produits Quantité');
        $this->translate('QUANTIFIED_ASSOC_TYPE_1-product_models', 'fr_FR')->shouldReturn('[QUANTIFIED_ASSOC_TYPE_1] Modèles de produits');
        $this->translate('QUANTIFIED_ASSOC_TYPE_1-product_models-quantity', 'fr_FR')->shouldReturn('[QUANTIFIED_ASSOC_TYPE_1] Modèles de produits Quantité');
    }
}
