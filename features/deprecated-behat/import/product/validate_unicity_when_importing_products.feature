...
Feature: Validate values for unique attributes when importing products
  ...
  Scenario: Successfully ignore duplicate unique date values
    ...
    Then I should see the text "The value \"2014-01-01T00:00:00+0100\" for unique attribute \"date\" was already read in this file"
  ...
  Scenario: Successfully ignore duplicate unique number values
    ...
    And I launch the import job
    And I wait for the "product_import" job to finish
    Then I should see the text "The value \"123\" for unique attribute \"number\" was already read in this file"
    And there should be 1 product
  ...
  Scenario: Successfully ignore duplicate unique text values
    ...
    And I launch the import job
    And I wait for the "product_import" job to finish
    Then I should see the text "The value \"foo\" for unique attribute \"text\" was already read in this file"
    And there should be 1 product
  ...
  Scenario: Import a file with same value in unique attribute and with existing product with this value
    ...
    Then I should see the text "The value \"1200000011a\" for unique attribute \"test_unique_attribute\" was already read in this file"
  ...
  Scenario: Import a file with same sku, duplicated products should not be imported
    ...
    And I launch the import job
    And I wait for the "footwear_product_import" job to finish
    Then I should see the text "The unique code \"17727158\" was already read in this file"
    And I am on the products page
