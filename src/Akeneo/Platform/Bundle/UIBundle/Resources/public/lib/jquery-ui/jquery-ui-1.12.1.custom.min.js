          ...
          return (
            ...
            t.each(['my', 'at'], function () {
              var t,
                ...
                i = (n[this] || '').split(' ');
              1 === i.length &&
                (i = r.test(i[0]) ? i.concat(['center']) : l.test(i[0]) ? ['center'].concat(i) : ['center', 'center']),
          ...
          if (1 === this.containers.length)
            ...
            for (
              ...
              t.contains(this.containers[p].element[0], this.items[s].item[0]) &&
                ...
                n > Math.abs(e[u] - l) &&
                  ((n = Math.abs(e[u] - l)), (o = this.items[s]), (this.direction = h ? 'up' : 'down')));
        ...
        return (
                ...
                : s))),
          {
            top:
              ...
              this.offset.relative.top -
              this.offset.parent.top +
              ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : l ? 0 : r.scrollTop()),
            left:
              o -
              this.offset.click.left -
              this.offset.relative.left -
              this.offset.parent.left +
              ('fixed' === this.cssPosition ? -this.scrollParent.scrollLeft() : l ? 0 : r.scrollLeft()),
          }
        );
      },
