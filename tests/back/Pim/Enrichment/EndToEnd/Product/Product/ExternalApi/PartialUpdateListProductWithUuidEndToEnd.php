...
{"line":11,"uuid":122345,"code":422,"message":"This is not a valid UUID. Check the expected format on the API documentation.","_links":{"documentation":{"href":"http:\/\/api.akeneo.com\/api-reference.html#patch_products__code_"}}}
JSON;
...
JSON;
        ...
        $expectedContent =
<<<JSON
{"line":1,"uuid":"{$uuid->toString()}","code":422,"message":"Property \"group\" does not exist. Check the expected format on the API documentation.","_links":{"documentation":{"href":"http:\/\/api.akeneo.com\/api-reference.html#patch_products__code_"}}}
JSON;
...
JSON;
        ...
        $expectedContent =
<<<JSON
{"line":1,"uuid":"{$uuid->toString()},","code":422,"message":"This is not a valid UUID. Check the expected format on the API documentation.","_links":{"documentation":{"href":"http:\/\/api.akeneo.com\/api-reference.html#patch_products__code_"}}}
JSON;
