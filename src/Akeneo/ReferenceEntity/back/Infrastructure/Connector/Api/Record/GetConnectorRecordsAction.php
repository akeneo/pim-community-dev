...
class GetConnectorRecordsAction
{
    ...
    {
        // TODO validate search filters with json-schema
        $rawSearchFilters = $this->getSearchFiltersFromRequest($request);
        $searchFilters = $this->formatSearchFilters($rawSearchFilters);
