Feature: Update price fields
  ...
  Scenario: Successfully update a price field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | BOX4    | [{"type": "set_value", "field": "price", "value": [{"data": "5", "currency": "EUR"}], "locale": "fr_FR", "scope": null}] | {"values": {"price": [{"locale": "fr_FR", "scope": null, "value": [{"data": 5, "currency": "EUR"}]}]}}    |
      | BOX4    | [{"type": "set_value", "field": "price", "value": [{"data": "5", "currency": "USD"}], "locale": "fr_FR", "scope": null}] | {"values": {"price": [{"locale": "fr_FR", "scope": null, "value": [{"data": 5, "currency": "USD"}]}]}}    |
      | BOX6    | [{"type": "set_value", "field": "price", "value": [{"data": "5", "currency": "EUR"}], "locale": "fr_FR", "scope": null}, {"type": "set_value", "field": "price", "value": [], "locale": "fr_FR", "scope": null}]                                 | {"values": {"price": [{"locale": "fr_FR", "scope": null, "value": [{"data": null, "currency": "EUR"}]}]}}                                  |
