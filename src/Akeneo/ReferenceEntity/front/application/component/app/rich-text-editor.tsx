    ...
    return {
      component: () => (
        <div className="AknMessageBox AknMessageBox--danger">
          <div className="AknMessageBox-title">{__('pim_reference_entity.editor.embedded.invalid_link.title')}</div>
          <p>{__('pim_reference_entity.editor.embedded.invalid_link.message')}</p>
