...
class ServiceProviderDefaultConfiguration implements ServiceProviderDefaultConfigurationInterface
{
    ...
    public function getServiceProvider(): ServiceProvider
    {
        ...
        $subject->setDNProp('id-at-organizationName', 'autogenerated self-signed certificat without end date');
        ...
        return ServiceProvider::fromArray([
            ...
            'publicCertificate' => $serviceProviderPublicKey,
            'privateCertificate' => $serviceProviderPrivateKey
        ]);
    }
}
