...
use Akeneo\Platform\TailoredImport\Infrastructure\Validation\DataMapping\Target\Attribute\MultiSelect\MultiSelect;
use Akeneo\Platform\TailoredImport\Test\Integration\Infrastructure\Validation\AbstractValidationTest;
use Akeneo\Test\Integration\Configuration;

final class MultiSelectValidatorTest extends AbstractValidationTest
{
    /**
    ...
    public function validDataMappings(): array
    {
        return [
            ...
            'a valid multi select data mapping with replacement operation' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'a_multi_select',
