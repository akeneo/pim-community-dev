...
module.exports = async function (cucumber) {
  ...
  Given(
    'the following attributes for the reference entity {string}:',
    async function (referenceEntityIdentifier, attributes) {
  ...
  When(
    'the user deletes the attribute {string} linked to the reference entity {string}',
    async function (attributeIdentifier, referenceEntityIdentifier) {
      await showAttributesTab(this.page);
      const attributes = await getElement(this.page, 'Attributes');
  ...
  When(
    'the user cannot delete the attribute {string} linked to the reference entity {string}',
    async function (attributeIdentifier, referenceEntityIdentifier) {
      await showAttributesTab(this.page);
      const attributes = await getElement(this.page, 'Attributes');
