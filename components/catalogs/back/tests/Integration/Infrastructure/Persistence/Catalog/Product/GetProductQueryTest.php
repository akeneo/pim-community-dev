...
class GetProductQueryTest extends IntegrationTestCase
{
    ...
    public function testItReturnsNullWithProductUuidNotBelongingToTheCatalog(): void
    {
        ...
        $catalogProduct = $this->getProductQuery->execute($catalogId, (string) $productDisabled->getUuid());

        $this->assertNull($catalogProduct);
    }
    ...
    public function testItReturnsAProductMatchingTheCatalog(): void
    {
        ...
        $result = $this->getProductQuery->execute($catalogId, $productEnabledUuid);
    ...
    public function testItReturnsAProductWithValuesFilteredByChannels(): void
    {
        ...
        $this->setCatalogProductValueFilters($catalogId, [
            'channels' => ['ecommerce'],
        ]);
        ...
        $result = $this->getProductQuery->execute($catalogId, $productUuid);
