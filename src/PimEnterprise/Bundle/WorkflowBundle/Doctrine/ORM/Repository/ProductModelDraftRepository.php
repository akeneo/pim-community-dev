...
/**
 * Product model draft repository
 */
class ProductModelDraftRepository extends EntityRepository implements ProductDraftRepositoryInterface, CursorableRepositoryInterface, SearchableRepositoryInterface, MassActionRepositoryInterface
{
    /**
     * {@inheritdoc}
     */
