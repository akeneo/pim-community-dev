...
Then I should get an error on update with message 'structure[0]: "attributeCode" field is required for "reference_entity" type.'
...
Then I should get an error on update with message 'structure[0]: "process" field is required for "reference_entity" type.'
