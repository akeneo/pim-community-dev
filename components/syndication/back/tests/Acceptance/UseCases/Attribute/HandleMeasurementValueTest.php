...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\Measurement\InMemoryFindUnitLabel;
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\Measurement\InMemoryFindUnitSymbol;
...
final class HandleMeasurementValueTest extends AttributeTestCase
{
    ...
    private function loadOptions(): void
    {
        ...
        $findUnitLabel = self::getContainer()->get('Akeneo\Platform\Syndication\Domain\Query\FindUnitLabelInterface');
        ...
        $findUnitSymbol = self::getContainer()->get('Akeneo\Platform\Syndication\Domain\Query\FindUnitSymbolInterface');
