 ...
 */
class ListChildrenCategoriesWithCountIncludingSubCategories implements \Akeneo\Category\Domain\Component\CategoryTree\Query\ListChildrenCategoriesWithCountIncludingSubCategories
{
    /** @var Connection */
    private $connection;
