...
final class AttributesWereCreatedOrUpdatedMessageIntegration extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        \putenv('PUBSUB_TOPIC_ATTRIBUTES_WERE_UPSERT=test_upsert_attributes_queue');
        \putenv('PUBSUB_SUBSCRIPTION_TEST_UPSERT_ATTRIBUTES_CONSUMER=test_upsert_attributes_consumer');
