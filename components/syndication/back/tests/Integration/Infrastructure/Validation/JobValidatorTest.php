...
class JobValidatorTest extends AbstractValidationTest
{
    ...
    {
        $job = $this->get('akeneo_batch.job.job_registry')->get('syndication_product_export');
    ...
    public function test_it_invalidates_an_invalid_job(): void
    {
        ...
        $this->assertHasValidationError(
            'akeneo.syndication.validation.attribute.should_exist',
    ...
    {
        return [
            'filePath' => '/tmp/export_%job_label%_%datetime%.syndication',
            'withHeader' => true,
            'linesPerFile' => 10000,
            'user_to_notify' => null,
    ...
    {
        return [
            'filePath' => '/tmp/export_%job_label%_%datetime%.amazon',
            'withHeader' => true,
            'linesPerFile' => 10000,
            'user_to_notify' => null,
            'is_user_authenticated' => false,
