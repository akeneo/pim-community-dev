...
class ListGrantedChildrenCategoriesWithCountIncludingSubCategoriesIntegration extends TestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = $this->get('akeneo.pim.enrichment.category.category_tree.query.list_children_categories_with_count_including_sub_categories');
