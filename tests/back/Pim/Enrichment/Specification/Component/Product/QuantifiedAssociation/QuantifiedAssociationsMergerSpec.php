...
class QuantifiedAssociationsMergerSpec extends ObjectBehavior
{
    public function it_merge_quantified_associations(
        ...
        $product1->getQuantifiedAssociationCollection()->willReturn($quantifiedAssociations1);
        $product2->getQuantifiedAssociationCollection()->willReturn($quantifiedAssociations2);
