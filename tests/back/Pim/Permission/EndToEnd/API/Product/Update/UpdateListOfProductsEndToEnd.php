...
class UpdateListOfProductsEndToEnd extends AbstractProductTestCase
{
...
{"line":1,"identifier":"not_existing_product","status_code":422,"message":"The a_metric_without_decimal_negative attribute does not exist in your PIM. Check the expected format on the API documentation.","_links":{"documentation":{"href":"http:\/\/api.akeneo.com\/api-reference.html#patch_products__code_"}}}
...
JSON;
        $expectedContent = <<<JSON
{"line":1,"identifier":"product_without_category","status_code":422,"message":"The a_metric_without_decimal_negative attribute does not exist in your PIM. Check the expected format on the API documentation.","_links":{"documentation":{"href":"http:\/\/api.akeneo.com\/api-reference.html#patch_products__code_"}}}
{"line":2,"identifier":"toto","status_code":201}
JSON;
        $response = $this->executeAndCheckStreamRequest($data);
