...
define(['jquery', 'underscore', 'backbone', 'oro/translator', 'oro/app', 'oro/messenger',
    ...
    function($, _, Backbone, __, app, messenger, CalendarConnectionCollection, CalendarConnectionModel) {
        'use strict';

        /**
         * @export  oro/calendar/connection-view
         * @class   oro.CalendarConnectionView
        ...
        return Backbone.View.extend({
            ...
            initialize: function() {
                this.options.collection = this.options.collection || new CalendarConnectionCollection();
                this.template = _.template($("#template-calendar-connection-item").html());
