...
$index = $container->getParameter('asset_index_name');
$configurationLoader = new Loader(
    [
        "{$eeDir}/src/Akeneo/AssetManager/back/Infrastructure/Symfony/Resources/config/search/asset_index_configuration.yml",
    ]
);
