...
use PimEnterprise\Bundle\ProductAssetBundle\MassUpload\MassUploadToProductTasklet;
 ...
 */
class MassUploadToProductTaskletSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(MassUploadToProductTasklet::class);
    }
