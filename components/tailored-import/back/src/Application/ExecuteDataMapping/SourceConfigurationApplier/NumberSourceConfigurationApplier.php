...
class NumberSourceConfigurationApplier implements SourceConfigurationApplierInterface
{
    ...
    {
        if (!$sourceConfiguration instanceof NumberSourceConfiguration) {
            throw new \InvalidArgumentException('Cannot apply Number source configuration on this value');
        }
    ...
    {
        return $sourceConfiguration instanceof NumberSourceConfiguration;
    }
}
