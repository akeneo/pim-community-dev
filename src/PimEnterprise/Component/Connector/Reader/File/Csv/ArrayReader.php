...
namespace PimEnterprise\Component\Connector\Reader\File\Csv;
...
/**
 * The Array Reader allows to read file CSV file, where each line will return an array of items. The main function
