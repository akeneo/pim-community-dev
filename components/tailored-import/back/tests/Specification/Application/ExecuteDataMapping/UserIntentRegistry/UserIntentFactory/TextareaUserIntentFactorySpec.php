...
class TextareaUserIntentFactorySpec extends ObjectBehavior
{
    ...
    public function it_throws_an_exception_when_target_type_is_invalid(
        ...
        $this->shouldThrow(new \InvalidArgumentException('The target must be an AttributeTarget and be of type "pim_catalog_textarea"'))->during('create', [$attributeTarget, $value]);
    }
