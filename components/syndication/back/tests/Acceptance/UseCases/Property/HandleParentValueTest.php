...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\ProductModel\InMemoryFindProductModelLabels;
...
final class HandleParentValueTest extends PropertyTestCase
{
    ...
    private function loadParent(): void
    {
        ...
        $findProductModelLabelsRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindProductModelLabelsInterface');
