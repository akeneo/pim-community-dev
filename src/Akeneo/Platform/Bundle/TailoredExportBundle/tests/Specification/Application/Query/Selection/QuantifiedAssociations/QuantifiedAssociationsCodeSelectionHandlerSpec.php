...
class QuantifiedAssociationsCodeSelectionHandlerSpec extends ObjectBehavior
{
    ...
    public function it_does_not_apply_selection_on_not_supported_selections_and_values()
    {
        ...
        $this
            ->shouldThrow(new \InvalidArgumentException('Cannot apply quantified associations code selection on this entity'))
            ->during('applySelection', [$notSupportedSelection, $notSupportedValue]);
    }

    public function it_supports_quantified_association_code_selection_with_quantified_association_value()
    {
        $selection = new QuantifiedAssociationsCodeSelection('products', '/');
