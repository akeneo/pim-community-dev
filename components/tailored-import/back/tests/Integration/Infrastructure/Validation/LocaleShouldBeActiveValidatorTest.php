...
use Akeneo\Platform\TailoredImport\Infrastructure\Validation\LocaleShouldBeActive;
...
class LocaleShouldBeActiveValidatorTest extends AbstractValidationTest
{
    ...
    public function test_it_builds_violations_when_locale_is_not_active(): void
    {
        ...
        $this->assertHasValidationError('akeneo.tailored_import.validation.locale.should_be_active', '', $violations);
    }
