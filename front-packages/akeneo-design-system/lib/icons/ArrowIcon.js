...
var ArrowIcon = function (_a) {
    ...
    return (react_1.default.createElement("svg", __assign({ viewBox: "0 0 24 24", width: size, height: size }, props),
        ...
        react_1.default.createElement("path", { stroke: color, vectorEffect: "non-scaling-stroke", d: "M21 19H3V2m15 14l3 3-3 3", fill: "none", fillRule: "evenodd", strokeLinecap: "round" })));
};
