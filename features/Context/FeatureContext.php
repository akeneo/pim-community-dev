...
use Pim\Behat\Context\Domain\Collect\ImportFileContext;
...
class FeatureContext extends PimContext implements KernelAwareContext
{
    ...
    public function gatherContexts(BeforeScenarioScope $scope)
    {
        ...
        $this->contexts['importFile'] = $environment->getContext(\Pim\Behat\Context\Domain\Collect\ImportFileContext::class);
