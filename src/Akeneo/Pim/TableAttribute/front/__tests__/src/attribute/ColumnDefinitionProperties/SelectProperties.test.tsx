...
const selectedColumn = getComplexTableAttribute().table_configuration.find(columnDefinition => columnDefinition.data_type === 'select') as SelectColumnDefinition;

describe('SelectProperties', () => {
  it('should render the component', () => {
    renderWithProviders(
      <SelectProperties attribute={getComplexTableAttribute()} selectedColumn={selectedColumn} handleChange={jest.fn()}/>
    );
  ...
  it('should callback changes', () => {
    ...
    renderWithProviders(
      <SelectProperties attribute={getComplexTableAttribute()} selectedColumn={selectedColumn} handleChange={handleChange}/>
    );
    ...
    expect(handleChange).toBeCalledWith(
      {...selectedColumn, options: [{code: 'fake_code', labels: {en_US: 'fake label'}}]}
    );
  });
});
