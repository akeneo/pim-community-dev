    ...
    function ($, _, Backbone, BaseForm, formTemplate, UserContext, Routing, TreeAssociate, mediator) {
        return BaseForm.extend({
            ...
            changeTree: function (event) {
                ...
                $(event.currentTarget).siblings('.AknVerticalNavtab-item').removeClass('AknVerticalNavtab-item--active');
                $(event.currentTarget).addClass('AknVerticalNavtab-item--active');
            },
