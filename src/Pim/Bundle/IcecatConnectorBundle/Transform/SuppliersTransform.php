...
class SuppliersTransform implements TransformInterface
{
    ...
    /**
     * (non-PHPdoc)
     * @see Pim\Bundle\IcecatConnectorBundle\Transform.LanguagesTransform::transform()
     */
...
//         $xml->open($this->filePath);
        ...
        while ($xml->read()) {
            if ($xml->nodeType === XMLREADER::ELEMENT && $xml->name === 'SupplierMapping') {
                ...
                $supplier = $this->entityManager->getRepository('PimIcecatConnectorBundle:SourceSupplier')
