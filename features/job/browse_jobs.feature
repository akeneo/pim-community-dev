...
Feature: Browse jobs
  ...
  Scenario: Successfully view job profiles depending on given permissions for manager
    ...
    And I should see import profiles clothing_attribute_import, clothing_group_import, clothing_product_import, clothing_rule_import, clothing_product_proposal_import and xlsx_clothing_product_proposal_import
