...
class ProductPriceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetSetValue()
    {
        ...
        $this->assertInstanceOf('Pim\Bundle\ProductBundle\Entity\ProductValue', $this->price->getValue());
    }

    /**
     * Assert entity
     * @param Pim\Bundle\ProductBundle\Entity\ProductPrice $entity
     */
    protected function assertEntity($entity)
    {
        $this->assertInstanceOf('Pim\Bundle\ProductBundle\Entity\ProductPrice', $entity);
    }
}
