...
class RegisterCalculationStepPass implements CompilerPassInterface
{
     ...
     */
    const DEFAULT_CALCULATION_STEP = 'pimee_team_work_assistant.calculation_step.chained';

    /**
     * All calculation step must be tagged with "pimee_team_work_assistant.calculation_step".
     */
    const CALCULATION_STEP_TAG = 'pimee_team_work_assistant.calculation_step';
