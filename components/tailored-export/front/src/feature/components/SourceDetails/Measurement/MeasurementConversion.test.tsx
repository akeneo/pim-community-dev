...
test('it can update a conversion unit', async () => {
  ...
  userEvent.click(
    screen.getByText('akeneo.tailored_export.column_details.sources.operation.measurement_conversion.title')
  );
  userEvent.click(
    screen.getByLabelText(
      'akeneo.tailored_export.column_details.sources.operation.measurement_conversion.target_unit_code.label'
    )
  );
