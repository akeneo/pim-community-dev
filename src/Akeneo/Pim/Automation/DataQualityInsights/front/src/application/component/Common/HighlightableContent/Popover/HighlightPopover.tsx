...
const HighlightPopover: FC<HighlightPopoverProps> = ({children, activeHighlight, activeElement, ariaLabel, ...popoverProps}) => {
  ...
  return (
    <HighlightPopoverContextProvider activeHighlight={activeHighlight} activeElement={activeElement} hide={hide !== undefined ? hide : () => {}}>
      <Popover {...popoverProps} ref={popoverRef} aria-label={ariaLabel} tabIndex={0}
       unstable_autoFocusOnShow={false} unstable_autoFocusOnHide={false}
