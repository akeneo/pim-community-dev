...
FROM `pimee_team_work_assistant_project` AS `p`
INNER JOIN `pimee_team_work_assistant_project_product` AS `pp`
	ON `pp`.`project_id` = `p`.`id`
INNER JOIN `pimee_team_work_assistant_completeness_per_attribute_group` AS `cag`
