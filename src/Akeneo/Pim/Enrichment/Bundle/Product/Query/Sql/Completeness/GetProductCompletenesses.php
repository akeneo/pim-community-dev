 ...
 */
final class GetProductCompletenesses
{
    /** @var Connection */
    private $connection;
    ...
    {
        $sql = <<<SQL
SELECT channel.code AS channel_code, locale.code AS locale_code, completeness.required_count AS required_count, JSON_ARRAYAGG(attribute.code) AS missing_attribute_codes
...
GROUP BY channel.code, locale.code
SQL;
