...
| multi select                 	| string[]       | `[0 => "optionA", 1 => "optionB"]`                                                                 | each element of the array represents the *code* of the *Akeneo\Pim\Structure\Component\Model\AttributeOptionInterface*       |
| number                       	| string         | `"-99.8732"`                                                                                       | formatted as a string to avoid the floating point precision problem of PHP (see above)                              |
| reference data multi select  	| string[]       | `[0 => "fabricA",1 => "fabricB"]`                                                                  | each element of the array represents the *code* of the *Akeneo\Pim\Enrichment\Component\Product\Model\ReferenceDataInterface*   |
| simple select                	| string         | `"optionB"`                                                                                        | it represents the *code* of the *Akeneo\Pim\Structure\Component\Model\AttributeOptionInterface*                              |
| reference data simple select 	| string         | `"colorB"`                                                                                         | it represents the *code* of the *Akeneo\Pim\Enrichment\Component\Product\Model\ReferenceDataInterface*                          |
...
| reference_data_name    | string         | `"color"`                          | it represents the *code* of the object *Akeneo\Pim\Enrichment\Component\Product\Model\ReferenceDataInterface*                                                                                      |
| available_locales      | string[]       | `[0 => "en_US", 1 => "fr_FR"]`     | only for locale specific. If the array is empty, locale specific is false. Each element of the array represents the *code* of the object *Akeneo\Channel\Component\Model\LocaleInterface* |
...
| labels  | string[]       | `["en_US" => "Croll sell"]` | each key of the array represents the *code* of the *Akeneo\Channel\Component\Model\LocaleInterface* |
...
| family                 | string         | `"family"`                                                                                                 | it represents the *code* of the *Akeneo\Pim\Structure\Component\Model\FamilyInterface* the family variant belongs to |
...
| type   | string         | `"RELATED"`               |                                                                                                  |
| labels | array          | `["en_US" => "My group"]` | each key of the array represents the *code* of the *Akeneo\Channel\Component\Model\LocaleInterface* |
...
| labels     | array          | `["en_US" => "My beautiful group type"]` | each key of the array represents the *code* of the *Akeneo\Channel\Component\Model\LocaleInterface* |
...
| type       | string         | `"product"`                                                                                                                                          | it represents the *type* of the object *Akeneo\Tool\Bundle\RuleEngineBundle\Model\RuleDefinitionInterface*           |
