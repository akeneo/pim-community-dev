...
import useSpellcheckOptionsListState
  from "../../../../infrastructure/hooks/AttributeEditForm/useSpellcheckOptionsListState";
import useSpellcheckPopoverState, {useSpellcheckPopoverProps} from "../../../../infrastructure/hooks/Common/Spellcheck/useSpellcheckPopoverState";
...
const SpellcheckOptionsList: FC = () => {
  ...
  const handleIgnore = useCallback((text: string, locale: string) => {
    (async () => {
