...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\Families;
...
class FamiliesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(Families::class);
    }
