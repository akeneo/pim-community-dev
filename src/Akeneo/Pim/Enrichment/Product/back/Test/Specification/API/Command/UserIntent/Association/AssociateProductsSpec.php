 ...
 */
class AssociateProductsSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(AssociateProducts::class);
    ...
    public function it_cannot_be_instantiated_with_empty_product_identifiers()
    {
