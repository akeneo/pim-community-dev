...
class NumberUserIntentFactorySpec extends ObjectBehavior
{
    ...
    public function it_create_a_set_number_value_object(
        ...
        $this->create($targetAttribute, 123)->shouldBeLike($expectedSetNumberValue);
    }
    ...
    public function it_does_not_support_target_attribute_other_than_catalog_number(
        TargetAttribute $targetAttribute
    )
    {
