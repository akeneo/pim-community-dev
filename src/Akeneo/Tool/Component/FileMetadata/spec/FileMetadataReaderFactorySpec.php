...
class FileMetadataReaderFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Tool\Component\FileMetadata\FileMetadataReaderFactoryInterface');
    }
    ...
    function it_creates_a_file_metadata_reader_for_the_given_file(
        ...
        $reader->shouldHaveType('Akeneo\Tool\Component\FileMetadata\FileMetadataReaderInterface');
        $reader->all($file);
    }
}
