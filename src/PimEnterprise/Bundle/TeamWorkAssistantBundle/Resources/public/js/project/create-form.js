...
define(
    [
        ...
        'oro/loading-mask',
        'oro/messenger',
        'team-work-assistant/saver/project',
        'datepicker',
        'pim/date-context',
        'pim/datagrid/state',
        'pim/user-context',
        'pim/formatter/date',
        'text!team-work-assistant/templates/grid/create-project-modal-content',
        'text!team-work-assistant/templates/field-error'
    ],
    function (
        $,
        _,
        ...
        return BaseForm.extend({
            ...
            validateLabel: function (label) {
                ...
                if (isLabelTooLong) {
                    this.validationErrors.push({
                        field: 'label',
                        message: __('team_work_assistant.project.label_maxlength', {max: this.maxLengthLabel})
                    });
                }

                this.trigger(
                    'team-work-assistant:edit-project:field-validated',
                    'label',
                    !isLabelTooLong
                );
            },
            ...
            validateDueDate: function (modelDueDate) {
                ...
                if (fieldIsInvalid) {
                    this.validationErrors.push({
                        field: 'dueDate',
                        message: __('team_work_assistant.project.due_date_past')
                    });
                }
                ...
                return ProjectSaver.save(project)
                    .done(function () {
                        messenger.notificationMessage(
                            'success',
                            __('team_work_assistant.' + this.formType + '_project_modal.saved')
                        );
                    }.bind(this))
            ...
            render: function () {
                ...
                this.$el.html(this.template({
                    ...
                    labelLabel: __('team_work_assistant.project.label'),
                    labelPlaceholder: __('team_work_assistant.' + this.formType + '_project_modal.label_placeholder'),
                    descriptionValue: model.get('description'),
                    descriptionLabel: __('team_work_assistant.project.description'),
                    descriptionPlaceholder: __(
                        'team_work_assistant.' + this.formType + '_project_modal.description_placeholder'
                    ),
                    ...
                    dueDateLabel: __('team_work_assistant.project.due_date'),
                    errors: this.validationErrors,
                    requiredLabel: __('team_work_assistant.common.required')
                }));
