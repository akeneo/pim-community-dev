...
Feature: Mass Edit Families
  ...
  Scenario: Successfully mass edit attribute requirements by attribute group
    ...
    Then attribute "rate_sale" should be optional in family "boots" for channel "Tablet"
    And attribute "rate_sale" should be optional in family "sneakers" for channel "Tablet"
    And attribute "rate_sale" should be optional in family "sandals" for channel "Tablet"
    And attribute "rate_sale" should be optional in family "boots" for channel "Mobile"
    And attribute "rate_sale" should be optional in family "sneakers" for channel "Mobile"
    And attribute "rate_sale" should be optional in family "sandals" for channel "Mobile"
