...
Feature: Display completeness widget
  ...
  Scenario: Display completeness widget
    ...
    Then I should see the text "Completeness Over Channels and Locales"
    Then completeness of "Ecommerce" should be "13%"
    And "German (Germany)" completeness of "Ecommerce" should be "0/2"
    And "English (United Kingdom)" completeness of "Ecommerce" should be "0/2"
    And "English (United States)" completeness of "Ecommerce" should be "0/2"
    And "French (France)" completeness of "Ecommerce" should be "1/2"
    And completeness of "Tablet" should be "100%"
    And "English (United Kingdom)" completeness of "Tablet" should be "1/1"
    And "English (United States)" completeness of "Tablet" should be "1/1"
    And completeness of "Print" should be "0%"
    And "German (Germany)" completeness of "Print" should be "0/1"
    And "English (United States)" completeness of "Print" should be "0/1"
