...
namespace Akeneo\OnboarderSerenity\Test\Integration\Infrastructure\Supplier\Import;
...
final class ImportSupplierTaskletIntegration extends SqlIntegrationTestCase
{
    ...
    {
        $filePath = sprintf(
            '%s/components/onboarder/back/tests/Integration/files/suppliers_import_empty.xlsx',
            static::$kernel->getProjectDir(),
        );
