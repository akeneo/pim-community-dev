...
const QuantifiedAssociationTypeSelector = ({
  ...
  return (
    ...
    >
      <Section>
        <Field label={translate('akeneo.syndication.data_mapping_details.sources.selection.association.entity_type')}>
          <SelectInput
            clearable={false}
        ...
        <Field label={translate('pim_common.type')}>
          ...
          >
            ...
            <SelectInput.Option
              title={translate(
                'akeneo.syndication.data_mapping_details.sources.selection.quantified_association.quantity'
              )}
              value="quantity"
            >
              {translate('akeneo.syndication.data_mapping_details.sources.selection.quantified_association.quantity')}
            </SelectInput.Option>
          </SelectInput>
          ...
          <>
            ...
            >
              <Helper inline={true} level="info">
                {translate('akeneo.syndication.data_mapping_details.sources.selection.association.information.channel')}
              </Helper>
            </ChannelDropdown>
            <LocaleDropdown
              locales={locales}
            ...
            >
              <Helper inline={true} level="info">
                {translate('akeneo.syndication.data_mapping_details.sources.selection.association.information.locale')}
              </Helper>
            </LocaleDropdown>
          </>
        )}
