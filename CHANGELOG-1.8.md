...
### Configuration
- PIM-6740: Add parameter ̀ install_status_dir` in `pim_parameters.yml` (default to `var` for dev/test env)
- PIM-6740: Remove `installed` parameters from `parameters.yml.dist`
