...
define([
  ...
  'react'
], function (_, __, BaseForm, router, Routing, template, mediator, { MainNavigationItem, CardIcon }, React) {
  return BaseForm.extend({
    ...
    render: function () {
      ...
      this.renderReact(MainNavigationItem, {
        children: this.getLabel(),
        icon: icon,
        onClick: (event) => this.redirect(event.nativeEvent),
        active: this.active
      }, this.el);
