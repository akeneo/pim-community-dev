 ...
 */
final class AssociateQuantifiedProductUuids implements QuantifiedAssociationUserIntent
{
    /**
     * @param QuantifiedProductWithUuid[] $quantifiedProducts
     */
    public function __construct(private string $associationType, private array $quantifiedProducts)
    {
        ...
        Assert::allIsInstanceOf($quantifiedProducts, QuantifiedProductWithUuid::class);
    }
    ...
    /**
     * @return QuantifiedProductWithUuid[]
     */
