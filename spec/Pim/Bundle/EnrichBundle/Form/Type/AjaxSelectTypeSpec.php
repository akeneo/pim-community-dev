...
class AjaxSelectTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->getName()->shouldReturn('pim_ajax_select');
    }
    ...
    function it_builds_form(
        ...
        $transformerFactory->create($repository, $options)->willReturn($transformer);
