  ...
  $.widget('ech.multiselect', {
    ...
    _create: function () {
      ...
      var button = (this.button = $(
          '<button type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'
        ))
    ...
    _bindEvents: function () {
      ...
      button.find('span').on('click.multiselect', clickHandler);
      ...
      this.menu
        .delegate('li.ui-multiselect-optgroup-label a', 'click.multiselect', function (e) {
          ...
          var $inputs = $this
            .parent()
            .nextUntil('li.ui-multiselect-optgroup-label')
    ...
    _traverse: function (which, start) {
      ...
      $next = $start
        .parent()
        [moveToLast ? 'prevAll' : 'nextAll']('li:not(.ui-multiselect-disabled, .ui-multiselect-optgroup-label)')
        [moveToLast ? 'last' : 'first']();
