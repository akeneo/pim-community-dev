...
final class ExportUserRoleIntegration extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->get(SqlCreateJobInstance::class)->createJobInstance([
            ...
            'status' => 0,
            'type' => 'export',
            'raw_parameters' => 'a:5:{s:9:"delimiter";s:1:";";s:9:"enclosure";s:1:""";s:10:"withHeader";b:1;s:14:"user_to_notify";N;s:21:"is_user_authenticated";b:0;}',
        ]);
        $this->get(SqlCreateJobInstance::class)->createJobInstance([
            ...
            'status' => 0,
            'type' => 'export',
            'raw_parameters' => 'a:4:{s:10:"withHeader";b:1;s:12:"linesPerFile";i:10000;s:14:"user_to_notify";N;s:21:"is_user_authenticated";b:0;}',
        ]);
    }
