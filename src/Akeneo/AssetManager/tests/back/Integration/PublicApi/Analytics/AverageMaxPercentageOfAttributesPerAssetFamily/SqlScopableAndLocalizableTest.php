...
class SqlScopableAndLocalizableTest extends SqlIntegrationTestCase
{
    ...
    private SqlScopableAndLocalizable $averageMaxPercentageOfScopableOnlyAttributesPerAssetFamily;

    public function setUp(): void
    {
        parent::setUp();

        $this->averageMaxPercentageOfScopableOnlyAttributesPerAssetFamily = $this->get('akeneo_assetmanager.infrastructure.persistence.query.analytics.average_max_percentage_of_attributes_per_asset_family.scopable_only_and_localizable');
