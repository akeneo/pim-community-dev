...
class ChangeStatusSpec extends ObjectBehavior
{
    ...
    {
        $this->getAlias()->shouldReturn('change-status');
    }
    ...
    {
        $this->getBatchJobCode()->shouldReturn('update_product');
    }
    ...
    function it_provides_formatted_batch_config_for_the_job()
    {
        ...
        $this->getBatchConfig()->shouldReturn(
            '{\"filters\":[[\"id\",\"IN\",[\"98\",\"99\",\"100\"]]],\"actions\":[{\"field\":\"enable\",\"value\":true}]}'
        );
        ...
        $this->getBatchConfig()->shouldReturn(
            '{\"filters\":[[\"id\",\"IN\",[\"98\",\"99\",\"100\"]]],\"actions\":[{\"field\":\"enable\",\"value\":false}]}'
        );
    }
}
