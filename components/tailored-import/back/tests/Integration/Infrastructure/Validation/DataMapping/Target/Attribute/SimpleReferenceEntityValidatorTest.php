...
use Akeneo\Platform\TailoredImport\Infrastructure\Validation\DataMapping\Target\Attribute\SimpleReferenceEntity\SimpleReferenceEntity;
use Akeneo\Platform\TailoredImport\Test\Integration\Infrastructure\Validation\AbstractValidationTest;
use Akeneo\Test\Integration\Configuration;

final class SimpleReferenceEntityValidatorTest extends AbstractValidationTest
{
    /**
    ...
    {
        $violations = $this->getValidator()->validate($value, new SimpleReferenceEntity([
    ...
    {
        return [
            'a valid simple reference entity data mapping' => [
                [
            ...
            'a valid simple reference entity data mapping with clear value' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'a_simple_reference_entity',
            ...
            'a valid simple reference entity data mapping with sample data' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'a_simple_reference_entity',
    ...
    {
        return [
            'a simple reference entity data mapping with an invalid uuid' => [
            ...
            'a simple reference entity data mapping does not handle add action if not empty' => [
            ...
            'a simple reference entity data mapping with an unsupported operation' => [
            ...
            'a simple reference entity data mapping with an invalid sample data' => [
