...
Feature: Export variant products through CSV export
  ...
  Scenario: Export product models through CSV
    ...
    Then exported file of "csv_product_model_export" should contain the lines:
      """
      code;family_variant;parent;categories;X_SELL-groups;X_SELL-products;X_SELL-product_models;UPSELL-groups;UPSELL-products;UPSELL-product_models;SUBSTITUTION-groups;SUBSTITUTION-products;SUBSTITUTION-product_models;PACK-groups;PACK-products;PACK-product_models;COMPATIBILITY-groups;COMPATIBILITY-products;COMPATIBILITY-product_models;brand;care_instructions;collection;color;composition;description-en_US-ecommerce;erp_name-en_US;image;keywords-en_US;material;meta_description-en_US;meta_title-en_US;name-en_US;notice;price-EUR;price-USD;supplier;variation_image;variation_name-en_US;wash_temperature;weight;weight-unit
