Feature: Update association fields
  ...
  Scenario: Successfully update the association field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | owner   | [{"type": "add_data", "field": "associations", "data": {"similar":{"products":["associatedTwo", "associatedThree"], "groups":["groupTwo","groupThree"]}}}] | {"associations":{"similar":{"products":["associatedOne","associatedThree","associatedTwo"],"groups":["groupOne","groupTwo","groupThree"]}}} |
