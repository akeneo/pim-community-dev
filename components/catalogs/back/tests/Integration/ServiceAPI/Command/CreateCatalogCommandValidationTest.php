...
use Akeneo\Catalogs\Infrastructure\Validation\MaxLimitValidator;
...
class CreateCatalogCommandValidationTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        self::getContainer()->set(
            MaxLimitValidator::class,
            new class($this->isCatalogsNumberLimitReachedQuery) extends MaxLimitValidator {
            }
        );
    ...
    public function testItValidatesThatTheLimitOfCatalogsByUserIsNotReached(): void
    {
        ...
        $this->assertViolationsListContains($violations, 'You can create up to 15 catalogs per app');
    }
}
