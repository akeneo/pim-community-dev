...
class ProductCategoryAccessUpdaterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Akeneo\Pim\Permission\Component\Updater\ProductCategoryAccessUpdater');
    }
    ...
    function it_throws_an_exception_if_group_not_found(
        ...
        $this->shouldThrow(
            InvalidPropertyException::validEntityCodeExpected(
                ...
                'Akeneo\Pim\Permission\Component\Updater\ProductCategoryAccessUpdater',
                'foo'
            )
