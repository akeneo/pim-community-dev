...
class ProposalController
{
     ...
     */
    private $productDraftFactory;
    /**
     * @var ProductDraftRepository
     */
    private $productDraftRepository;
    /**
     * @var ProductDraftBuilder
     */
    private $productDraftBuilder;
    ...
    public function __construct(
        ...
        ProductDraftFactory $productDraftFactory,
        ProductDraftRepository $productDraftRepository,
        ProductDraftBuilder $productDraftBuilder
    ) {
    ...
    public function partialUpdateAction(Request $request, $code)
    {
        ...
        if (null === $productDraft) {
            $productDraft = $this->productDraftFactory->createProductDraft($product, $data['username']);
        }

        $productDraft->setChanges($data['changes']);
        $productDraft->setAuthor($data['author']);
        $productDraft->markAsReady();
        $productDraft->setAllReviewStatuses('to_review');
