...
class FamilySaver implements SaverInterface, BulkSaverInterface
{
    ...
    public function save($family, array $options = [])
    {
        ...
        $this->eventDispatcher->dispatch(BaseEvents::PRE_SAVE, new GenericEvent($family));
        ...
        $this->eventDispatcher->dispatch(BaseEvents::POST_SAVE, new GenericEvent($family));
    }
    ...
    public function saveAll(array $families, array $options = [])
    {
        ...
        $this->eventDispatcher->dispatch(BaseEvents::PRE_SAVE_ALL, new GenericEvent($families));
        ...
        $this->eventDispatcher->dispatch(BaseEvents::POST_SAVE_ALL, new GenericEvent($families));
    }
}
