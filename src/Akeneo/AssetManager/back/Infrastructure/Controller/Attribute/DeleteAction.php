...
class DeleteAction
{
    public function __construct(private DeleteAttributeHandler $deleteAttributeHandler, private SecurityFacade $securityFacade, private CanEditAssetFamilyQueryHandler $canEditAssetFamilyQueryHandler, private TokenStorageInterface $tokenStorage)
    {
    }
