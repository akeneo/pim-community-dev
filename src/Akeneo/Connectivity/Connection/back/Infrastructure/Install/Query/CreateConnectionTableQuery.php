...
CREATE TABLE IF NOT EXISTS akeneo_connectivity_connection(
    ...
    CONSTRAINT FK_CONNECTIVITY_CONNECTION_pim_api_client_connection_client_id FOREIGN KEY (client_id) REFERENCES pim_api_client (id),
    CONSTRAINT FK_CONNECTIVITY_CONNECTION_oro_user_connection_user_id FOREIGN KEY (user_id) REFERENCES oro_user (id),
