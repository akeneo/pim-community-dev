...
export const getErrorsView = (errors: ValidationError[], field: string, searchMethod: (field: string) => (error: ValidationError) => boolean = equalsFilter) => {
