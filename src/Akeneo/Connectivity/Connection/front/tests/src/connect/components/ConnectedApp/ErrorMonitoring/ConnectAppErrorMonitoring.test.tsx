...
} from '@src/connect/components/ConnectedApp/ErrorMonitoring/NotDataSourceConnectedApp';
...
test('It renders the app errors',  async done => {
    (useFetchConnectedAppMonitoringSettings as jest.Mock).mockImplementation(() => () => Promise.resolve({
    ...
    await waitFor(() => expect(ConnectionErrors).toHaveBeenCalledWith({
