...
const LockIcon = ({title, size = 24, color = 'currentColor', ...props}: IconProps) => (
  <svg viewBox="0 0 24 24" width={size} height={size} {...props}>
    ...
    <g stroke={color} transform="translate(3 2)" fillRule="nonzero" fill="none">
      ...
      <path vectorEffect="non-scaling-stroke" d="M5.5 7.5V3.088C5.5 1.383 7.067 0 9 0s3.5 1.383 3.5 3.088V7.5" />
      <path vectorEffect="non-scaling-stroke" d="M9 12v3" strokeLinecap="round" />
    </g>
  </svg>
);
