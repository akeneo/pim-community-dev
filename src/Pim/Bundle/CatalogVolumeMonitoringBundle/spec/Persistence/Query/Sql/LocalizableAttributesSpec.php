...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\LocalizableAttributes;
...
class LocalizableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(LocalizableAttributes::class);
    }
    ...
    function it_gets_average_and_max_volume($connection, Statement $statement)
    {
        ...
        $this->fetch()->shouldBeLike(new CountVolume(4, 12, 'localizable_attributes'));
    }
}
