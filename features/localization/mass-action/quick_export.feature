@javascript
Feature: Quick export many products with localizes attributes from datagrid
  ...
  Background:
    ...
    And the following products:
      | sku      | family   | categories        | name-en_US    | price                | size | color | weight      | rate_sale |
      | boots    | boots    | winter_collection | Amazing boots | 20.80 EUR, 25.35 USD | 40   | black | 250 GRAM    | 75.5      |
  ...
  Scenario: Successfully quick export products with number attributes
    ...
    """
    sku;categories;color;enabled;family;groups;name-en_US;price-EUR;price-USD;rate_sale;size;weight;weight-unit
    boots;winter_collection;black;1;boots;;"Amazing boots";20,80;25,35;75,5000;40;250,0000;GRAM
    sneakers;summer_collection;white;1;sneakers;;Sneakers;50,00;60,00;75,0000;42;125,5000;GRAM
    sandals;summer_collection;red;1;sandals;;Sandals;5,00;5,00;75,0000;40;0,5000;GRAM
