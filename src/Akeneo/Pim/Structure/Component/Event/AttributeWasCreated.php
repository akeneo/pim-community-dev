 ...
 */
final class AttributeWasCreated
{
    ...
    public static function denormalize(array $normalized): AttributeWasCreated
    {
        ...
        return new AttributeWasCreated($normalized['id'], $normalized['code'], $date);
    }
}
