...
class AttributeGroupCompletenessCalculatorSpec extends ObjectBehavior
{
    ...
    function it_pre_processes_completeness_when_all_product_values_are_filled_for_an_attribute_group(
        ...
        $result[0]->shouldBeAnInstanceOf('Akeneo\Pim\WorkOrganization\TeamworkAssistant\Component\Model\AttributeGroupCompleteness');
        $result[1]->shouldBeAnInstanceOf('Akeneo\Pim\WorkOrganization\TeamworkAssistant\Component\Model\AttributeGroupCompleteness');
