...
namespace spec\Pim\Bundle\NotificationBundle\DependencyInjection\Compiler;
...
class RegisterDataCollectorPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Pim\Bundle\NotificationBundle\DependencyInjection\Compiler\RegisterDataCollectorPass');
    }
