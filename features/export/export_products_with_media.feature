...
Feature: Export products with media
  ...
  Scenario: Successfully export products with media
    ...
    """
    sku;categories;color;description-en_US-mobile;description-fr_FR-mobile;enabled;family;groups;lace_color;manufacturer;name-en_US;name-fr_FR;price-EUR;price-USD;rating;side_view;size;top_view;weather_conditions
