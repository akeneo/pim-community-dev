...
final class HandleQualityScoreValueTest extends PropertyTestCase
{
    public const PROPERTY_NAME = 'quality_score';

    /**
     * @dataProvider provider
     */
    public function test_it_can_transform_a_quality_score_value(
        array $operations,
