Feature: Edit a number attribute of a reference entity
  ...
  @acceptance-back
  Scenario: Updating is prefix property
  ...
  @acceptance-back
  Scenario Outline: Invalid is prefix edit
    Given  a reference entity with an url attribute 'dam_image'
  ...
  Scenario Outline: Invalid is suffix edit
    ...
    Examples:
      ...
      | ""                       | The suffix cannot be empty. |

  @acceptance-back
  Scenario: Updating is preview type property
    Given a reference entity with an url attribute 'dam_image'
    When the user sets the preview type value of 'dam_image' to '"other"'
    Then 'dam_image' preview type should be '"other"'

  @acceptance-back
  Scenario Outline: Invalid is preview type edit
    Given  a reference entity with an url attribute 'dam_image'
