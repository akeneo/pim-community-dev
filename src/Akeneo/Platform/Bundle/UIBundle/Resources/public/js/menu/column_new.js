 ...
 */
define(['underscore', 'pim/form/common/column', 'pim/router', 'oro/mediator', 'akeneo-design-system'], function (
  _,
  Column,
  router,
  mediator,
  ...
  return Column.extend({
      ...
      if (this.active && this.isVisible) {
        this.renderReact(
          SubNavigationPanel,
          {
            ...
            onCollapse: isOpen => this.setCollapsed(!isOpen),
          },
          this.el
        );
    ...
    setCollapsed: function (collapsed) {
      sessionStorage.setItem(this.getSessionStorageKey(), collapsed ? '1' : '0');
