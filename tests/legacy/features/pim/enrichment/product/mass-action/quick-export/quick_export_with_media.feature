...
Feature: Quick export many products with media from datagrid
  ...
  Background:
    ...
    And the following products:
      ...
      | bf9cfd30-f120-4e82-9173-cda3e899dfa2 | boots    | boots    | winter_collection | Amazing boots | 20 EUR, 25 USD | 40   | black | aaa | %fixtures%/akeneo.jpg  |
      | 13c5df68-646c-4177-a3aa-4141685621eb | sneakers | sneakers | summer_collection | Sneakers      | 50 EUR, 60 USD | 42   | white | bbb | %fixtures%/akeneo2.jpg |
  ...
  Scenario: Successfully quick export products and media as a XLSX file
    ...
    And exported xlsx file of "xlsx_product_quick_export" should contain:
      ...
      | boots    | aaa | winter_collection | black |                          | 1       | boots    |        |            |              | Amazing boots | 20        | 25        |        | files/bf9cfd30-f120-4e82-9173-cda3e899dfa2/side_view/akeneo.jpg  | 40   |          |                    |
      | sneakers | bbb | summer_collection | white |                          | 1       | sneakers |        |            |              | Sneakers      | 50        | 60        |        | files/13c5df68-646c-4177-a3aa-4141685621eb/side_view/akeneo2.jpg | 42   |          |                    |
