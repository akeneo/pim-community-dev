...
import fetchCategoryTrees
  from "@akeneo-pim-community/data-quality-insights/src/infrastructure/fetcher/Dashboard/fetchCategoryTrees";
import fetchCategoryChildren
  from "@akeneo-pim-community/data-quality-insights/src/infrastructure/fetcher/Dashboard/fetchCategoryChildren";
import CategoryFilter
  from "@akeneo-pim-community/data-quality-insights/src/application/component/Dashboard/Overview/Filters/CategoryFilter";
...
describe('Dashboard > filter on category', () => {
  test('dashboard can be filtered on "Digital cameras" category', async () => {
    ...
    fetchCategoryChildren
      .mockResolvedValueOnce(masterChildren)
      .mockResolvedValueOnce(cameraChildren);
