...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\ReferenceEntity\InMemoryFindRecordLabels;
...
final class HandleReferenceEntityCollectionValueTest extends AttributeTestCase
{
    ...
    private function loadRecords(): void
    {
        ...
        $recordLabelsRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindRecordLabelsInterface');
