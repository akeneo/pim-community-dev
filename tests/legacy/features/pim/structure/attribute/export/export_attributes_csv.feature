...
Feature: Export attributes
  ...
  Scenario: Successfully export attributes in CSV
    ...
    pim_catalog_date;destocking_date;"Destocking date";other;;0;1;;;;;;;0;;;;;;;;;;;0;0;0;0;0;
