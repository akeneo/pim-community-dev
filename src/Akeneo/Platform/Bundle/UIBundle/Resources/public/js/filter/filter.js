...
define(['jquery', 'underscore', 'oro/translator', 'oro/mediator', 'pim/form', 'pim/template/filter/filter'], function (
  $,
  _,
  __,
  mediator,
  ...
  return BaseForm.extend({
    ...
    setField: function (field) {
      this.setData({field: field}, {silent: true});
    },
    ...
    setOperator: function (operator) {
      this.setData({operator: operator}, {silent: true});
    },
