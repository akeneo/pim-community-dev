...
use Akeneo\Catalogs\Infrastructure\Persistence\GetCatalogsToDisableOnCategoryRemovalQuery;
 ...
 *
 * @covers \Akeneo\Catalogs\Infrastructure\Persistence\GetCatalogsToDisableOnCategoryRemovalQuery
 */
class GetCatalogsToDisableOnCategoryRemovalQueryTest extends IntegrationTestCase
{
    private ?GetCatalogsToDisableOnCategoryRemovalQuery $query;
    ...
    protected function setUp(): void
    {
        ...
        $this->query = self::getContainer()->get(GetCatalogsToDisableOnCategoryRemovalQuery::class);
    }
