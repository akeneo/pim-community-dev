...
class ListRootCategoriesWithCountIncludingSubCategoriesIntegration extends TestCase
{
    /**
     * @inheritDoc
     */
    ...
    public function test_list_root_categories()
    {
        ...
        $expectedCategories = [
            ...
            new RootCategory(1, 'tree_1', 'Tree_1', 3, true),
            new RootCategory(3, 'tree_2', 'Tree_2', 2, false),
        ];
