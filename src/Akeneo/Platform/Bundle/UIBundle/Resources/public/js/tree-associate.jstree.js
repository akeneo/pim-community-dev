define(['jquery', 'underscore', 'routing', 'oro/mediator', 'jquery.jstree'], function ($, _, Routing, mediator) {
  'use strict';
        ...
        ajax: {
          ...
          url: function (node) {
            ...
            if ((!node || node === -1) && treeHasItem) {
              return Routing.generate(routes.list_categories, {
                id: id,
            ...
            return Routing.generate(routes.children, {
              _format: 'json',
              dataLocale: dataLocale,
              context: 'associate',
            });
