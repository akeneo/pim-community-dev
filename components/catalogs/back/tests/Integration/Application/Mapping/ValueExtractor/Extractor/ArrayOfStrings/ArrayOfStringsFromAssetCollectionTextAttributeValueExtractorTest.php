 ...
 *
 * @covers \Akeneo\Catalogs\Application\Mapping\ValueExtractor\Extractor\ArrayOfStrings\ArrayOfStringsFromAssetCollectionTextAttributeValueExtractor
 */
class ArrayOfStringsFromAssetCollectionTextAttributeValueExtractorTest extends ValueExtractorTestCase
{
    private ?ArrayOfStringsFromAssetCollectionTextAttributeValueExtractor $extractor;
    ...
    protected function setUp(): void
    {
        ...
        $this->extractor = self::getContainer()->get(ArrayOfStringsFromAssetCollectionTextAttributeValueExtractor::class);
    }
