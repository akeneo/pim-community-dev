...
import TimePeriodFilter
  from "@akeneo-pim-community/data-quality-insights/src/application/component/Dashboard/Overview/Filters/TimePeriodFilter";
...
describe('Dashboard > change time period', () => {
  test('time period can be changed to weekly on the dashboard', async () => {
    ...
    const filter = await waitForElement(() => getByText('akeneo_data_quality_insights.dqi_dashboard.time_period.weekly'));
