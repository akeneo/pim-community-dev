...
/**
 * The standard format of a published product does not contain values that are not filled.
...
class FillMissingPublishedProductValues implements FillMissingValuesInterface
{
    ...
    public function fromStandardFormat(array $productStandardFormat): array
    {
        ...
        $priceProductValuesWithNullValuesInPivotFormat = array_replace_recursive(
            $nullPriceValuesInPivotFormat,
            $priceProductValuesInPivotFormat
        );
        $standardPriceProductValues = $this->pivotFormatToStandardFormatForPriceValues(
            $priceProductValuesWithNullValuesInPivotFormat
        );
