...
Feature: Browse export profiles
  ...
  Scenario: Successfully view, sort and filter export jobs
    ...
    And I should be able to use the following filters:
      ...
      | Label     | Product                      | csv_footwear_product_export                                                                                                                                                                                                                                                                                                                                                                                             |
      | Job       | Group export in CSV          | csv_footwear_group_export                                                                                                                                                                                                                                                                                                                                                                                               |
      | Connector | Akeneo Product CSV Connector | csv_footwear_product_export, csv_footwear_category_export, csv_footwear_association_type_export, csv_footwear_group_export, csv_footwear_variant_group_export, csv_footwear_attribute_export, csv_footwear_family_export and csv_footwear_option_export                                                                                                                                                                 |
