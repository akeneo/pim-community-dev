 ...
 */
class Version_6_0_20211026142500_add_ref_entity_web_api_acl_Integration extends TestCase
{
    ...
    {
        $this->createRoleWithAcls('ROLE_WITH_PERMS', ['pim_api_overall_access', 'pim_api_reference_entity_edit']);
...
SQL;
        ...
        foreach ($acls as $acl => $expectedValue) {
            ...
            $isAllowed = (bool) $connection->fetchOne($query, [
                'role' => $role,
                'acl' => $acl,
            ]);
