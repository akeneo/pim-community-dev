...
use Pim\Bundle\CatalogVolumeMonitoringBundle\Persistence\Query\Sql\LocalizableAndScopableAttributes;
...
class LocalizableAndScopableAttributesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(LocalizableAndScopableAttributes::class);
    }
