...
class ListGrantedRootCategoriesWithCountIncludingSubCategoriesIntegration extends TestCase
{
    /**
     * {@inheritdoc}
     */
    protected function setUp(): void
    {
        ...
        $fixturesLoader->givenTheProductModelsWithCategories([
            ...
            'product_model_5' => ['tree_2_child_1_level_2'],
            'product_model_6' => ['tree_2_child_1_level_1', 'tree_2_child_1_level_2'],
        ]);
    }

    public function test_list_root_categories_with_permissions_applied()
    {
        $query = $this->get('akeneo.pim.enrichment.category.category_tree.query.list_root_categories_with_count_including_sub_categories');
        ...
        $expectedCategories = [
            ...
            new RootCategory(2, 'tree_1', 'Tree_1', 2, true),
