...
use Akeneo\CatalogBundle\Form\Type\GroupType;

use Akeneo\CatalogBundle\Form\Type\ProductTypeType;
...
class ProductTypeController extends Controller
{
    ...
    {
        return $this->redirect($this->generateUrl('akeneo_catalog_producttype_list'));
    }
    ...
    public function listAction()
    {
        ...
        $rowAction = new RowAction('Edit', 'akeneo_catalog_producttype_edit');
        $rowAction->setRouteParameters(array('id'));
        $grid->addRowAction($rowAction);
        
        return $grid->getGridResponse('AkeneoCatalogBundle:ProductType:list.html.twig');
    }
    ...
    public function addAction()
    {
        ...
        return $this->render(
                'AkeneoCatalogBundle:ProductType:add.html.twig', array('form' => $form->createView())
        );
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render(
                'AkeneoCatalogBundle:ProductType:create.html.twig', array('form' => $form->createView())
        );
    }
...
//         }
        ...
        return $this->render(
                'AkeneoCatalogBundle:ProductType:edit.html.twig', array('form' => $form->createView(), 'formGroup' => $formGroup)
        );
    }
    ...
    {
        return $this->render('AkeneoCatalogBundle:ProductType:update.html.twig');
    }
    ...
    {
        return $this->render('AkeneoCatalogBundle:ProductType:clone.html.twig');
    }
    ...
    public function addGroupAction($id)
    {
        ...
        return $this->render(
                'AkeneoCatalogBundle:ProductType:addGroup.html.twig', array('formGroup' => $formGroup->createView())
        );
    }
    ...
    public function createGroupAction(Request $request)
    {
        ...
        return $this->render(
                'AkeneoCatalogBundle:ProductType:createGroup.html.twig', array('formGroup' => $formGroup->createView())
        );
    }
    ...
    {
        $this->init();
        return $this->managerService->getRepository('AkeneoCatalogBundle:ProductTypeMongo')->find($id);
    }
}