...
namespace Akeneo\Connectivity\Connection\Tests\Integration\TestApps\Validation;
...
class CreateTestAppCommandValidationIntegration extends TestCase
{
    ...
    public function test_it_invalidates_a_test_app_with_a_blank_name(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'name',
            'akeneo_connectivity.connection.test_app.errors.creation.name.not_blank',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_with_a_too_long_name(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'name',
            'akeneo_connectivity.connection.test_app.errors.creation.name.max_length',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_if_the_activate_url_is_not_an_url(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'activateUrl',
            'akeneo_connectivity.connection.test_app.errors.creation.activate_url.must_be_url',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_if_the_activate_url_is_too_long(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'activateUrl',
            'akeneo_connectivity.connection.test_app.errors.creation.activate_url.max_length',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_if_the_callback_url_is_too_long(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'callbackUrl',
            'akeneo_connectivity.connection.test_app.errors.creation.callback_url.max_length',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_if_the_callback_url_is_not_an_url(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'callbackUrl',
            'akeneo_connectivity.connection.test_app.errors.creation.callback_url.must_be_url',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_with_a_too_long_client_id(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'clientId',
            'akeneo_connectivity.connection.test_app.errors.creation.client_id.max_length',
        );
    }
    ...
    public function test_it_invalidates_a_test_app_with_a_blank_client_id(): void
    {
        ...
        $this->assertHasViolation(
            $violations,
            'clientId',
            'akeneo_connectivity.connection.test_app.errors.creation.client_id.not_blank',
        );
    }
