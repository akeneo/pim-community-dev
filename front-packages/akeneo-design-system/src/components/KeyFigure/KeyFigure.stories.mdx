      ...
      return (
        <KeyFigureGrid>
          ...
          <KeyFigure icon={React.createElement(Icons[args.icon])} title="Key figure 4">
            Average: <KeyFigure.Figure>789454</KeyFigure.Figure>
            Max: <KeyFigure.Figure>78945485</KeyFigure.Figure>
          </KeyFigure>
          <KeyFigure icon={React.createElement(Icons[args.icon])} title="Key figure 5">
            Average: <KeyFigure.Figure>5451</KeyFigure.Figure>
            Max: <KeyFigure.Figure>15369</KeyFigure.Figure>
          </KeyFigure>
        </KeyFigureGrid>
      );
    }}
