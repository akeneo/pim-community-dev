...
use Akeneo\Platform\Syndication\Infrastructure\UseCases\ListProductIdsQueryHandler;
...
class GetProductIdentifiersAction
{
    ...
    private ListProductIdsQueryHandler $listProductIdsQueryHandler;
    ...
    public function __construct(
        ...
        ListProductIdsQueryHandler $listProductIdsQueryHandler,
    ...
    public function listAction(Request $request, string $platformConfigurationCode, string $catalogCode): JsonResponse
    {
        ...
        return new JsonResponse([
            'type' => 'product',
            'total_count' => $productIdentifiers->totalNumberOfProductIdentifiers(),
            'has_next' => count($productIdentifiers->productIdentifiers()) === self::PAGE_SIZE,
            'identifiers' => array_filter($productIdentifiers->productIdentifiers(), function ($identifier) use ($query) {
