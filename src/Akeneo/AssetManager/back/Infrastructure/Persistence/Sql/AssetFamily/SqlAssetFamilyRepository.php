...
{
    public function __construct(private Connection $sqlConnection, private EventDispatcherInterface $eventDispatcher, private TransformationCollectionFactory $transformationCollectionFactory)
    {
    }
