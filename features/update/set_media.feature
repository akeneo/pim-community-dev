Feature: Update media fields
  ...
  Scenario: Successfully update a media field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | AKN_MUG | [{"type": "set_data", "field": "user_guide", "data": {"originalFilename": "user_guide.pdf", "filePath": "%fixtures%/akeneo.jpg"}, "locale": "fr_FR", "scope": "mobile"}]                                                                                                                                                                                                  | {"values": {"user_guide": [{"locale": "fr_FR", "scope": "mobile", "data": {"originalFilename": "user_guide.pdf"}}]}} |
      | AKN_MUG | [{"type": "set_data", "field": "user_guide", "data": {"originalFilename": "user_guide.pdf", "filePath": "%fixtures%/akeneo.jpg"}, "locale": "fr_FR", "scope": "mobile"}, {"type": "set_data", "field": "user_guide", "data": {"originalFilename": "side_view.pdf", "filePath": "%fixtures%/akeneo2.jpg"}, "locale": "fr_FR", "scope": "mobile"}] | {"values": {"user_guide": [{"locale": "fr_FR", "scope": "mobile", "data": {"originalFilename": "side_view.pdf"}}]}}  |
