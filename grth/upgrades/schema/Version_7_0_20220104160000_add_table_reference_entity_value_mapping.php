...
final class Version_7_0_20220104160000_add_table_reference_entity_value_mapping extends AbstractMigration implements ContainerAwareInterface
{
    private ContainerInterface $container;

    public function getDescription(): string
    {
        return 'Add the mapping for the table reference entity value in the product and product model index';
    }
    ...
    private function mappingIsAlreadySet(array $existingDynamicTemplate): bool
    {
        foreach ($existingDynamicTemplate as $fields) {
            if (\array_key_exists('table_values_reference_entity', $fields)) {
...
-
  table_values_reference_entity:
    path_match: 'table_values.*.value-reference_entity'
    mapping:
      type: 'keyword'
