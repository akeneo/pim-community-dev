...
Feature: Filter attributes
  ...
  Scenario: Successfully filter attributes
    Then I should be able to use the following filters:
      ...
      | Scopable    | no     | comment, sku, volume, name, manufacturer, weather_conditions, price, rating, side_view, top_view, size, color, lace_color, my_length, destocking_date, handmade, number_in_stock, heel_color, sole_color, sole_fabric, rate_sale, weight and 123 |
      | Localizable | yes    | name, description, cap_color and lace_fabric                                                                                                                                                                                          |
      | Localizable | no     | comment, volume, sku, manufacturer, weather_conditions, price, rating, side_view, top_view, size, color, lace_color, my_length and number_in_stock, destocking_date, handmade, heel_color, sole_color, sole_fabric, rate_sale, weight and 123    |
