...
const SupplierEdit = () => {
    ...
    const [supplier, handleSupplierChanges, supplierHasChanges, saveSupplier, validationErrors] = useSupplier(supplierIdentifier);
        ...
        <Container>
            ...
            <StyledPageContent>
                ...
                {isCurrent('configuration') && (
                    <Configuration supplier={supplier} setLabel={handleSupplierLabelChange} validationErrors={validationErrors} />
                )}
