...
class AjaxOptionController
{
    ...
    public function listAction(Request $request)
    {
        ...
        // cf Pim\Bundle\CatalogBundle\Doctrine\ORM\Repository\GroupRepository, we should add a GroupRepository
        // implementing the SearchableRepositoryInterface in the EnrichBundle
