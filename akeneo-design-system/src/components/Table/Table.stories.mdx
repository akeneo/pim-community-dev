...
<Meta
  ...
  subcomponents={{
    ...
    'Table.ImageCell': Table.ImageCell,
...
Data tables allow users to analyze, compare, filter, sort, and manipulate data for information and actions.
...
<Canvas>
  <Story name="Standard">
    <Table>
      ...
      <Table.Body>
        <Table.Row>
          <Table.ImageCell src='https://picsum.photos/seed/akeneo/200/140' alt='The al'/>
          <Table.Cell isHighlighted>Giant panda</Table.Cell>
...
## Table with image cell
<Canvas>
  <Story name="Table with image cell">
    <Table>
      <Table.Header>
        <Table.HeaderCell>Image</Table.HeaderCell>
        <Table.HeaderCell>Image type</Table.HeaderCell>
        <Table.HeaderCell>Actions</Table.HeaderCell>
      </Table.Header>
      <Table.Body>
        <Table.Row>
          <Table.ImageCell fit='contain' isStacked={false} src='https://picsum.photos/seed/akeneo/200/140' alt='Fit contain'/>
          <Table.Cell>Fit contain</Table.Cell>
          <Table.ActionCell><Button level='primary' ghost>Button</Button></Table.ActionCell>
        </Table.Row>
        <Table.Row>
          <Table.ImageCell fit='cover' isStacked={false} src='https://picsum.photos/seed/akeneo/200/140' alt='Fit cover'/>
          <Table.Cell>Fit cover</Table.Cell>
          <Table.ActionCell><Button level='primary' ghost>Button</Button></Table.ActionCell>
        </Table.Row>
        <Table.Row>
        <Table.ImageCell fit='contain' isStacked={true} src='https://picsum.photos/seed/akeneo/200/140' alt='Stacked fit cover'/>
          <Table.Cell>Stacked fit cover</Table.Cell>
          <Table.ActionCell><Button level='primary' ghost>Button</Button></Table.ActionCell>
        </Table.Row>
        <Table.Row>
          <Table.ImageCell fit='cover' isStacked={true} src='https://picsum.photos/seed/akeneo/200/140' alt='Stacked fit contain'/>
          <Table.Cell>Stacked fit contain</Table.Cell>
          <Table.ActionCell><Button level='primary' ghost>Button</Button></Table.ActionCell>
        </Table.Row>
      </Table.Body>
    </Table>
                ...
                sortedRows.map((row) => {
                  return (
                    <Table.Row key={row.name}>
                      <Table.ImageCell src={row.image} alt='The alt'/>
                      <Table.Cell isHighlighted>{row.name}</Table.Cell>
                      ...
                      <Table.ActionCell>
                        <Button level='primary' onClick={() => console.log('ofofofo')} ghost>Button</Button>
                      </Table.ActionCell>
                    </Table.Row>
                  )
                })
