...
trait EntityWithQuantifiedAssociationTrait
{
    ...
    public function mergeQuantifiedAssociations(QuantifiedAssociationCollection $quantifiedAssociationCollection): void
    {
        ...
        $this->quantifiedAssociationCollection = $this->quantifiedAssociationCollection->merge($quantifiedAssociationCollection);
    }
    ...
    public function overrideQuantifiedAssociations(array $submittedQuantifiedAssociations): void
    {
        ...
        $this->quantifiedAssociationCollection = $this->quantifiedAssociationCollection->overrideQuantifiedAssociations(
