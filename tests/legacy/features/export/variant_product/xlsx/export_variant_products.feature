...
Feature: Export variant products through XLSX export
  ...
  Scenario: Export variant products through XLSX
    Given the following associations for the product "1111111173":
      | type   | products    |
      | X_SELL | 1111111176  |
      | UPSELL | 1111111177  |
    And the following associations for the product model "brogueshoe":
      | type   | products    |
      | X_SELL | 1111111175  |
    And I am on the "xlsx_summer_2016_shoes_products_export" export job page
    ...
    Then exported xlsx file of "xlsx_summer_2016_shoes_products_export" should contain:
      |sku       |categories                                  |enabled|family|parent    |groups|brand|collection|color|composition|description-en_US-ecommerce|ean|erp_name-en_US|eu_shoes_size|image|keywords-en_US|material|meta_description-en_US|meta_title-en_US|name-en_US|notice|price-EUR|price-USD|size|sole_composition|supplier|top_composition|UPSELL-groups|UPSELL-products|UPSELL-product_models|variation_image|variation_name-en_US|weight|weight-unit|X_SELL-groups|X_SELL-products|X_SELL-product_models|
      |1111111173|master_men_shoes,supplier_abibas            |1      |shoes |brogueshoe|      ||summer_2016|||||Brogue shoe|410||||||brogueshoe||267.00|||1111111176,1111111175||||abibas||||900.0000|GRAM||1111111177||
