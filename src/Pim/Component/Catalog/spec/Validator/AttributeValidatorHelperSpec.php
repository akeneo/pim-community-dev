...
class AttributeValidatorHelperSpec extends ObjectBehavior
{
    ...
    {
        $this->beAnInstanceOf('spec\Pim\Component\Catalog\Validator\InitializedAttributeValidatorHelper');
        $this->beConstructedWith($localeRepository, $scopeRepository);
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('Pim\Component\Catalog\Validator\AttributeValidatorHelper');
    }
