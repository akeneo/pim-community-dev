...
sed -i s#https://ask-franklin.cloud.akeneo.com#https://ask-franklin-test.dev.cloud.akeneo.com# vendor/akeneo/pim-enterprise-dev/src/Akeneo/Pim/Automation/FranklinInsights/Infrastructure/Symfony/Resources/config/client/franklin.yml
rm -rf var/cache/*
ENDSSH
