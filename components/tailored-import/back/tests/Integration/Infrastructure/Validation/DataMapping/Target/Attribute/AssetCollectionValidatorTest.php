...
use Akeneo\Platform\TailoredImport\Infrastructure\Validation\DataMapping\Target\Attribute\AssetCollection\AssetCollection;
use Akeneo\Platform\TailoredImport\Test\Integration\Infrastructure\Validation\AbstractValidationTest;
use Akeneo\Test\Integration\Configuration;

final class AssetCollectionValidatorTest extends AbstractValidationTest
{
    /**
    ...
    {
        $violations = $this->getValidator()->validate($value, new AssetCollection([
    ...
    {
        return [
            'a valid asset collection data mapping' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'an_asset_collection',
                        'type' => 'attribute',
            ...
            'a valid asset collection data mapping with clear value' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'an_asset_collection',
            ...
            'a valid asset collection data mapping with add action if not empty' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'an_asset_collection',
            ...
            'a valid asset collection data mapping with sample data' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'an_asset_collection',
            ...
            'a valid asset collection data mapping with split operation' => [
                [
                    'uuid' => 'f3513836-4f1d-4bf6-b1a0-ce85ddcca5cd',
                    'target' => [
                        'code' => 'an_asset_collection',
    ...
    {
        return [
            'an asset collection data mapping with an invalid uuid' => [
            ...
            'an asset collection data mapping with an unsupported operation' => [
            ...
            'an asset collection data mapping should have a source' => [
            ...
            'an asset collection data mapping cannot have more than 4 sources' => [
            ...
            'an asset collection data mapping with an invalid sample data' => [
