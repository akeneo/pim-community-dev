...
class GetCategoryChildrenIdsSqlIntegration extends CategoryTestCase
{
    ...
    public function testItRetrievesCategoryChildrenIds(): void
    {
        ...
        $categoryChildrenIds = $this->get(GetCategoryChildrenIdsInterface::class)->execute($categoryClothes->getId());
    ...
    public function testItDoesNotRetrieveCategoryChildrenIds(): void
    {
        ...
        $categoryChildrenIds = $this->get(GetCategoryChildrenIdsInterface::class)->execute($categoryAccessories->getId());
