...
import {useRouter, useSecurity, useTranslate, useRoute, Security} from '@akeneo-pim-community/legacy-bridge';
import {PageContent, PageHeader, PimView, FullScreenError} from '@akeneo-pim-community/shared';
import {
  Breadcrumb,
  Button,
  Dropdown,
