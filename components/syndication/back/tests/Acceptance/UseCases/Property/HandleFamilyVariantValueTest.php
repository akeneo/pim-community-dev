...
use Akeneo\Platform\Syndication\Test\Acceptance\FakeServices\FamilyVariant\InMemoryFindFamilyVariantLabel;
...
final class HandleFamilyVariantValueTest extends PropertyTestCase
{
    ...
    private function loadFamilyVariantLabels(): void
    {
        ...
        $familyVariantLabelsRepository = self::$container->get('Akeneo\Platform\Syndication\Domain\Query\FindFamilyVariantLabelInterface');
