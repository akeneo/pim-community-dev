...
.PHONY: measurement-end-to-end-back
measurement-end-to-end-back: #Doc: launch PHPUnit end to end tests for measurement bounded context
	APP_ENV=test $(PHP_RUN) vendor/bin/phpunit -c src/Akeneo/Tool/Bundle/MeasureBundle/tests --testsuite Measurement_End_To_End_Test $(O)
