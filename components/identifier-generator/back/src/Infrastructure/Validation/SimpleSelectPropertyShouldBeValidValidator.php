 ...
 */
final class SimpleSelectPropertyShouldBeValidValidator extends ConstraintValidator
{
    ...
    public function validate($property, Constraint $constraint): void
    {
        ...
        if (\array_key_exists('type', $property) && $property['type'] !== SimpleSelectProperty::type()) {
            return;
        }
