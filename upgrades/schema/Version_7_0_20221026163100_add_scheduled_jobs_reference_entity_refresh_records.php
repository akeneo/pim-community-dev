...
final class Version_7_0_20221026163100_add_scheduled_jobs_reference_entity_refresh_records extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addScheduledJob(
            'reference_entity_refresh_records',
            'Refresh all records referencing a deleted record or a deleted attribute option.',
            []
        );
    }
